...
\$(OBJS_DRT_MAT) \$(OBJS_DRT_STRU_MULTI) \$(OBJS_DRT_SURFSTRESS) \$(OBJS_DRT_LOMA) \$(OBJS_DRT_ELCH) \$(OBJS_DRT_SCATRA) \$(OBJS_DRT_SCATRA_LIB) \$(OBJS_DRT_COMBUST) \$(OBJS_DRT_BELE3_LIB)" 
...
\$(OBJS_SOH8_LIB) \$(OBJS_DRT_W1_LIB) \$(OBJS_DRT_ALE_LIB) \$(OBJS_DRT_COMBUST3_LIB) \$(OBJS_DRT_STATMECH_LIB) \$(OBJS_DRT_SURFSTRESS) \$(OBJS_DRT_SCATRA_LIB) \$(OBJS_DRT_THERMO_LIB) \$(OBJS_FILTER_COMMON) \$(OBJS_DRT_ARTNET_LIB)"
