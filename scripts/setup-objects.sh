...
\$(OBJS_DRT) \$(OBJS_DRT_LIB) \$(OBJS_DRT_CONTACT) \$(OBJS_DRT_CONTACT_LIB) \$(OBJS_DRT_CONSTRAINT) \$(OBJS_DRT_CONDIF3_LIB) \$(OBJS_DRT_STRUCTURE) \$(OBJS_PSS) \$(OBJS_INPUT) \$(OBJS_INPUT_CPP) \$(OBJS_PAR) \$(OBJS_MATH) \
