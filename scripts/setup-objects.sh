...
\$(OBJS_DRT) \$(OBJS_DRT_LIB) \$(OBJS_DRT_INPAR) \$(OBJS_DRT_NURBS_DISCRET) \$(OBJS_DRT_CONTACT) \$(OBJS_DRT_CONTACT_LIB) \$(OBJS_DRT_STATMECH) \$(OBJS_DRT_STATMECH_LIB) \
...
\$(OBJS_DRT_IO_LIB) \$(OBJS_DRT_LIB) \$(OBJS_DRT_INPAR) \$(OBJS_DRT_NURBS_DISCRET) \$(OBJS_DRT_MAT_LIB) \$(OBJS_PSS) \$(OBJS_PAR) \$(OBJS_DRT_CONTACT_LIB) \$(OBJS_DRT_CONDIF3_LIB) \
\$(OBJS_INTERSECTION) \$(OBJS_DRT_CONSTRAINT_LIB) \$(OBJS_DRT_F2_LIB) \$(OBJS_DRT_B2_LIB) \$(OBJS_DRT_B3_LIB) \$(OBJS_DRT_BELE3_LIB) \$(OBJS_DRT_T3_LIB) \$(OBJS_DRT_F3_LIB)  \$(OBJS_DRT_S8_LIB) \
...
if grep '^[[:blank:]]*D_FLUID3' "$definefile" 2>&1 > /dev/null ; then
    if [ "x$OBJ_FLUID" = "x0" ] ; then
        ...
        \$(OBJS_DRT_CONDIF3_LIB) \$(OBJS_DRT_COMBUST3_LIB)"
        DEFINES="$DEFINES -DD_FLUID"
        OBJ_FLUID=1
    else
