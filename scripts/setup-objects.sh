...
\$(OBJS_DRT_CONSTRAINT) \$(OBJS_DRT_CONSTRAINT_LIB) \$(OBJS_DRT_STRUCTURE) \$(OBJS_DRT_THERMO) \$(OBJS_DRT_THERMO_LIB) \$(OBJS_PSS) \$(OBJS_INPUT) \$(OBJS_INPUT_CPP) \$(OBJS_PAR) \$(OBJS_MATH) \
