...
\$(OBJS_DISCRET) \$(OBJS_DISCRET_LIB) \$(OBJS_PSS) \$(OBJS_PSS_CPP) \$(OBJS_INPUT) \$(OBJS_INPUT_CPP) \$(OBJS_PAR) \$(OBJS_MATH) \
\$(OBJS_OUTPUT) \$(OBJS_FORTRAN) \$(OBJS_VISUAL) \$(OBJS_STRUCTURE) \$(OBJS_IO)"
