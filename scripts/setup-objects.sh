...
\$(OBJS_DRT_FSI) \$(OBJS_DRT_FLUID) \$(OBJS_DRT_MAT)"

FILTER_OBJECTS="\$(OBJS_POST_DRT_GID) \$(OBJS_POST_GID_TXT) \$(OBJS_POST_DRT_COMMON) \
\$(OBJS_IO_LIB) \$(OBJS_DRT_LIB) \$(OBJS_DRT_MAT) \$(OBJS_PSS) \$(OBJS_PAR) \
