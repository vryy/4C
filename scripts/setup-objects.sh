...
\$(OBJS_INTERSECTION) \$(OBJS_DRT_CONSTRAINT_LIB) \$(OBJS_DRT_F2_LIB) \$(OBJS_DRT_B2_LIB) \$(OBJS_DRT_B2R_LIB) \$(OBJS_DRT_B3_LIB) \$(OBJS_DRT_BELE3_LIB) \$(OBJS_DRT_T3_LIB) \$(OBJS_DRT_F3_LIB)  \$(OBJS_DRT_S8_LIB) \
