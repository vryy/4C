...
\$(OBJS_INTERSECTION) \$(OBJS_DRT_FSI) \$(OBJS_DRT_MFSI) \$(OBJS_DRT_FLUID) \$(OBJS_DRT_MAT_LIB) \$(OBJS_DRT_MAT) \$(OBJS_DRT_STRU_MULTI) \$(OBJS_DRT_TIMADA)"

FILTER_OBJECTS="\$(OBJS_POST_DRT_COMMON) \
\$(OBJS_IO_LIB) \$(OBJS_DRT_LIB) \$(OBJS_DRT_MAT_LIB) \$(OBJS_PSS) \$(OBJS_PAR) \$(OBJS_DRT_CONTACT_LIB) \
\$(OBJS_INTERSECTION) \$(OBJS_DRT_F2_LIB) \$(OBJS_DRT_F3_LIB)  \$(OBJS_DRT_S8_LIB) \
\$(OBJS_SOH8_LIB) \$(OBJS_DRT_W1_LIB) \$(OBJS_DRT_ALE_LIB) \$(OBJS_FILTER_COMMON)"
