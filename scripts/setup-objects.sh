...
\$(OBJS_DRT) \$(OBJS_DRT_LIB) \$(OBJS_DRT_CONTACT) \$(OBJS_DRT_CONTACT_LIB) \$(OBJS_DRT_CONSTRAINT) \$(OBJS_DRT_STRUCTURE) \$(OBJS_PSS) \$(OBJS_INPUT) \$(OBJS_INPUT_CPP) \$(OBJS_PAR) \$(OBJS_MATH) \
...
\$(OBJS_DRT_MAT) \$(OBJS_DRT_STRU_MULTI) \$(OBJS_DRT_SURFSTRESS) \$(OBJS_DRT_TIMADA) \$(OBJS_DRT_ELCH)"

FILTER_OBJECTS="\$(OBJS_POST_DRT_COMMON) \
\$(OBJS_DRT_IO_LIB) \$(OBJS_DRT_LIB) \$(OBJS_DRT_MAT_LIB) \$(OBJS_PSS) \$(OBJS_PAR) \$(OBJS_DRT_CONTACT_LIB) \
\$(OBJS_INTERSECTION) \$(OBJS_DRT_CONSTRAINT) \$(OBJS_DRT_F2_LIB) \$(OBJS_DRT_B2_LIB) \$(OBJS_DRT_B3_LIB) \$(OBJS_DRT_F3_LIB)  \$(OBJS_DRT_S8_LIB) \
