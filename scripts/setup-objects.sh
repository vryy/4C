...
\$(OBJS_DRT) \$(OBJS_DRT_LIB) \$(OBJS_DRT_INPAR) \$(OBJS_DRT_NURBS_DISCRET_LIB) \$(OBJS_DRT_NURBS_DISCRET) \$(OBJS_DRT_CONTACT) \$(OBJS_DRT_CONTACT_LIB) \$(OBJS_DRT_STATMECH) \$(OBJS_DRT_STATMECH_LIB) \
...
\$(OBJS_DRT_IO_LIB) \$(OBJS_DRT_LIB) \$(OBJS_DRT_INPAR) \$(OBJS_DRT_NURBS_DISCRET_LIB) \$(OBJS_DRT_MAT_LIB) \$(OBJS_PSS) \$(OBJS_PAR) \$(OBJS_DRT_CONTACT_LIB) \
