...
\$(OBJS_DRT) \$(OBJS_DRT_LIB) \$(OBJS_DRT_CONTACT) \$(OBJS_DRT_CONTACT_LIB) \$(OBJS_DRT_STATMECH) \$(OBJS_DRT_STATMECH_LIB) \$(OBJS_DRT_CONSTRAINT) \$(OBJS_DRT_CONSTRAINT_LIB) \$(OBJS_DRT_CONDIF3_LIB) \$(OBJS_DRT_STRUCTURE) \$(OBJS_PSS) \$(OBJS_INPUT) \$(OBJS_INPUT_CPP) \$(OBJS_PAR) \$(OBJS_MATH) \
...
\$(OBJS_DRT_MAT) \$(OBJS_DRT_STRU_MULTI) \$(OBJS_DRT_SURFSTRESS) \$(OBJS_DRT_TIMADA) \$(OBJS_DRT_ELCH) \$(OBJS_DRT_COMBUST) \$(OBJS_DRT_SCATRA) \$(OBJS_DRT_BELE3_LIB)" 
