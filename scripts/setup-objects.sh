...
\$(OBJS_INTERSECTION) \$(OBJS_INV_ANALYSIS) \$(OBJS_DRT_FSI) \$(OBJS_DRT_MFSI) \$(OBJS_DRT_FLUID) \$(OBJS_DRT_MAT_LIB) \$(OBJS_DRT_MAT) \$(OBJS_DRT_STRU_MULTI) \$(OBJS_DRT_SURFSTRESS) \$(OBJS_DRT_TIMADA)"
