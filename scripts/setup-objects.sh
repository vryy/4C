...
\$(OBJS_DRT) \$(OBJS_DRT_LIB) \$(OBJS_DRT_CONTACT) \$(OBJS_DRT_STRUCTURE) \$(OBJS_PSS) \$(OBJS_INPUT) \$(OBJS_INPUT_CPP) \$(OBJS_PAR) \$(OBJS_MATH) \
...
\$(OBJS_IO_LIB) \$(OBJS_DRT_LIB) \$(OBJS_DRT_MAT_LIB) \$(OBJS_PSS) \$(OBJS_PAR) \$(OBJS_DRT_CONTACT) \
