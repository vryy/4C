...
void SCATRA::LevelSetAlgorithm::Init()
{
  ...
  // set number of element layers around interface where velocity field form Navier-Stokes kept
...
{
  // -----------------------------------------------------------------
  //              solve level-set equation equation
  // -----------------------------------------------------------------
 ...
 *----------------------------------------------------------------------*/
void SCATRA::LevelSetAlgorithm::ReadRestart(bool restart)
{
  dserror("ReadRestart() not yet implemented!");
  return;
}
