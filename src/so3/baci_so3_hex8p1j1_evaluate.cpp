  ...
  ** ============================================================================*/
  ...
  for (unsigned gp = 0; gp < NUMGPT_SOH8; ++gp)
  {
    ...
    */
    ...
    CORE::LINALG::SerialDenseVector mod_glstrain_epetra(MAT::NUM_STRESS_3D);
    CORE::LINALG::Matrix<MAT::NUM_STRESS_3D, 1> mod_glstrain(mod_glstrain_epetra.values(), true);
