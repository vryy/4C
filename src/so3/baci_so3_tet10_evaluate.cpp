    ...
    CORE::LINALG::SerialDenseVector& elevec3_epetra)
{
  ...
  CORE::LINALG::Matrix<NUMDOF_SOTET10, NUMDOF_SOTET10> elemat1(elemat1_epetra.A(), true);
  CORE::LINALG::Matrix<NUMDOF_SOTET10, NUMDOF_SOTET10> elemat2(elemat2_epetra.A(), true);
  CORE::LINALG::Matrix<NUMDOF_SOTET10, 1> elevec1(elevec1_epetra.A(), true);
  CORE::LINALG::Matrix<NUMDOF_SOTET10, 1> elevec2(elevec2_epetra.A(), true);
  CORE::LINALG::Matrix<NUMDOF_SOTET10, 1> elevec3(elevec3_epetra.A(), true);
