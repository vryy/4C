 ...
 *----------------------------------------------------------------------*/
int Discret::ELEMENTS::SoPyramid5::Evaluate(Teuchos::ParameterList& params,
    ...
    Core::LinAlg::SerialDenseVector& elevec3_epetra)
{
  ...
  // start with "none"
  Discret::ELEMENTS::SoPyramid5::ActionType act = SoPyramid5::none;
 ...
 *----------------------------------------------------------------------*/
int Discret::ELEMENTS::SoPyramid5::evaluate_neumann(Teuchos::ParameterList& params,
    ...
    Core::LinAlg::SerialDenseMatrix* elemat1)
{
  ...
  ** ============================================================================*/
  ...
  return 0;
}  // Discret::ELEMENTS::So_pyramid5::evaluate_neumann


/*----------------------------------------------------------------------*
 |  init the element jacobian mapping (protected)                       |
 *----------------------------------------------------------------------*/
void Discret::ELEMENTS::SoPyramid5::init_jacobian_mapping()
{
  const static std::vector<Core::LinAlg::Matrix<NUMDIM_SOP5, NUMNOD_SOP5>> derivs = sop5_derivs();
 ...
 *----------------------------------------------------------------------*/
void Discret::ELEMENTS::SoPyramid5::sop5_linstiffmass(std::vector<int>& lm,  // location matrix
    ...
    const Inpar::STR::StrainType ioplstrain)  // plastic strain output option
{
  ...
  ** ============================================================================*/
  ...
  return;
}  // Discret::ELEMENTS::So_pyramid5::sop5_linstiffmass


/*----------------------------------------------------------------------*
 |  evaluate the element (private)                                      |
 *----------------------------------------------------------------------*/
void Discret::ELEMENTS::SoPyramid5::sop5_nlnstiffmass(std::vector<int>& lm,  // location matrix
    std::vector<double>& disp,                                    // current displacements
    ...
    const Inpar::STR::StrainType ioplstrain)  // plastic strain output option
{
  ...
  ** ============================================================================*/
  ...
  return;
}  // Discret::ELEMENTS::So_pyramid5::sop5_nlnstiffmass


/*----------------------------------------------------------------------*
 |  lump mass matrix (private)                                          |
 *----------------------------------------------------------------------*/
void Discret::ELEMENTS::SoPyramid5::sop5_lumpmass(
 ...
 *----------------------------------------------------------------------*/
std::vector<Core::LinAlg::Matrix<NUMNOD_SOP5, 1>> Discret::ELEMENTS::SoPyramid5::sop5_shapefcts()
{
...
Discret::ELEMENTS::SoPyramid5::sop5_derivs()
{
 ...
 *----------------------------------------------------------------------*/
std::vector<double> Discret::ELEMENTS::SoPyramid5::sop5_weights()
{
 ...
 *----------------------------------------------------------------------*/
void Discret::ELEMENTS::SoPyramid5::sop5_shapederiv(
 ...
 *----------------------------------------------------------------------*/
int Discret::ELEMENTS::SoPyramid5Type::Initialize(Discret::Discretization& dis)
{
 ...
 *----------------------------------------------------------------------*/
void Discret::ELEMENTS::SoPyramid5::def_gradient(const std::vector<double>& disp,
 ...
 *----------------------------------------------------------------------*/
void Discret::ELEMENTS::SoPyramid5::get_temperature_for_structural_material(
 ...
 *----------------------------------------------------------------------*/
void Discret::ELEMENTS::SoPyramid5::update_jacobian_mapping(
