...
namespace DRT
{
  ...
  namespace ELEMENTS
  {
    class SoHex18Type : public DRT::ElementType
    {
     public:
     ...
     private:
      ...
      std::string GetElementTypeString() const { return "SOLIDH18"; }
    };  // class So_hex18Type
    ...
    class SoHex18 : public virtual SoBase
    {
      ...
      */
      ...
      DRT::ElementType& ElementType() const override { return SoHex18Type::Instance(); }
