...
static int      NKEYS=9;              /* see VISUAL2 manual             */
static int      XYPIX[2];             /* size of VISUAL2 window         */
static int      IKEYS[]={112,115,118,102,120,121,97,116,102};
static int      FKEYS[]={1,1,1,3,1,1,1,1,3};             
static float    FLIMS[9][2];          /* data limits                    */
...
fluid_readvispss(actfield,&ncols,&time_a);
...
if (IOPT>=2)
{
   dserror("ale not implemented yet!");
}
else
{
...
else 
{
   ...
   {
      dy = dx*ratio;
      XYMIN[1] = 0.5*(XYMIN[1]+XYMAX[12]) - 0.5*dy;
      XYMAX[1] = XYMIN[1] + dy;
   }   
} /* endif else */
...
case fluid:
   ...
   /*-------------------------------------------------------------------*/   
   case 3: /* vorticity */
      printf("VORTICITY NOT IMPLEMTED SO FAR!!!!!!!!!!!!!!!!!!!!\n");
   break;
   case 4: 
...
{
case fluid: 
   if (icol<ncols-1) icol++;
   else if (icol==ncols-1) icol=0;
...
case tri3: /* 3 node triangle */
   for (i=0;i<numele;i++)
   {
      ...
      for(j=0;j<3;j++) 
      {
         PCELL[inel][j] = actele->node[j]->Id+1;
      }
...
case tri6:
   for (i=0;i<numele;i++)
   {
      ...
      inel++;
      /*----------------------------------------- sub-element 1 */
      PCELL[inel][0] = actele->node[0]->Id+1;    
      PCELL[inel][1] = actele->node[3]->Id+1;    
      PCELL[inel][2] = actele->node[5]->Id+1;    
      PCELL[inel][3] = actele->node[0]->Id+1;
      inel++;
      /*----------------------------------------- sub-element 2 */
      PCELL[inel][0] = actele->node[3]->Id+1;    
      PCELL[inel][1] = actele->node[1]->Id+1;    
      PCELL[inel][2] = actele->node[4]->Id+1;    
      PCELL[inel][3] = actele->node[3]->Id+1;
      inel++;
      /*----------------------------------------- sub-element 3 */
      PCELL[inel][0] = actele->node[3]->Id+1;    
      PCELL[inel][1] = actele->node[4]->Id+1;    
      PCELL[inel][2] = actele->node[5]->Id+1;    
      PCELL[inel][3] = actele->node[3]->Id+1;
      inel++;
      /*----------------------------------------- sub-element 4 */
      PCELL[inel][0] = actele->node[4]->Id+1;    
      PCELL[inel][1] = actele->node[3]->Id+1;    
      PCELL[inel][2] = actele->node[5]->Id+1;    
      PCELL[inel][3] = actele->node[4]->Id+1;
    } 
   break;
...
case quad8:
   for (i=0;i<numele;i++)
   {
      ...
      PCELL[inel][0] = actele->node[0]->Id+1;    
      PCELL[inel][1] = actele->node[4]->Id+1;    
      PCELL[inel][2] = actele->node[7]->Id+1;    
      PCELL[inel][3] = actele->node[0]->Id+1;
      inel++;
      /*----------------------------------------- sub-element 2 */
      PCELL[inel][0] = actele->node[4]->Id+1;    
      ...
      inel++;
      /*----------------------------------------- sub-element 3 */
      PCELL[inel][0] = actele->node[5]->Id+1;    
      PCELL[inel][1] = actele->node[2]->Id+1;    
      PCELL[inel][2] = actele->node[6]->Id+1;    
      PCELL[inel][3] = actele->node[5]->Id+1;
      inel++;
      /*----------------------------------------- sub-element 4 */
      PCELL[inel][0] = actele->node[6]->Id+1;    
      PCELL[inel][1] = actele->node[3]->Id+1;    
      PCELL[inel][2] = actele->node[7]->Id+1;    
      PCELL[inel][3] = actele->node[6]->Id+1;
      inel++;
      /*----------------------------------------- sub-element 5 */
      PCELL[inel][0] = actele->node[6]->Id+1;    
      PCELL[inel][1] = actele->node[7]->Id+1;    
      PCELL[inel][2] = actele->node[4]->Id+1;    
      PCELL[inel][3] = actele->node[5]->Id+1;
   }
   break;
case quad9:
   for (i=0;i<numele;i++)
   {
      ...
      PCELL[inel][0] = actele->node[0]->Id+1;    
      PCELL[inel][1] = actele->node[4]->Id+1;    
      PCELL[inel][2] = actele->node[8]->Id+1;    
      PCELL[inel][3] = actele->node[7]->Id+1;
      inel++;
      /*----------------------------------------- sub-element 2 */
      PCELL[inel][0] = actele->node[4]->Id+1;    
      PCELL[inel][1] = actele->node[1]->Id+1;    
      PCELL[inel][2] = actele->node[5]->Id+1;    
      PCELL[inel][3] = actele->node[8]->Id+1;
      inel++;
      /*----------------------------------------- sub-element 3 */
      PCELL[inel][0] = actele->node[8]->Id+1;    
      PCELL[inel][1] = actele->node[5]->Id+1;    
      PCELL[inel][2] = actele->node[2]->Id+1;    
      PCELL[inel][3] = actele->node[6]->Id+1;
      inel++;
      /*----------------------------------------- sub-element 4 */
      PCELL[inel][0] = actele->node[7]->Id+1;    
      PCELL[inel][1] = actele->node[8]->Id+1;    
      PCELL[inel][2] = actele->node[6]->Id+1;    
      PCELL[inel][3] = actele->node[3]->Id+1;
   }
   break;           
