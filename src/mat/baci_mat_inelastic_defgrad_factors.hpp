...
#ifndef BACI_MAT_INELASTIC_DEFGRAD_FACTORS_HPP
#define BACI_MAT_INELASTIC_DEFGRAD_FACTORS_HPP
  ...
  */
  class InelasticDefgradFactors
  {
   public:
     ...
     */
    virtual void EvaluateAdditionalCmat(const CORE::LINALG::Matrix<3, 3>* defgrad,
