...
*----------------------------------------------------------------------*/
#ifndef BACI_MAT_SCATRA_MAT_ANISO_HPP
#define BACI_MAT_SCATRA_MAT_ANISO_HPP
...
namespace MAT
{
  ...
  class ScatraMatAniso : public Material
  {
    ...
    */
    ...
    /// material type
    INPAR::MAT::MaterialType MaterialType() const override { return INPAR::MAT::m_scatra_aniso; }
