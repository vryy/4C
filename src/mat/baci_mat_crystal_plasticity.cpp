...
MAT::PAR::CrystalPlasticity::CrystalPlasticity(Teuchos::RCP<MAT::PAR::Material> matdata)
    : Parameter(matdata),
      ...
      poisson_(*matdata->Get<double>("NUE")),
      density_(*matdata->Get<double>("DENS")),
      lattice_(*matdata->Get<std::string>("LAT")),
      ctoa_(*matdata->Get<double>("CTOA")),
      lattice_const_(*matdata->Get<double>("ABASE")),
      num_slip_sys_(*matdata->Get<int>("NUMSLIPSYS")),
      num_slip_sets_(*matdata->Get<int>("NUMSLIPSETS")),
      ...
      num_twin_sys_(*matdata->Get<int>("NUMTWINSYS")),
      num_twin_sets_(*matdata->Get<int>("NUMTWINSETS")),
