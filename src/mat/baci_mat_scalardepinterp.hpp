...
namespace MAT
{
  ...
  namespace PAR
  {
     ...
     *  \date 12/2015
     */
    class ScalarDepInterp : public Parameter
    {
     public:
      /// standard constructor
      ScalarDepInterp(Teuchos::RCP<MAT::PAR::Material> matdata);
  ...
  class ScalarDepInterp : public So3Material
  {
   public:
    ...
    /// material type
    INPAR::MAT::MaterialType MaterialType() const override { return INPAR::MAT::m_sc_dep_interp; }
