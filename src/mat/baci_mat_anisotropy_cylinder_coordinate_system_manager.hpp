...
#ifndef BACI_MAT_ANISOTROPY_CYLINDER_COORDINATE_SYSTEM_MANAGER_HPP
#define BACI_MAT_ANISOTROPY_CYLINDER_COORDINATE_SYSTEM_MANAGER_HPP
...
#endif  // MAT_ANISOTROPY_CYLINDER_COORDINATE_SYSTEM_MANAGER_H
