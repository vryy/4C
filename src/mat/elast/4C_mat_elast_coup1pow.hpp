...
#ifndef FOUR_C_MAT_ELAST_COUP1POW_HPP
#define FOUR_C_MAT_ELAST_COUP1POW_HPP
...
namespace Mat
{
  namespace Elastic
  {
    namespace PAR
    {
       ...
       */
      class Coup1Pow : public Core::Mat::PAR::Parameter
      {
       public:
    ...
    class Coup1Pow : public Summand
    {
     public:
      ...
      {
        return Core::Materials::mes_coup1pow;
      }
