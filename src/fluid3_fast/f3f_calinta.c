  ...
  for (lr=0;lr<nir;lr++)
  {
    ...
    perf_begin(60);
        ...
        if (fdyn->nii!=0)
        {
          ...
          f3fcalif(eiforce,covint,alecovint,funct,derxy,derxy2,
    ...
    perf_begin(61);
        ...
        if (hasext[0]!=0)
        {
          ...
          f3fcalstabexf(eiforce,derxy,derxy2,edeadng,alecovint,fac,&ths,&thp,
              tau, paravec, flagvec, sizevec);
    ...
    perf_begin(62);
        ...
        if (fdyn->nif!=0)
        {
          ...
          f3fveli(alecovint,funct,ealecovn,sizevec);
          ...
          f3fcaltf(etforce,alecovint,velint,covint,funct,derxy,
    ...
    perf_begin(63);
          ...
          if (hasext[0]!=0)
          {
            ...
            f3fcalstabexf(etforce,derxy,derxy2,edeadn,alecovint,fac,&ths,&thp,tau,
                paravec, flagvec, sizevec);
