...
#ifndef BACI_BEAMINTERACTION_BEAM_TO_SOLID_SURFACE_VISUALIZATION_OUTPUT_WRITER_HPP
#define BACI_BEAMINTERACTION_BEAM_TO_SOLID_SURFACE_VISUALIZATION_OUTPUT_WRITER_HPP
...
namespace BEAMINTERACTION
{
  ...
  class BeamToSolidSurfaceVisualizationOutputWriter
  {
   ...
   private:
     ...
     */
    void WriteOutputBeamToSolidSurface(
