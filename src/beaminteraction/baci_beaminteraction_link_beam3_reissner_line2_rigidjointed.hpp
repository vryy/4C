...
*/
/*----------------------------------------------------------------------*/
#ifndef BACI_BEAMINTERACTION_LINK_BEAM3_REISSNER_LINE2_RIGIDJOINTED_HPP
#define BACI_BEAMINTERACTION_LINK_BEAM3_REISSNER_LINE2_RIGIDJOINTED_HPP

#include "baci_config.hpp"

#include "baci_beaminteraction_link_rigidjointed.hpp"
