...
#ifndef BACI_BEAMINTERACTION_BEAM_TO_BEAM_CONTACT_TANGENTSMOOTHING_HPP
#define BACI_BEAMINTERACTION_BEAM_TO_BEAM_CONTACT_TANGENTSMOOTHING_HPP
...
#endif  // BEAMINTERACTION_BEAM3CONTACT_TANGENTSMOOTHING_H
