...
#ifndef BACI_BEAMINTERACTION_POTENTIAL_RUNTIME_VISUALIZATION_OUTPUT_PARAMS_HPP
#define BACI_BEAMINTERACTION_POTENTIAL_RUNTIME_VISUALIZATION_OUTPUT_PARAMS_HPP
