...
#ifndef FOUR_C_BEAMINTERACTION_CONTACT_BEAM_TO_SOLID_SURFACE_MESHTYING_PAIR_BASE_HPP
#define FOUR_C_BEAMINTERACTION_CONTACT_BEAM_TO_SOLID_SURFACE_MESHTYING_PAIR_BASE_HPP
