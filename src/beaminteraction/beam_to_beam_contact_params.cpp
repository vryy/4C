...
void BEAMINTERACTION::BeamToBeamContactParams::Init()
{
  ...
  if (DRT::INPUT::IntegralValue<int>(beam_contact_params_list, "BEAMS_SEGCON"))
  {
    ...
    if (segangle_ <= 0.0) dserror("Segmentation angle must be greater than zero!");
  ...
  /****************************************************************************/
  if (DRT::INPUT::IntegralValue<int>(beam_contact_params_list, "BEAMS_SMOOTHING") !=
      INPAR::BEAMCONTACT::bsm_none)
    dserror("BEAMS_SMOOTHING currently not supported!");

  /****************************************************************************/
  if (DRT::INPUT::IntegralValue<int>(beam_contact_params_list, "BEAMS_DAMPING") !=
  ...
  /****************************************************************************/
  if (BTB_basicstiff_gap_ != -1.0) dserror("BEAMS_BASICSTIFFGAP currently not supported!");
