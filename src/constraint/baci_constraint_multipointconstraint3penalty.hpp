...
#ifndef BACI_CONSTRAINT_MULTIPOINTCONSTRAINT3PENALTY_HPP
#define BACI_CONSTRAINT_MULTIPOINTCONSTRAINT3PENALTY_HPP
  ...
  */
  class MPConstraint3Penalty : public CONSTRAINTS::MPConstraint
  {
   ...
   private:
    ...
    void EvaluateError(Teuchos::RCP<DRT::Discretization> disc,  ///< discretization to evaluate
        Teuchos::ParameterList&
            params,  ///< parameter list to communicate between elements and discretization
        Teuchos::RCP<Epetra_Vector> systemvector3,  ///< distributed vector that may be filled by
...
#endif  // CONSTRAINT_MULTIPOINTCONSTRAINT3PENALTY_H
