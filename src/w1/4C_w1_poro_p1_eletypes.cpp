    ...
    Core::Nodes::Node& node, std::span<const double> x0, const int numdof)
{
  switch (numdof)
  {
    ...
    default:
      FOUR_C_THROW(
          "The computation of a {}-dimensional null space is not yet implemented for the wall "
          "quad4 poro P1 element.",
          numdof);
  }
}
    ...
    Core::Nodes::Node& node, std::span<const double> x0, const int numdof)
{
  switch (numdof)
  {
    ...
    default:
      FOUR_C_THROW(
          "The computation of a {}-dimensional null space is not yet implemented for the wall tri3 "
          "poro P1 element.",
          numdof);
  }
}
