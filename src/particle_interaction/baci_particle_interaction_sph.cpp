...
/*---------------------------------------------------------------------------*
 | headers                                                                   |
 *---------------------------------------------------------------------------*/
#include "baci_particle_interaction_sph.hpp"
...
#include "baci_particle_interaction_sph_boundary_particle.hpp"
...
#include "baci_particle_interaction_sph_momentum.hpp"
...
#include "baci_particle_interaction_sph_pressure.hpp"
#include "baci_particle_interaction_sph_rigid_particle_contact.hpp"
#include "baci_particle_interaction_sph_surface_tension.hpp"
#include "baci_particle_interaction_sph_temperature.hpp"
