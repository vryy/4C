...
/*---------------------------------------------------------------------------*
 | definitions                                                               |
 *---------------------------------------------------------------------------*/
#ifndef BACI_PARTICLE_INTERACTION_SPH_SURFACE_TENSION_INTERFACE_VISCOSITY_HPP
#define BACI_PARTICLE_INTERACTION_SPH_SURFACE_TENSION_INTERFACE_VISCOSITY_HPP
