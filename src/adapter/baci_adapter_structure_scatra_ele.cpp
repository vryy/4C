...
INPAR::SCATRA::ImplType ADAPTER::GetScaTraImplType(DRT::Element* ele)
{
  ...
  {
    impltype = (dynamic_cast<DRT::ELEMENTS::So3_Scatra<DRT::ELEMENTS::So_tet4,
  ...
  {
    impltype = (dynamic_cast<DRT::ELEMENTS::So3_Scatra<DRT::ELEMENTS::So_tet10,
  ...
  {
    impltype = (dynamic_cast<DRT::ELEMENTS::So3_Scatra<DRT::ELEMENTS::So_hex8,
  ...
  {
    impltype = (dynamic_cast<DRT::ELEMENTS::So3_Scatra<DRT::ELEMENTS::So_hex8fbar,
                    DRT::Element::DiscretizationType::hex8>*>(ele))
                   ->ImplType();
  }
  // hex27 solid scatra
  ...
  {
    impltype = (dynamic_cast<DRT::ELEMENTS::So3_Scatra<DRT::ELEMENTS::So_hex27,
  ...
  {
    impltype = (dynamic_cast<DRT::ELEMENTS::So3_Scatra<DRT::ELEMENTS::So_weg6,
                    DRT::Element::DiscretizationType::wedge6>*>(ele))
                   ->ImplType();
  }
  ...
  {
    impltype =
        (dynamic_cast<DRT::ELEMENTS::MembraneScatra<DRT::Element::DiscretizationType::tri3>*>(ele))
            ->ImplType();
  }
  ...
  {
    impltype =
        (dynamic_cast<DRT::ELEMENTS::MembraneScatra<DRT::Element::DiscretizationType::tri6>*>(ele))
            ->ImplType();
  }
  ...
  {
    impltype =
        (dynamic_cast<DRT::ELEMENTS::MembraneScatra<DRT::Element::DiscretizationType::quad4>*>(ele))
            ->ImplType();
  }
  ...
  {
    impltype =
        (dynamic_cast<DRT::ELEMENTS::MembraneScatra<DRT::Element::DiscretizationType::quad9>*>(ele))
            ->ImplType();
  }
