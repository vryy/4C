...
namespace Adapter
{
  class FPSIStructureWrapper : public FSIStructureWrapper
  {
    ...
    */
    virtual Teuchos::RCP<Core::LinAlg::Vector> extract_interface_dispn(bool FPSI = false);
    ...
    */
    virtual Teuchos::RCP<Core::LinAlg::Vector> extract_interface_dispnp(bool FPSI = false);
  };
}  // namespace Adapter
