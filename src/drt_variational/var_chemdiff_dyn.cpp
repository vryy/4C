...
/*----------------------------------------------------------------------*/
 ...
 void print_var_logo()
 {
   // more at http://www.ascii-art.de under entry "wodka" (a minor but vital modification has been implemented)
  std::cout<<"            |HH|  "<<std::endl;
  std::cout<<"            )  (  "<<std::endl;
  std::cout<<"            (  )  "<<std::endl;
  std::cout<<"           _)  (_ "<<"  __        __     ___         _______          "<<std::endl;
  std::cout<<"          |      |  "<<"\\X\\ \\      / /  /X/ _ \\     |X|  __   \\    "<<std::endl;
  std::cout<<"          ||||||||  "<<" \\X\\ \\    / /  /X/ /_\\ \\    |X| |__/  /    "<<std::endl;
  std::cout<<"   ____   | CHEM |  "<<"  \\X\\ \\  / /  /X/  ___  \\   |X|  _   /      "<<std::endl;
  std::cout<<"  |~~~~~| |Diffus|  "<<"   \\X\\ \\/ /  /X/  / \\X\\  \\  |X| |\\X\\ \\ "<<std::endl;
