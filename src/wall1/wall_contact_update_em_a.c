...
Newton iteration within the E-M conserving integration scheme.
...
---------------------------------------------------------------------*/
void wall_contact_update_em_a(FIELD *actfield, INTRA *actintra)
{
...
#ifdef DEBUG 
dstrc_enter("wall_contact_update_em_a");
#endif
/*----------------------------------------------------------------------*/
...
/* end of wall_contact_update_em_a*/
