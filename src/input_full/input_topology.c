...
if (actdis->gsurf != tmpgsurf) 
{
   ...
   for (i=0; i<actdis->numele; i++)
   {
      ...
      break;
      default:
         dserror("Unknown type of discretization");
      break;
      }
...
for (i=0; i<actdis->numele; i++)
{
   ...
   switch (actele->distyp)
   {
   case quad4: actgsurf = actele->g.gsurf; isgvol=0; nnodeperline=2; break; 
   case quad8: actgsurf = actele->g.gsurf; isgvol=0; nnodeperline=3; break; 
   case quad9: actgsurf = actele->g.gsurf; isgvol=0; nnodeperline=3; break; 
   case tri3:  actgsurf = actele->g.gsurf; isgvol=0; nnodeperline=2; break; 
   case tri6:  actgsurf = actele->g.gsurf; isgvol=0; nnodeperline=3; break; 
...
case tet10: 
   ...
   linenodes[5][2] = actele->node[3]->Id;
break;
default: dserror("Unknown type of discretization"); 
break;
}
/*----------------------------------------------------------------------*/
#ifdef DEBUG 
...
for (i=0; i<npatch; i++)
{
   ...
   else dserror("Unknown type of element");
