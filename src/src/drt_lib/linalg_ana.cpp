...
{
#if DEBUGGING_ANA
  cout << "double operator* (const LINALG::ANA::Vector& vec1, const LINALG::ANA::Vector& vec2)" << endl; fflush(stdout);
#endif
  double result;
...
{
#if DEBUGGING_ANA
  cout << "double operator* (const LINALG::ANA::LCBase& left, const LINALG::ANA::LCBase& right)" << endl; fflush(stdout);
#endif
...
{
#if DEBUGGING_ANA
  cout << "double operator* (const LINALG::ANA::Vector& vec1, const LINALG::ANA::LCBase& right)" << endl; fflush(stdout);
#endif
 ...
 *----------------------------------------------------------------------*/
double LINALG::ANA::operator* (const LINALG::ANA::Vector& vec1, const LINALG::ANA::LC_s_times_vec& right)
{
#if DEBUGGING_ANA
  cout << "double operator* (const LINALG::ANA::Vector& vec1, const LINALG::ANA::LC_s_times_vec& right)" << endl; fflush(stdout);
#endif
  double result;
 ...
 *----------------------------------------------------------------------*/
double LINALG::ANA::operator* (const LINALG::ANA::LC_s_times_vec& left, const LINALG::ANA::LC_s_times_vec& right)
{
#if DEBUGGING_ANA
  cout << "double operator* (const LINALG::ANA::LC_s_times_vec& left, const LINALG::ANA::LC_s_times_vec& right)" << endl; fflush(stdout);
#endif
  double result;
