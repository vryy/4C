...
/*!---------------------------------------------------------------------
\brief routine to calculate submesh stability parameter for fluid3
...
/*--------------------------------------------------- norm of velocity */
   velno = sqrt(velint[0]*velint[0]+velint[1]*velint[1]+velint[2]*velint[2]);
...
/*------------------------------------ norm of rate-of-velocity tensor */
   norovt = sqrt(TWO*(vderxy[0][0]*vderxy[0][0]+vderxy[1][1]*vderxy[1][1]\
                     +vderxy[2][2]*vderxy[2][2]+vderxy[0][1]*vderxy[1][0]\
