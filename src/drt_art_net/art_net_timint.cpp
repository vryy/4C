...
ART::TimInt::TimInt(Teuchos::RCP<DRT::Discretization>  actdis,
...
coupledTo3D_(false)
{
  ...
  if(linsolvernumber_ == -1)
    dserror("Set a valid linear solver for arterial network");
}
 ...
 *------------------------------------------------------------------------*/
void ART::TimInt::Init(
    const Teuchos::ParameterList& globaltimeparams,
    const Teuchos::ParameterList& arteryparams,
    const std::string& scatra_disname)
{
  solver_ = Teuchos::rcp( new LINALG::Solver(DRT::Problem::Instance()->SolverParams(linsolvernumber_),
                                                     discret_->Comm(),
                                                     errfile_ ));
...
//<><><><><><><><><><><><><><><><><><><><><><><><><><><><><><><><><><><>//
//<><><><><><><><><><><><><><><><><><><><><><><><><><><><><><><><><><><>//
void ART::TimInt::Integrate(bool CoupledTo3D,
...
//<><><><><><><><><><><><><><><><><><><><><><><><><><><><><><><><><><><>//
//<><><><><><><><><><><><><><><><><><><><><><><><><><><><><><><><><><><>//
void ART::TimInt::TimeLoop(bool CoupledTo3D,
