...
//<><><><><><><><><><><><><><><><><><><><><><><><><><><><><><><><><><><>//
//<><><><><><><><><><><><><><><><><><><><><><><><><><><><><><><><><><><>//
void ART::ArtNetImplStationary::Init(
    ...
    )
{
  ...
  // -------------------------------------------------------------------
  SetInitialField(
      DRT::INPUT::IntegralValue<INPAR::ARTDYN::InitialField>(
          arteryparams, "INITIALFIELD"), arteryparams.get<int>("INITFUNCNO"));


  if(solvescatra_)
  {
    const Teuchos::ParameterList& myscatraparams = DRT::Problem::Instance()->ScalarTransportDynamicParams();
    ...
    scatra_->Init(
        globaltimeparams,
        myscatraparams,
        DRT::Problem::Instance()->SolverParams(linsolvernumber_),
        scatra_disname,
        false);
 ...
 *----------------------------------------------------------------------*/
ART::ArtNetImplStationary::~ArtNetImplStationary()
{
  return;
}
...
void ART::ArtNetImplStationary::ApplyDirichletBC()
{
  ...
  discret_->ClearState();
  discret_->EvaluateDirichlet(p,pressurenp_,Teuchos::null,Teuchos::null,Teuchos::null,dbcmaps_);
  discret_->ClearState();
}
 ...
 *----------------------------------------------------------------------*/
void ART::ArtNetImplStationary::ApplyNeumannBC(
...
//<><><><><><><><><><><><><><><><><><><><><><><><><><><><><><><><><><><>//
//<><><><><><><><><><><><><><><><><><><><><><><><><><><><><><><><><><><>//
void ART::ArtNetImplStationary::Output(bool               CoupledTo3D,
...
//<><><><><><><><><><><><><><><><><><><><><><><><><><><><><><><><><><><>//
//<><><><><><><><><><><><><><><><><><><><><><><><><><><><><><><><><><><>//
void ART::ArtNetImplStationary::ReadRestart(int step,
                                             bool coupledTo3D)
{
...
void ART::ArtNetImplStationary::SetInitialField(
    const INPAR::ARTDYN::InitialField init,
