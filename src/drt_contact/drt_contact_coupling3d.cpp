 ...
 *----------------------------------------------------------------------*/
CONTACT::Coupling3d::Coupling3d(const Interface::ShapeFcnType shapefcn,
...
bool CONTACT::Coupling3d::IntegrateCells()
{
  ...
  CONTACT::Integrator integrator(shapefcn_,Cells()[0]->Shape());
...
CONTACT::Coupling3d(Interface::Undefined,idiscret,dim,quad,auxplane,sele,mele),
sintele_(sintele),
mintele_(mintele)
{
...
/*----------------------------------------------------------------------*
 |  ctor (public)                                             popp 06/09|
 *----------------------------------------------------------------------*/
CONTACT::Coupling3dQuad::Coupling3dQuad(const Interface::ShapeFcnType shapefcn,
                                DRT::Discretization& idiscret, int dim, bool quad,
                                bool auxplane,
                                CONTACT::CElement& sele, CONTACT::CElement& mele,
                                CONTACT::IntElement& sintele,
                                CONTACT::IntElement& mintele) :
CONTACT::Coupling3d(shapefcn,idiscret,dim,quad,auxplane,sele,mele),
sintele_(sintele),
mintele_(mintele)
{
  // 3D quadratic coupling only for aux. plane case
