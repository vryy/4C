/*!----------------------------------------------------------------------
\file constraint_element2_evaluate.cpp
                                    ...
                                    Epetra_SerialDenseVector& elevec3)
{
  ...
  else if (action=="calc_MPC_stiff")
  {
    ...
    else if (*type == "angle") act = calc_MPC_angle_stiff;
...
double DRT::ELEMENTS::ConstraintElement2::ComputeAngle
(
  const LINALG::Matrix<3,2>& xc
)
{
...
/*----------------------------------------------------------------------*
 * second derivatives */
void DRT::ELEMENTS::ConstraintElement2::ComputeSecondDerivDist
(
  const LINALG::Matrix<3,2>& xc,
