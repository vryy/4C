    ...
    Epetra_SerialDenseVector& elevec3)
{
   ...
   *(allows connectin Truss2 and beam3 directly)*/
...
int DRT::ELEMENTS::Truss2::EvaluateStatForceDamp(ParameterList& params,
                                                ...
                                                int& ActNumDof0)
{
  ...
  return 0;
} //DRT::ELEMENTS::Truss2::EvaluateStatisticalNeumann
