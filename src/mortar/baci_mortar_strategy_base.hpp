...
*/
/*----------------------------------------------------------------------*/
#ifndef BACI_MORTAR_STRATEGY_BASE_HPP
#define BACI_MORTAR_STRATEGY_BASE_HPP

#include "baci_config.hpp"

#include "baci_inpar_contact.hpp"     // for the INPAR::CONTACT enums
#include "baci_mortar_interface.hpp"  // for the enum state type
#include "baci_solver_nonlin_nox_constraint_interface_preconditioner.hpp"  // interface specifications
