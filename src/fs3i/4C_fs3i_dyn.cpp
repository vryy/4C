...
void fs3i_dyn()
{
  ...
  switch (probtype)
  {
    ...
    {
      fs3i = Teuchos::make_rcp<FS3I::PartFS3I1Wc>(comm);
    }
    break;
    case Core::ProblemType::thermo_fsi:
    {
      fs3i = Teuchos::make_rcp<FS3I::PartFS3I2Wc>(comm);
    }
    break;
    case Core::ProblemType::biofilm_fsi:
    {
      fs3i = Teuchos::make_rcp<FS3I::BiofilmFSI>(comm);
    }
    break;
    case Core::ProblemType::fps3i:
    {
      fs3i = Teuchos::make_rcp<FS3I::PartFpS3I1Wc>(comm);
    }
    break;
    default:
