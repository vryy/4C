/*----------------------------------------------------------------------*/
/*!
 \file so3_poro_p1_scatra_eletypes.cpp
...
Teuchos::RCP<DRT::Element> DRT::ELEMENTS::So_hex8PoroP1ScatraType::Create( const std::string eletype,
                                                            ...
                                                            const int owner )
{
  ...
  {
    Teuchos::RCP<DRT::Element> ele = Teuchos::rcp(new DRT::ELEMENTS::So3_Poro_P1_Scatra<DRT::ELEMENTS::So_hex8, DRT::Element::hex8>
                                                                    (id,owner));
    return ele;
  }
  return Teuchos::null;
...
Teuchos::RCP<DRT::Element> DRT::ELEMENTS::So_hex8PoroP1ScatraType::Create( const int id, const int owner )
{
  Teuchos::RCP<DRT::Element> ele = Teuchos::rcp(new DRT::ELEMENTS::So3_Poro_P1_Scatra<DRT::ELEMENTS::So_hex8, DRT::Element::hex8>
                                                                        (id,owner));
  return ele;
...
void DRT::ELEMENTS::So_hex8PoroP1ScatraType::SetupElementDefinition( std::map<std::string,std::map<std::string,DRT::INPUT::LineDefinition> > & definitions )
{
  ...
  std::map<std::string, DRT::INPUT::LineDefinition>& defs =
      definitions["SOLIDH8POROP1SCATRA"];
...
Teuchos::RCP<DRT::Element> DRT::ELEMENTS::So_tet4PoroP1ScatraType::Create( const std::string eletype,
                                                            const std::string eledistype,
                                                            const int id,
                                                            const int owner )
{
  ...
  {
    Teuchos::RCP<DRT::Element> ele = Teuchos::rcp(new DRT::ELEMENTS::So3_Poro_P1_Scatra<DRT::ELEMENTS::So_tet4, DRT::Element::tet4>
                                                                    (id,owner));
    return ele;
  }
  return Teuchos::null;
...
Teuchos::RCP<DRT::Element> DRT::ELEMENTS::So_tet4PoroP1ScatraType::Create( const int id, const int owner )
{
  Teuchos::RCP<DRT::Element> ele = Teuchos::rcp(new DRT::ELEMENTS::So3_Poro_P1_Scatra<DRT::ELEMENTS::So_tet4, DRT::Element::tet4>
                                                                   (id,owner));
  return ele;
...
void DRT::ELEMENTS::So_tet4PoroP1ScatraType::SetupElementDefinition( std::map<std::string,std::map<std::string,DRT::INPUT::LineDefinition> > & definitions )
{
  ...
  std::map<std::string, DRT::INPUT::LineDefinition>& defs_tet4 =
      definitions_tet4["SOLIDT4POROP1"];

  std::map<std::string, DRT::INPUT::LineDefinition>& defs =
      definitions["SOLIDT4POROP1SCATRA"];
