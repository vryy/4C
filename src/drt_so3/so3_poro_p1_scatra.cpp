...
/*!
 ...
 \brief implementation of the 3D solid-poro element (p1, mixed approach) including scatra functionality
...
So3_Poro_P1<so3_ele,distype>(id,owner),
 ...
 *----------------------------------------------------------------------*/
template<class so3_ele, DRT::Element::DiscretizationType distype>
DRT::ELEMENTS::So3_Poro_P1_Scatra<so3_ele,distype>::So3_Poro_P1_Scatra(const DRT::ELEMENTS::So3_Poro_P1_Scatra<so3_ele,distype>& old):
So3_Poro_P1<so3_ele,distype>(old),
 ...
 *----------------------------------------------------------------------*/
template<class so3_ele, DRT::Element::DiscretizationType distype>
bool DRT::ELEMENTS::So3_Poro_P1_Scatra<so3_ele,distype>::ReadElement(const std::string& eletype,
