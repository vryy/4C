                                    ...
                                    Epetra_SerialDenseVector& elevec3)
{
  ...
  else if (action=="calc_struct_update_imrlike") act = So_ctet10::calc_struct_update_imrlike;
  else if (action=="calc_struct_reset_istep")   act = So_ctet10::calc_struct_reset_istep;
