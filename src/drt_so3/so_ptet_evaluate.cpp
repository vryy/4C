                                  ...
                                  const int                 gp)
{
  ...
  else if (action=="multi_calc_dens")                     act = Ptet::multi_calc_dens;
  ...
  switch(act)
  {
    ...
    case calc_struct_nlnstifflmass:
    {
      ...
      ptetnlnstiffmass(lm,mydisp,myres,&elemat1,&elemat2,&elevec1,gp,params);
    ...
    case calc_struct_nlnstiff:
    {
      ...
      ptetnlnstiffmass(lm,mydisp,myres,elemat1ptr,NULL,&elevec1,gp,params);
    }
    break;
    ...
    case calc_struct_internalforce:
    {
      ...
      ptetnlnstiffmass(lm,mydisp,myres,&myemat,NULL,&elevec1,gp,params);
    }
    break;
      ...
      Teuchos::ParameterList& params)  // parameter list for communication
{
  ...
  */
  ...
  double density = -999.99;
  {
    ...
    SelectMaterial(stress,cmat,density,glstrainbar,Fbar,0,params);
                      ...
                      Teuchos::ParameterList& params)
{
  ...
  switch (mat->MaterialType())
  {
    ...
    case INPAR::MAT::m_elasthyper: /*----------- general hyperelastic matrial */
    {
      ...
      hyper->Evaluate(glstrain,cmat,stress,gp,params);
