                                    ...
                                    Epetra_SerialDenseVector& elevec3_epetra)
{
  ...
  else if (action=="calc_struct_linstiff")                        act = So_pyramid5fbar::calc_struct_linstiff;
  else if (action=="calc_struct_nlnstiff")                        act = So_pyramid5fbar::calc_struct_nlnstiff;
  else if (action=="calc_struct_internalforce")                   act = So_pyramid5fbar::calc_struct_internalforce;
  else if (action=="calc_struct_linstiffmass")                    act = So_pyramid5fbar::calc_struct_linstiffmass;
  else if (action=="calc_struct_nlnstiffmass")                    act = So_pyramid5fbar::calc_struct_nlnstiffmass;
  else if (action=="calc_struct_nlnstifflmass")                   act = So_pyramid5fbar::calc_struct_nlnstifflmass;
  else if (action=="calc_struct_stress")                          act = So_pyramid5fbar::calc_struct_stress;
  else if (action=="calc_struct_eleload")                         act = So_pyramid5fbar::calc_struct_eleload;
  else if (action=="calc_struct_fsiload")                         act = So_pyramid5fbar::calc_struct_fsiload;
  else if (action=="calc_struct_update_istep")                    act = So_pyramid5fbar::calc_struct_update_istep;
  else if (action=="calc_struct_reset_istep")                     act = So_pyramid5fbar::calc_struct_reset_istep;
  else if (action=="calc_struct_reset_all")                       act = So_pyramid5fbar::calc_struct_reset_all;
  else if (action=="postprocess_stress")                          act = So_pyramid5fbar::postprocess_stress;
  else if (action=="multi_readrestart")                           act = So_pyramid5fbar::multi_readrestart;
  ...
  switch(act)
  {
    ...
    case calc_struct_nlnstiff:
    {
      ...
      nlnstiffmass(lm,mydisp,NULL,NULL,myres,mydispmat,matptr,NULL,&elevec1,NULL,NULL,NULL,NULL,NULL,params,
                                  INPAR::STR::stress_none,INPAR::STR::strain_none,INPAR::STR::strain_none);
    }
    break;
 ...
 *----------------------------------------------------------------------*/
void DRT::ELEMENTS::So_pyramid5fbar::nlnstiffmass(
...
int DRT::ELEMENTS::So_pyramid5fbarType::Initialize(DRT::Discretization& dis)
{
  for (int i=0; i<dis.NumMyColElements(); ++i)
  {
    ...
    DRT::ELEMENTS::So_pyramid5fbar* actele = dynamic_cast<DRT::ELEMENTS::So_pyramid5fbar*>(dis.lColElement(i));
