...
DRT::ELEMENTS::So_pyramid5Type & DRT::ELEMENTS::So_pyramid5Type::Instance()
{
  return instance_;
}
...
Teuchos::RCP<DRT::Element> DRT::ELEMENTS::So_pyramid5Type::Create( const std::string eletype,
...
void DRT::ELEMENTS::So_pyramid5Type::NodalBlockInformation( DRT::Element * dwele, int & numdf, int & dimns, int & nv, int & np )
{
  numdf = 3;
  dimns = 6;
  nv = 3;
...
void DRT::ELEMENTS::So_pyramid5Type::ComputeNullSpace( DRT::Discretization & dis, std::vector<double> & ns, const double * x0, int numdf, int dimns )
{
  DRT::UTILS::ComputeStructure3DNullSpace( dis, ns, x0, numdf, dimns );
}

void DRT::ELEMENTS::So_pyramid5Type::SetupElementDefinition( std::map<std::string,std::map<std::string,DRT::INPUT::LineDefinition> > & definitions )
{
...
/*----------------------------------------------------------------------*
 |  dtor (public)                                                       |
 *----------------------------------------------------------------------*/
DRT::ELEMENTS::So_pyramid5::~So_pyramid5()
{
  return;
}
...
(
    LINALG::Matrix<NUMGPT_SOP5,MAT::NUM_STRESS_3D>& stresses,
