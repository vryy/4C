...
Teuchos::RCP<DRT::Element> DRT::ELEMENTS::So_hex8PoroScatraType::Create( const std::string eletype,
                                                            ...
                                                            const int owner )
{
  ...
  {
    Teuchos::RCP<DRT::Element> ele = Teuchos::rcp(new DRT::ELEMENTS::So3_Poro_Scatra<DRT::ELEMENTS::So_hex8, DRT::Element::hex8>
                                                                    (id,owner));
    return ele;
  }
  return Teuchos::null;
...
Teuchos::RCP<DRT::Element> DRT::ELEMENTS::So_hex8PoroScatraType::Create( const int id, const int owner )
{
  Teuchos::RCP<DRT::Element> ele = Teuchos::rcp(new DRT::ELEMENTS::So3_Poro_Scatra<DRT::ELEMENTS::So_hex8, DRT::Element::hex8>
                                                                        (id,owner));
  return ele;
...
void DRT::ELEMENTS::So_hex8PoroScatraType::SetupElementDefinition( std::map<std::string,std::map<std::string,DRT::INPUT::LineDefinition> > & definitions )
{
  ...
  std::map<std::string, DRT::INPUT::LineDefinition>& defs_hex8 =
      definitions_hex8["SOLIDH8PORO"];

  std::map<std::string, DRT::INPUT::LineDefinition>& defs =
      definitions["SOLIDH8POROSCATRA"];
...
Teuchos::RCP<DRT::Element> DRT::ELEMENTS::So_tet4PoroScatraType::Create( const std::string eletype,
                                                            const std::string eledistype,
                                                            const int id,
                                                            const int owner )
{
  ...
  {
    Teuchos::RCP<DRT::Element> ele = Teuchos::rcp(new DRT::ELEMENTS::So3_Poro_Scatra<DRT::ELEMENTS::So_tet4, DRT::Element::tet4>
                                                                    (id,owner));
    return ele;
  }
  return Teuchos::null;
...
Teuchos::RCP<DRT::Element> DRT::ELEMENTS::So_tet4PoroScatraType::Create( const int id, const int owner )
{
  Teuchos::RCP<DRT::Element> ele = Teuchos::rcp(new DRT::ELEMENTS::So3_Poro_Scatra<DRT::ELEMENTS::So_tet4, DRT::Element::tet4>
                                                                   (id,owner));
  return ele;
...
void DRT::ELEMENTS::So_tet4PoroScatraType::SetupElementDefinition( std::map<std::string,std::map<std::string,DRT::INPUT::LineDefinition> > & definitions )
{
...
Teuchos::RCP<DRT::Element> DRT::ELEMENTS::So_hex27PoroScatraType::Create( const std::string eletype,
                                                            const std::string eledistype,
                                                            const int id,
                                                            const int owner )
{
  ...
  {
    Teuchos::RCP<DRT::Element> ele = Teuchos::rcp(new DRT::ELEMENTS::So3_Poro_Scatra<DRT::ELEMENTS::So_hex27, DRT::Element::hex27>
                                                                    (id,owner));
    return ele;
  }
  return Teuchos::null;
...
Teuchos::RCP<DRT::Element> DRT::ELEMENTS::So_hex27PoroScatraType::Create( const int id, const int owner )
{
  Teuchos::RCP<DRT::Element> ele = Teuchos::rcp(new DRT::ELEMENTS::So3_Poro_Scatra<DRT::ELEMENTS::So_hex27, DRT::Element::hex27>
                                                                   (id,owner));
  return ele;
...
void DRT::ELEMENTS::So_hex27PoroScatraType::SetupElementDefinition( std::map<std::string,std::map<std::string,DRT::INPUT::LineDefinition> > & definitions )
{
  ...
  std::map<std::string, DRT::INPUT::LineDefinition>& defs_hex27 =
      definitions_hex27["SOLIDH27PORO"];

  std::map<std::string, DRT::INPUT::LineDefinition>& defs =
      definitions["SOLIDH27POROSCATRA"];
...
Teuchos::RCP<DRT::Element> DRT::ELEMENTS::So_tet10PoroScatraType::Create( const std::string eletype,
                                                            const std::string eledistype,
                                                            const int id,
                                                            const int owner )
{
  ...
  {
    Teuchos::RCP<DRT::Element> ele = Teuchos::rcp(new DRT::ELEMENTS::So3_Poro_Scatra<DRT::ELEMENTS::So_tet10, DRT::Element::tet10>
                                                                    (id,owner));
    return ele;
  }
  return Teuchos::null;
...
Teuchos::RCP<DRT::Element> DRT::ELEMENTS::So_tet10PoroScatraType::Create( const int id, const int owner )
{
  Teuchos::RCP<DRT::Element> ele = Teuchos::rcp(new DRT::ELEMENTS::So3_Poro_Scatra<DRT::ELEMENTS::So_tet10, DRT::Element::tet10>
                                                                   (id,owner));
  return ele;
...
void DRT::ELEMENTS::So_tet10PoroScatraType::SetupElementDefinition( std::map<std::string,std::map<std::string,DRT::INPUT::LineDefinition> > & definitions )
{
  ...
  std::map<std::string, DRT::INPUT::LineDefinition>& defs_tet10 =
      definitions_tet10["SOLIDT10PORO"];

  std::map<std::string, DRT::INPUT::LineDefinition>& defs =
      definitions["SOLIDT10POROSCATRA"];
...
DRT::ParObject* DRT::ELEMENTS::So_nurbs27PoroScatraType::Create( const std::vector<char> & data )
{
  DRT::ELEMENTS::So3_Poro_Scatra<DRT::ELEMENTS::NURBS::So_nurbs27, DRT::Element::nurbs27>* object =
        new DRT::ELEMENTS::So3_Poro_Scatra<DRT::ELEMENTS::NURBS::So_nurbs27, DRT::Element::nurbs27>(-1,-1);
  object->Unpack(data);
  return object;
}

Teuchos::RCP<DRT::Element> DRT::ELEMENTS::So_nurbs27PoroScatraType::Create( const std::string eletype,
                                                            const std::string eledistype,
                                                            const int id,
                                                            const int owner )
{
  ...
  {
    Teuchos::RCP<DRT::Element> ele = Teuchos::rcp(new DRT::ELEMENTS::So3_Poro_Scatra<DRT::ELEMENTS::NURBS::So_nurbs27, DRT::Element::nurbs27>
                                                                    (id,owner));
    return ele;
  }
  return Teuchos::null;
...
Teuchos::RCP<DRT::Element> DRT::ELEMENTS::So_nurbs27PoroScatraType::Create( const int id, const int owner )
{
  Teuchos::RCP<DRT::Element> ele = Teuchos::rcp(new DRT::ELEMENTS::So3_Poro_Scatra<DRT::ELEMENTS::NURBS::So_nurbs27, DRT::Element::nurbs27>
                                                                   (id,owner));
  return ele;
...
void DRT::ELEMENTS::So_nurbs27PoroScatraType::SetupElementDefinition( std::map<std::string,std::map<std::string,DRT::INPUT::LineDefinition> > & definitions )
{
  ...
  std::map<std::string, DRT::INPUT::LineDefinition>& defs =
      definitions["SONURBS27POROSCATRA"];
