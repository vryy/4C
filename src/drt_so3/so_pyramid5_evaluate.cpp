    ...
    Epetra_SerialDenseVector& elevec3_epetra)
{
  ...
  switch (act)
  {
    ...
    case calc_struct_linstiff:
    {
      ...
      sop5_nlnstiffmass(lm, mydisp, NULL, NULL, myres, mydispmat, &elemat1, NULL, &elevec1, NULL,
    ...
    case calc_struct_nlnstiff:
    {
      ...
      {
        sop5_nlnstiffmass(lm, mydisp, NULL, NULL, myres, mydispmat, matptr, NULL, &elevec1, NULL,
            NULL, NULL, NULL, NULL, params, INPAR::STR::stress_none, INPAR::STR::strain_none,
            INPAR::STR::strain_none);
      }
    }
    ...
    case calc_struct_internalforce:
    {
      ...
      {
        sop5_nlnstiffmass(lm, mydisp, NULL, NULL, myres, mydispmat, &myemat, NULL, &elevec1, NULL,
            NULL, NULL, NULL, NULL, params, INPAR::STR::stress_none, INPAR::STR::strain_none,
            INPAR::STR::strain_none);
      }
    }
    ...
    case calc_struct_stress:
    {
      ...
      if (discretization.Comm().MyPID() == Owner())
      {
        ...
        if (kintype_ == INPAR::STR::kinem_linear)
        {
          sop5_linstiffmass(lm, mydisp, myres, NULL, NULL, NULL, &stress, &strain, &plstrain,
              params, iostress, iostrain, ioplstrain);
        }
        // standard is: geometrically non-linear with Total Lagrangean approach
        else
        {
          sop5_nlnstiffmass(lm, mydisp, NULL, NULL, myres, mydispmat, NULL, NULL, NULL, NULL, NULL,
...
int DRT::ELEMENTS::So_pyramid5Type::Initialize(DRT::Discretization& dis)
{
  for (int i = 0; i < dis.NumMyColElements(); ++i)
  {
    ...
    DRT::ELEMENTS::So_pyramid5* actele =
        dynamic_cast<DRT::ELEMENTS::So_pyramid5*>(dis.lColElement(i));
