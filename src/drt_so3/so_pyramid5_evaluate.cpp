                                    ...
                                    Epetra_SerialDenseVector& elevec3_epetra)
{
  ...
  else if (action=="calc_struct_linstiff")                        act = So_pyramid5::calc_struct_linstiff;
  else if (action=="calc_struct_nlnstiff")                        act = So_pyramid5::calc_struct_nlnstiff;
  else if (action=="calc_struct_internalforce")                   act = So_pyramid5::calc_struct_internalforce;
  else if (action=="calc_struct_linstiffmass")                    act = So_pyramid5::calc_struct_linstiffmass;
  else if (action=="calc_struct_nlnstiffmass")                    act = So_pyramid5::calc_struct_nlnstiffmass;
  else if (action=="calc_struct_nlnstifflmass")                   act = So_pyramid5::calc_struct_nlnstifflmass;
  else if (action=="calc_struct_stress")                          act = So_pyramid5::calc_struct_stress;
  else if (action=="calc_struct_eleload")                         act = So_pyramid5::calc_struct_eleload;
  else if (action=="calc_struct_fsiload")                         act = So_pyramid5::calc_struct_fsiload;
  else if (action=="calc_struct_update_istep")                    act = So_pyramid5::calc_struct_update_istep;
  else if (action=="calc_struct_prestress_update")                act = So_pyramid5::prestress_update;
  else if (action=="calc_struct_reset_istep")                     act = So_pyramid5::calc_struct_reset_istep;
  else if (action=="calc_struct_energy")                          act = So_pyramid5::calc_struct_energy;
  else if (action=="calc_struct_errornorms")                      act = So_pyramid5::calc_struct_errornorms;
  ...
  switch(act)
  {
    ...
    case calc_struct_nlnstiff:
    {
      ...
      {
        sop5_linstiffmass(lm,mydisp,myres,matptr,NULL,&elevec1,NULL,NULL,NULL,params,
                           INPAR::STR::stress_none,INPAR::STR::strain_none,INPAR::STR::strain_none);
      }
    ...
    case calc_struct_internalforce:
    {
      ...
      if (kintype_ == INPAR::STR::kinem_linear)
      {
        sop5_linstiffmass(lm,mydisp,myres,&myemat,NULL,&elevec1,NULL,NULL,NULL,params,
                           INPAR::STR::stress_none,INPAR::STR::strain_none,INPAR::STR::strain_none);
      }
      // standard is: geometrically non-linear with Total Lagrangean approach
      else
    ...
    case calc_struct_nlnstifflmass:
    {
      ...
      if (kintype_ == INPAR::STR::kinem_linear)
      {
        sop5_linstiffmass(lm,mydisp,myres,&elemat1,&elemat2,&elevec1,NULL,NULL,NULL,params,
                           INPAR::STR::stress_none,INPAR::STR::strain_none,INPAR::STR::strain_none);
      }
      // standard is: geometrically non-linear with Total Lagrangean approach
      else
    ...
    case calc_struct_stress:
    {
      ...
      if (discretization.Comm().MyPID()==Owner())
      {
        ...
        if (kintype_ == INPAR::STR::kinem_linear)
        {
          sop5_linstiffmass(lm,mydisp,myres,NULL,NULL,NULL,&stress,&strain,&plstrain,params,iostress,iostrain,ioplstrain);
        }
        // standard is: geometrically non-linear with Total Lagrangean approach
        else
        {
                                             ...
                                             Epetra_SerialDenseMatrix* elemat1)
{
  ...
  */
  ...
  std::vector<double> curvefacs(NUMDIM_SOP5, 1.0);
 ...
 *----------------------------------------------------------------------*/
void DRT::ELEMENTS::So_pyramid5::sop5_linstiffmass(
 ...
 *----------------------------------------------------------------------*/
const std::vector<LINALG::Matrix<NUMDIM_SOP5,NUMNOD_SOP5> > DRT::ELEMENTS::So_pyramid5::sop5_derivs()
{
...
int DRT::ELEMENTS::So_pyramid5Type::Initialize(DRT::Discretization& dis)
{
  for (int i=0; i<dis.NumMyColElements(); ++i)
  {
    ...
    DRT::ELEMENTS::So_pyramid5* actele = dynamic_cast<DRT::ELEMENTS::So_pyramid5*>(dis.lColElement(i));
 ...
 *----------------------------------------------------------------------*/
void DRT::ELEMENTS::So_pyramid5::GLtoEA(
  LINALG::Matrix<MAT::NUM_STRESS_3D,1>* glstrain,
