...
/*----------------------------------------------------------------------*
 |                                                         vlf 06/07    |
 | recursive computation of determinant of a  matrix                    |
 |                              										|
 *----------------------------------------------------------------------*/
...
/* ============================================================================*/
  ...
  /*#endif //TET_NO_IMPLEMENT //not yet implemented
   dserror("DRT::Elements::So_tet10::EvaluateNeumann not yet implemented");*/
  return 0;
...
/* ============================================================================*/
  ...
  for (int gp=0; gp<NUMGPT_SOTET10; gp++) {
    ...
    //Epetra_SerialDenseMatrix deriv_gp_trans(NUMCOORD_SOTET10,NUMNOD_SOTET10 );
    ...
    for (int shape_func=0; shape_func<NUMNOD_SOTET10; shape_func++) {
      for (int ksi_num=0;ksi_num<NUMCOORD_SOTET10; ksi_num++) {
        ...
        //deriv_gp_trans(ksi_num,shape_func)=(*deriv)(NUMNOD_SOTET10*ksi_num+shape_func,gp);
      }
    }
    ...
    */
    ...
    jac_temp.Multiply('T','N',1.0,xrefe,deriv_gp,0.0);
    ...
    */
	...
	detJ=detJ/6; //volume of a tetrahedra	
    ...
    */   
    ...
    N_XYZ.Multiply('N','N',1.0,deriv_gp,partials,0.0); //N_XYZ = N_xsi_k*partials
    /* structure of N_XYZ:
    **             [   dN_1     dN_1     dN_1   ]
    **             [  ------   ------   ------  ]
    **             [    dX       dY       dZ    ]
    ...
    */
    ...
    /*for (int icol=0; icol < NUMDOF_SOTET10;icol++)
    {
    	for(int irow=0;irow < NUMDOF_SOTET10; irow++)
    	{
    		if (bop(irow,icol)<0.00001) bop(irow,icol)=0;
    	}
    }*/
      ...
      Epetra_SerialDenseVector** weights)   // pointer to pointer of weights
{
  ...
  static Epetra_SerialDenseMatrix df(NUMNOD_SOTET10*NUMCOORD_SOTET10,NUMGPT_SOTET10);  // derivatives
