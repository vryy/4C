                                    ...
                                    Epetra_SerialDenseVector& elevec3_epetra)
{
  ...
  switch(act) {
    ...
    case calc_struct_linstiff:
    {
      ...
      so_tet10_nlnstiffmass(lm,mydisp,NULL,NULL,myres,mydispmat,&elemat1,NULL,&elevec1,NULL,&elevec3,NULL,NULL,params,
    ...
    case calc_struct_nlnstiff:
    {
      ...
      so_tet10_nlnstiffmass(lm,mydisp,NULL,NULL,myres,mydispmat,matptr,NULL,&elevec1,NULL,&elevec3,NULL,NULL,params,
                                  INPAR::STR::stress_none,INPAR::STR::strain_none);
    }
    break;
    ...
    case calc_struct_internalforce:
    {
      ...
      so_tet10_nlnstiffmass(lm,mydisp,NULL,NULL,myres,mydispmat,&myemat,NULL,&elevec1,NULL,NULL,NULL,NULL,params,
        INPAR::STR::stress_none,INPAR::STR::strain_none);
    }
    break;
    ...
    case calc_struct_nlnstifflmass:
    {
      ...
      so_tet10_nlnstiffmass(lm,mydisp,&myvel,&myacc,myres,mydispmat,&elemat1,&elemat2,&elevec1,&elevec2,&elevec3,NULL,NULL,params,
        INPAR::STR::stress_none,INPAR::STR::strain_none);
    ...
    case calc_struct_stress:
    {
      ...
      if (discretization.Comm().MyPID()==Owner())
      {
        ...
        so_tet10_nlnstiffmass(lm,mydisp,NULL,NULL,myres,mydispmat,NULL,NULL,NULL,NULL,NULL,&stress,&strain,params,iostress,iostrain);
        {
          DRT::PackBuffer data;
    ...
    //******************************************************************
        ...
        //******************************************************************
            if (mat->MaterialType() == INPAR::MAT::m_stvenant)
          {
            ...
            const static std::vector<LINALG::Matrix<NUMNOD_SOTET10,1> > vals = so_tet10_11gp_shapefcts();
            const static std::vector<LINALG::Matrix<NUMDIM_SOTET10,NUMNOD_SOTET10> > derivs = so_tet10_11gp_derivs();
...
** ============================================================================*/
  ...
  const static std::vector<LINALG::Matrix<NUMDIM_SOTET10,NUMNOD_SOTET10> > derivs = so_tet10_4gp_derivs();
...
{
  const static std::vector<LINALG::Matrix<NUMDIM_SOTET10,NUMNOD_SOTET10> > derivs4gp = so_tet10_4gp_derivs();
  const static std::vector<LINALG::Matrix<NUMDIM_SOTET10,NUMNOD_SOTET10> > derivs11gp = so_tet10_11gp_derivs();
...
/* ============================================================================*/
  ...
  for (int gp=0; gp<NUMGPT_SOTET10; ++gp)
  {
    ...
    ** ============================================================================*/
      const static std::vector<LINALG::Matrix<NUMNOD_SOTET10,1> > shapefcts_11gp = so_tet10_11gp_shapefcts();
      const static std::vector<LINALG::Matrix<NUMDIM_SOTET10,NUMNOD_SOTET10> > derivs_11gp = so_tet10_11gp_derivs();
