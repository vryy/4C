...
Teuchos::RCP<DRT::Element> DRT::ELEMENTS::So_hex27Type::Create( const std::string eletype,
...
void DRT::ELEMENTS::So_hex27Type::NodalBlockInformation( DRT::Element * dwele, int & numdf, int & dimns, int & nv, int & np )
{
  numdf = 3;
  dimns = 6;
  nv = 3;
...
(
    LINALG::Matrix<NUMGPT_SOH27,MAT::NUM_STRESS_3D>& stresses,
