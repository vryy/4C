...
intpoints_(distype == DRT::Element::tet4 ? DRT::UTILS::intrule_tet_1point : (distype == DRT::Element::tet10 ? DRT::UTILS::intrule_tet_4point : DRT::ELEMENTS::DisTypeToOptGaussRule<distype>::rule)),
