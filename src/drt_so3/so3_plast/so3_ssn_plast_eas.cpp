...
void DRT::ELEMENTS::So3_Plast<distype>::EasInit()
{
  switch (eastype_)
  {
  case soh8p_easnone: neas_=PlastEasTypeToNumEas<DRT::ELEMENTS::soh8p_easnone>::neas; break;
  case soh8p_easmild: neas_=PlastEasTypeToNumEas<DRT::ELEMENTS::soh8p_easmild>::neas; break;
  case soh8p_easfull: neas_=PlastEasTypeToNumEas<DRT::ELEMENTS::soh8p_easfull>::neas; break;
  case soh8p_eassosh8:neas_=PlastEasTypeToNumEas<DRT::ELEMENTS::soh8p_eassosh8>::neas; break;
  case soh18p_eassosh18: neas_=PlastEasTypeToNumEas<DRT::ELEMENTS::soh18p_eassosh18>::neas; break;
  default: dserror("unknown EAS type");
  }
...
void DRT::ELEMENTS::So3_Plast<distype>::EasEnhanceStrains()
{
  ...
  {
  case soh8p_easfull:
    LINALG::DENSEFUNCTIONS::multiply<double,numstr_,PlastEasTypeToNumEas<DRT::ELEMENTS::soh8p_easfull>::neas,1>(1.0,total_glstrain.A(),1.0,M_eas().A(),alpha_eas_->A());
    break;
  case soh8p_easmild:
    LINALG::DENSEFUNCTIONS::multiply<double,numstr_,PlastEasTypeToNumEas<DRT::ELEMENTS::soh8p_easmild>::neas,1>(1.0,total_glstrain.A(),1.0,M_eas().A(),alpha_eas_->A());
    break;
  case soh8p_eassosh8:
    LINALG::DENSEFUNCTIONS::multiply<double,numstr_,PlastEasTypeToNumEas<DRT::ELEMENTS::soh8p_eassosh8>::neas,1>(1.0,total_glstrain.A(),1.0,M_eas().A(),alpha_eas_->A());
    break;
  case soh8p_easnone: break;
  default: dserror("Don't know what to do with EAS type %d", eastype_); break;
  }
  ...
  for (int i=0;i<nsd_;++i)
    SetRCG()(i,i)=2.*total_glstrain(i)+1.;
