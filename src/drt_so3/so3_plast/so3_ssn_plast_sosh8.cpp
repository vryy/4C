...
std::pair<bool,LINALG::Matrix<DRT::ELEMENTS::So3_Plast<DRT::Element::hex8>::nsd_,DRT::ELEMENTS::So3_Plast<DRT::Element::hex8>::nsd_> > DRT::ELEMENTS::So_sh8Plast::jac_refe_;
std::pair<bool,LINALG::Matrix<DRT::ELEMENTS::So3_Plast<DRT::Element::hex8>::nsd_,DRT::ELEMENTS::So3_Plast<DRT::Element::hex8>::nsd_> > DRT::ELEMENTS::So_sh8Plast::jac_curr_;
std::pair<bool,LINALG::Matrix<DRT::ELEMENTS::So_sh8Plast::num_ans*DRT::ELEMENTS::So_sh8Plast::num_sp,DRT::ELEMENTS::So_sh8Plast::numdofperelement_> > DRT::ELEMENTS::So_sh8Plast::B_ans_loc_;
std::pair<bool,LINALG::Matrix<DRT::ELEMENTS::So_sh8Plast::numstr_,DRT::ELEMENTS::So_sh8Plast::numstr_> > DRT::ELEMENTS::So_sh8Plast::TinvT_;
                                             ...
                                             DRT::INPUT::LineDefinition* linedef)
{
  ...
  if(tsi_)
    dserror("no tsi for solid shells.\n"
    ...
    )
{
  ...
  for (int gp=0; gp<numgpt_; ++gp)
  {
    ...
    if (stiffmatrix != NULL)
    {
      ...
      if (eastype_ != soh8p_easnone)
      {
        ...
        {
        case soh8p_eassosh8:
          LINALG::DENSEFUNCTIONS::multiply<double,numstr_,numstr_,PlastEasTypeToNumEas<DRT::ELEMENTS::soh8p_eassosh8>::neas>(cM.A(), Cmat().A(), M_eas().A());
          LINALG::DENSEFUNCTIONS::multiplyTN<double,PlastEasTypeToNumEas<DRT::ELEMENTS::soh8p_eassosh8>::neas,numstr_,PlastEasTypeToNumEas<DRT::ELEMENTS::soh8p_eassosh8>::neas>(1.0, *KaaInv_, detJ_w, M_eas(), cM);
          LINALG::DENSEFUNCTIONS::multiplyTN<double,PlastEasTypeToNumEas<DRT::ELEMENTS::soh8p_eassosh8>::neas,numstr_,numdofperelement_>(1.0, Kad_->A(), detJ_w, M_eas().A(), cb.A());
          LINALG::DENSEFUNCTIONS::multiplyTN<double,numdofperelement_,numstr_,PlastEasTypeToNumEas<DRT::ELEMENTS::soh8p_eassosh8>::neas>(1.0, Kda.A(), detJ_w,cb.A(), M_eas().A());
          LINALG::DENSEFUNCTIONS::multiplyTN<double,PlastEasTypeToNumEas<DRT::ELEMENTS::soh8p_eassosh8>::neas,numstr_,1>(1.0, feas_->A(), detJ_w, M_eas().A(), PK2().A());
          break;
        case soh8p_easmild:
      ...
      if (HavePlasticSpin())
      {
        if (eastype_!=soh8p_easnone)
          CondensePlasticity<plspin>(DefgrdMod(),DeltaLp(),Bop(),&DerivShapeFunctionXYZ(),NULL,detJ_w,
              gp,0,params,force,stiffmatrix,&M_eas(),&Kda);
        else
          CondensePlasticity<plspin>(DefgrdMod(),DeltaLp(),Bop(),&DerivShapeFunctionXYZ(),NULL,detJ_w,
              gp,0,params,force,stiffmatrix);
      }
      else
      {
        if (eastype_!=soh8p_easnone)
  ...
  if (stiffmatrix != NULL && !is_tangDis && eastype_!=soh8p_easnone)
  {
    ...
    {
    case soh8p_eassosh8:
      LINALG::DENSEFUNCTIONS::multiply<double,numdofperelement_,PlastEasTypeToNumEas<DRT::ELEMENTS::soh8p_eassosh8>::neas,PlastEasTypeToNumEas<DRT::ELEMENTS::soh8p_eassosh8>::neas>
        (0.,kdakaai.A(),1.,Kda.A(),KaaInv_->A());
      if (stiffmatrix!=NULL)
        LINALG::DENSEFUNCTIONS::multiply<double,numdofperelement_,PlastEasTypeToNumEas<DRT::ELEMENTS::soh8p_eassosh8>::neas,numdofperelement_>
          (1.,stiffmatrix->A(),-1.,kdakaai.A(),Kad_->A());
      if (force!=NULL)
        LINALG::DENSEFUNCTIONS::multiply<double,numdofperelement_,PlastEasTypeToNumEas<DRT::ELEMENTS::soh8p_eassosh8>::neas,1>
...
/*----------------------------------------------------------------------*
 |                                                          seitz 05/14 |
 *----------------------------------------------------------------------*/
void DRT::ELEMENTS::So_sh8Plast::CalculateBop(
    ...
    )
{
  ...
  lstrain(0)= 0.5 * (
     +(Jac_curr()(0,0)*Jac_curr()(0,0) + Jac_curr()(0,1)*Jac_curr()(0,1) + Jac_curr()(0,2)*Jac_curr()(0,2))
     -(Jac_refe()(0,0)*Jac_refe()(0,0)         + Jac_refe()(0,1)*Jac_refe()(0,1)         + Jac_refe()(0,2)*Jac_refe()(0,2)));
  // Ess = 0.5 * (dy/ds * dy/ds^T - dY/ds * dY/ds^T)
  lstrain(1)= 0.5 * (
     +(Jac_curr()(1,0)*Jac_curr()(1,0) + Jac_curr()(1,1)*Jac_curr()(1,1) + Jac_curr()(1,2)*Jac_curr()(1,2))
     -(Jac_refe()(1,0)*Jac_refe()(1,0)         + Jac_refe()(1,1)*Jac_refe()(1,1)         + Jac_refe()(1,2)*Jac_refe()(1,2)));
  // Ers = (dx/ds * dy/dr^T - dX/ds * dY/dr^T)
  lstrain(3)= (
     +(Jac_curr()(0,0)*Jac_curr()(1,0) + Jac_curr()(0,1)*Jac_curr()(1,1) + Jac_curr()(0,2)*Jac_curr()(1,2))
     -(Jac_refe()(0,0)*Jac_refe()(1,0)         + Jac_refe()(0,1)*Jac_refe()(1,1)         + Jac_refe()(0,2)*Jac_refe()(1,2)));
  ...
  else if (anstype_==ansnone_p)
  {
    ...
    lstrain(2)= 0.5 * (
       +(Jac_curr()(2,0)*Jac_curr()(2,0) + Jac_curr()(2,1)*Jac_curr()(2,1) + Jac_curr()(2,2)*Jac_curr()(2,2))
       -(Jac_refe()(2,0)*Jac_refe()(2,0)         + Jac_refe()(2,1)*Jac_refe()(2,1)         + Jac_refe()(2,2)*Jac_refe()(2,2)));
    // Est = (dz/ds * dy/dt^T - dZ/ds * dY/dt^T)
    lstrain(4)= (
       +(Jac_curr()(2,0)*Jac_curr()(1,0) + Jac_curr()(2,1)*Jac_curr()(1,1) + Jac_curr()(2,2)*Jac_curr()(1,2))
       -(Jac_refe()(2,0)*Jac_refe()(1,0)         + Jac_refe()(2,1)*Jac_refe()(1,1)         + Jac_refe()(2,2)*Jac_refe()(1,2)));
    // Est = (dz/dr * dx/dt^T - dZ/dr * dX/dt^T)
    lstrain(5)= (
        +(Jac_curr()(2,0)*Jac_curr()(0,0) + Jac_curr()(2,1)*Jac_curr()(0,1) + Jac_curr()(2,2)*Jac_curr()(0,2))
        -(Jac_refe()(2,0)*Jac_refe()(0,0)         + Jac_refe()(2,1)*Jac_refe()(0,1)         + Jac_refe()(2,2)*Jac_refe()(0,2)));
  }
  else
