...
*----------------------------------------------------------------------*/
Teuchos::RCP<DRT::Element> DRT::ELEMENTS::So_sh18PlastType::Create( const std::string eletype,
    ...
    )
{
  ...
  std::map<std::string, DRT::INPUT::LineDefinition>& defs_sh18
    = definitions_sh18["SOLIDSH18"];

  std::map<std::string, DRT::INPUT::LineDefinition>& defs
    = definitions["SOLIDSH18PLAST"];
...
DRT::ELEMENTS::So_sh18Plast::~So_sh18Plast()
{
  return;
}
 ...
 *----------------------------------------------------------------------*/
bool DRT::ELEMENTS::So_sh18Plast::ReadElement(const std::string& eletype,
                                              const std::string& distype,
                                              DRT::INPUT::LineDefinition* linedef)
{
  bool read=(DRT::ELEMENTS::So3_Plast<DRT::Element::hex18>::ReadElement(eletype,distype,linedef)
    ...
    )
{
  ...
  if (tsi_)
    dserror("no TSI for sosh18Plast (yet)");
