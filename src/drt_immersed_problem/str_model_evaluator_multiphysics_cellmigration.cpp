...
{
  STR::MODELEVALUATOR::Multiphysics::Init(
  ...
  Teuchos::RCP<STR::MODELEVALUATOR::PartitionedSSI> ssi_model_evaluator =
      Teuchos::rcp(new STR::MODELEVALUATOR::PartitionedSSIAdhesionDynamics());
  ...
  GetModelEvalutaorMap().insert(std::pair<enum STR::MODELEVALUATOR::MultiphysicType,
      Teuchos::RCP<STR::MODELEVALUATOR::Generic>>(mt_fsi, fsi_model_evaluator));
  GetModelEvalutaorMap().insert(std::pair<enum STR::MODELEVALUATOR::MultiphysicType,
      Teuchos::RCP<STR::MODELEVALUATOR::Generic>>(mt_ssi, ssi_model_evaluator));
}
