...
void LINALG::FixedSparseMatrix::Reset()
{
  Zero();
}

void LINALG::FixedSparseMatrix::Assemble(int eid,
...
void LINALG::FixedSparseMatrix::UnComplete()
{
  dserror( "UnComplete not supported" );
}

void LINALG::FixedSparseMatrix::ApplyDirichlet(const Teuchos::RCP<const Epetra_Vector> dbctoggle, bool diagonalblock)
{
