    ...
    const std::vector<double> &eqn_plane, const std::vector<std::vector<double>> &cornersLocal)
{
...
#else
  {
    ...
    else
    {
      ...
      // should check whether this is sufficient or do we need to find the number of side in the
      // element and use their orientation to get clockwise ordering
      ...
      switch (elem1_->Shape())
      {
        ...
        case DRT::Element::tet4:
        {
          if (parentSideno == 1 && ordering == "cw") clockwise_ = 1;
          if (parentSideno == 2 && ordering == "acw") clockwise_ = 1;
          break;
        }
        case DRT::Element::wedge6:
        {
          if (parentSideno == 0 && ordering == "cw") clockwise_ = 1;
          if (parentSideno == 1 && ordering == "acw") clockwise_ = 1;
          break;
        }
        case DRT::Element::pyramid5:
        {
          if (parentSideno == 1 && ordering == "cw") clockwise_ = 1;
          if (parentSideno == 3 && ordering == "acw") clockwise_ = 1;
          break;
        }
        default:
