...
/*----------------------------------------------------------------------------*
 *----------------------------------------------------------------------------*/
GEO::CUT::BoundaryCell::BoundaryCell( const Epetra_SerialDenseMatrix & xyz,
    Facet * facet, const std::vector<Point*> & points )
    : facet_( facet ),
      points_( Teuchos::rcp(new Cycle(points)) )
{
  xyz_.Shape( 3, xyz.N() );
...
/*----------------------------------------------------------------------------*
 *----------------------------------------------------------------------------*/
void GEO::CUT::BoundaryCell::Clear()
{ points_->clear(); }

/*----------------------------------------------------------------------------*
 *----------------------------------------------------------------------------*/
bool GEO::CUT::BoundaryCell::IsValid() const
{ return points_->size() > 0; }

/*----------------------------------------------------------------------------*
 *----------------------------------------------------------------------------*/
template <DRT::Element::DiscretizationType celldistype>
void GEO::CUT::BoundaryCell::TransformLocalCoords(
    Element * elem1,
     ...
     bool                     shadow )
{
  ...
  DRT::UTILS::ComputeMetricTensorForBoundaryEle<celldistype>( xyze, deriv,
...
/*----------------------------------------------------------------------------*
 *----------------------------------------------------------------------------*/
const std::vector<GEO::CUT::Point*> & GEO::CUT::BoundaryCell::Points() const
{
  return (*points_)();
}
...
/*----------------------------------------------------------------------------*
 *----------------------------------------------------------------------------*/
double GEO::CUT::Line2BoundaryCell::Area()
{
  return GEO::ElementArea( Shape(), xyz_ );
}
...
/*----------------------------------------------------------------------------*
 *----------------------------------------------------------------------------*/
void GEO::CUT::Point1BoundaryCell::Normal( const LINALG::Matrix<2,1> & xsi,
    LINALG::Matrix<3,1> & normal ) const
{
  normal.Scale(0.0);
}
...
/*----------------------------------------------------------------------------*
 *----------------------------------------------------------------------------*/
void GEO::CUT::Line2BoundaryCell::Normal( const LINALG::Matrix<2,1> & xsi,
    LINALG::Matrix<3,1> & normal ) const
{
...
/*----------------------------------------------------------------------------*
 *----------------------------------------------------------------------------*/
void GEO::CUT::Tri3BoundaryCell::Normal( const LINALG::Matrix<2,1> & xsi,
    LINALG::Matrix<3,1> & normal ) const
{
#if 1
...
/*----------------------------------------------------------------------------*
 *----------------------------------------------------------------------------*/
void GEO::CUT::Quad4BoundaryCell::Normal( const LINALG::Matrix<2,1> & xsi,
    LINALG::Matrix<3,1> & normal ) const
{
  // get derivatives at pos
...
/*----------------------------------------------------------------------------*
 *----------------------------------------------------------------------------*/
void GEO::CUT::ArbitraryBoundaryCell::Normal( const LINALG::Matrix<2,1> & xsi,
    LINALG::Matrix<3,1> & normal ) const
{
...
template void GEO::CUT::BoundaryCell::TransformLocalCoords<DRT::Element::tri3>(Element * elem1,const LINALG::Matrix<2,1> & eta,LINALG::Matrix<3,1> & x_gp_lin, LINALG::Matrix<3,1> & normal, double & drs, bool shadow );
template void GEO::CUT::BoundaryCell::TransformLocalCoords<DRT::Element::quad4>(Element * elem1,const LINALG::Matrix<2,1> & eta,LINALG::Matrix<3,1> & x_gp_lin, LINALG::Matrix<3,1> & normal, double & drs, bool shadow );
