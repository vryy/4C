...
/*----------------------------------------------------------------------*/
void ADAPTER::UTILS::CreateAleDiscretization()
{
...
/*----------------------------------------------------------------------*/
/*----------------------------------------------------------------------*/
RCP<DRT::Discretization> ADAPTER::UTILS::CreateDiscretizationFromCondition(
...
//    cout << (*cutterele) << endl;
    ...
    remove_copy_if(cutterele->NodeIds(), cutterele->NodeIds()+cutterele->NumNode(),
                   inserter(rownodeset, rownodeset.begin()),
                   not1(ADAPTER::UTILS::MyGID(cutternoderowmap)));
