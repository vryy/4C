...
/// constructor
ADAPTER::StructurePoroWrapper::StructurePoroWrapper(Teuchos::RCP<Field> field, FieldWrapper::Fieldtype type, bool NOXCorrection)
...
Teuchos::RCP<Epetra_Vector> ADAPTER::StructurePoroWrapper::InsertFSICondVector(Teuchos::RCP<const Epetra_Vector> cond)
{
...
void ADAPTER::StructurePoroWrapper::RecoverLagrangeMultiplierAfterNewtonStep(Teuchos::RCP<Epetra_Vector> iterinc)
{
 if (type_ == FieldWrapper::type_PoroField)
