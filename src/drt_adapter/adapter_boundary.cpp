...
/*----------------------------------------------------------------------*
 *----------------------------------------------------------------------*/
void ADAPTER::XFluidFSIBoundary::ReadRestart(int step)
{
...
/*----------------------------------------------------------------------*/
/*----------------------------------------------------------------------*/
ADAPTER::BoundaryBaseAlgorithm::BoundaryBaseAlgorithm()
{
  SetupBoundary();
}
...
/*----------------------------------------------------------------------*/
/*----------------------------------------------------------------------*/
void ADAPTER::BoundaryBaseAlgorithm::SetupBoundary()
{
  Teuchos::RCP<Teuchos::Time> t = Teuchos::TimeMonitor::getNewTimer("ADAPTER::BoundaryBaseAlgorithm::SetupBoundary");
  ...
  //if (aletype==ALE_DYNAMIC::classic_lin)
    boundary_ = rcp(new XFluidFSIBoundary(actdis, solver, params, output, aletype));
  //else if (aletype==ALE_DYNAMIC::springs)
  //  ale_ = rcp(new XFluidFSIBoundary(actdis, solver, params, output, aletype));
  //else
