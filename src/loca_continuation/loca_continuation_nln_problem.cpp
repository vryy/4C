...
#include "loca_continuation_nln_problem.H"
#include "loca_continuation_nln_statustest_factory.H"
#include "loca_continuation_nln_interface_required.H"
#include "loca_continuation_nln_group.H"
...
LOCA::NLN::Problem::Problem(const Teuchos::RCP<NOX::NLN::GlobalData>& nox_nln_global_data_ptr,
    ...
    const Teuchos::RCP<CORE::LINALG::SparseOperator>& jac_ptr,
