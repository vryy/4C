...
#ifndef BACI_SOLVER_NONLIN_NOX_CONSTRAINT_INTERFACE_PRECONDITIONER_HPP
#define BACI_SOLVER_NONLIN_NOX_CONSTRAINT_INTERFACE_PRECONDITIONER_HPP
...
#endif  // SOLVER_NONLIN_NOX_CONSTRAINT_INTERFACE_PRECONDITIONER_H
