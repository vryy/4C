...
#ifndef BACI_SOLVER_NONLIN_NOX_INNER_STATUSTEST_ARMIJO_HPP
#define BACI_SOLVER_NONLIN_NOX_INNER_STATUSTEST_ARMIJO_HPP
...
#endif  // SOLVER_NONLIN_NOX_INNER_STATUSTEST_ARMIJO_H
