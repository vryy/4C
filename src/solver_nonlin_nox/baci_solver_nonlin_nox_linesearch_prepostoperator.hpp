...
#ifndef BACI_SOLVER_NONLIN_NOX_LINESEARCH_PREPOSTOPERATOR_HPP
#define BACI_SOLVER_NONLIN_NOX_LINESEARCH_PREPOSTOPERATOR_HPP
...
#endif  // SOLVER_NONLIN_NOX_LINESEARCH_PREPOSTOPERATOR_H
