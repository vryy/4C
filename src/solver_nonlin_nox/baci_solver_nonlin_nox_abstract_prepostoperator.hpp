...
#ifndef BACI_SOLVER_NONLIN_NOX_ABSTRACT_PREPOSTOPERATOR_HPP
#define BACI_SOLVER_NONLIN_NOX_ABSTRACT_PREPOSTOPERATOR_HPP
...
#endif  // SOLVER_NONLIN_NOX_ABSTRACT_PREPOSTOPERATOR_H
