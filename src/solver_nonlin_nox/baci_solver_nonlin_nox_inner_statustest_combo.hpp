...
#ifndef BACI_SOLVER_NONLIN_NOX_INNER_STATUSTEST_COMBO_HPP
#define BACI_SOLVER_NONLIN_NOX_INNER_STATUSTEST_COMBO_HPP
...
#endif  // SOLVER_NONLIN_NOX_INNER_STATUSTEST_COMBO_H
