...
{
  // TODO (kruse): simplify input of fluid discretizations and
  // shift to XFEM::UTILS
  // check how many fluid meshes we have
  if (!DRT::Problem::Instance()->DoesExistDis("xfluid"))
  {
    Teuchos::RCP<DRT::DiscretizationXFEM> fluiddis =
    Teuchos::rcp_dynamic_cast<DRT::DiscretizationXFEM>(DRT::Problem::Instance()->GetDis("fluid"), true);
  ...
  Teuchos::RCP<DRT::Discretization> embfluiddis = DRT::Problem::Instance()->GetDis("fluid");
  embfluiddis->FillComplete();

  Teuchos::RCP<DRT::DiscretizationXFEM> bgfluiddis =  Teuchos::rcp_dynamic_cast<DRT::DiscretizationXFEM>(DRT::Problem::Instance()->GetDis("xfluid"));
