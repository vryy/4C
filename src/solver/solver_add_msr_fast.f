...
C
C--------------------------------------------------------------------------
      subroutine fadmd(estif,lm,owner,dirich,invupdate,bindx,
     &                   invbindx, val,
     &                   myrank,nprocs,numeqtotal,numeq,
     &                   numnp,nd,aloopl,loopl,ele )
...
C
C--------------------------------------------------------------------------
      subroutine fadmd2(estif,lm,owner,dirich,invupdate,bindx,
     &                    invbindx, val,
     &                    myrank,nprocs,numeqtotal,numeq,
     &                    numnp,nd,aloopl,loopl,ele )
...
c     check for dirichlet conditions !!
      do i=1,nd
...
C
C--------------------------------------------------------------------------
      subroutine fadmdp(estif,lm,owner,dirich,invupdate,bindx,
     &                   invbindx, val,
     &                   myrank,nprocs,numeqtotal,numeq,
     &                   numnp,nd,aloopl,loopl,ele )
...
C
C--------------------------------------------------------------------------
      subroutine fadmd2p(estif,lm,owner,dirich,invupdate,bindx,
     &                      invbindx, val,
     &                      myrank,nprocs,numeqtotal,numeq,
     &                      numnp,nd,aloopl,loopl,ele )
