...
#include "MueLu_UseShortNames.hpp"
  ...
  public:
    ...
    /*!
      ...
      Routine extends BuildFactory method from MueLu::FactoryFactory class for Baci specific MueLu factories
    ...
    virtual RCP<const FactoryBase> BuildFactory(const Teuchos::ParameterEntry& param, const FactoryMap& factoryMapIn, const FactoryManagerMap& factoryManagersIn) const {
      ...
      if (factoryName == "ContactAFilterFactory")              return myBuild<MueLu::ContactAFilterFactory<Scalar,LocalOrdinal, GlobalOrdinal, Node> >(paramList, factoryMapIn, factoryManagersIn);
      if (factoryName == "ContactSPAggregationFactory")        return myBuild<MueLu::ContactSPAggregationFactory<Scalar, LocalOrdinal, GlobalOrdinal, Node> >(paramList, factoryMapIn, factoryManagersIn);
      if (factoryName == "SelectiveSaPFactory")                return myBuild<MueLu::SelectiveSaPFactory<Scalar,LocalOrdinal,GlobalOrdinal,Node> >(paramList, factoryMapIn, factoryManagersIn);
      if (factoryName == "IterationAFactory")                  return myBuild<MueLu::IterationAFactory<Scalar,LocalOrdinal,GlobalOrdinal,Node> >(paramList, factoryMapIn, factoryManagersIn);
      if (factoryName == "FilteredTrilinosSmoother")           return myBuildSmoother(paramList, factoryMapIn, factoryManagersIn);
    ...
    template <class T>
    RCP<T> myBuild(const Teuchos::ParameterList& paramList, const FactoryMap& factoryMapIn, const FactoryManagerMap& factoryManagersIn) const {
    ...
    RCP<FactoryBase> myBuildSmoother(const Teuchos::ParameterList & paramList, const FactoryMap & factoryMapIn, const FactoryManagerMap& factoryManagersIn) const {

      TEUCHOS_TEST_FOR_EXCEPTION(paramList.get<std::string>("factory") != "FilteredTrilinosSmoother", Exceptions::RuntimeError, "");
      ...
      std::string mapName="";         if(paramList.isParameter("map: name"))     mapName     = paramList.get<std::string>("map: name");
      std::string mapFactName="";     if(paramList.isParameter("map: factory"))  mapFactName = paramList.get<std::string>("map: factory");
      ...
      std::string AfactName="";     if(paramList.isParameter("A: factory"))  AfactName = paramList.get<std::string>("A: factory");
      ...
      Teuchos::RCP<SmootherPrototype> smooProto = Teuchos::rcp( new MueLu::MyTrilinosSmoother<Scalar, LocalOrdinal, GlobalOrdinal, Node>(mapName, mapFact, type, params, overlap, AFact));
