...
namespace MueLu {
  ...
  Teuchos::RCP<const Teuchos::ParameterList> ContactAFilterFactory<Scalar, LocalOrdinal, GlobalOrdinal, Node>::GetValidParameterList(const Teuchos::ParameterList& paramList) const {
    ...
    validParamList->set< std::string >           ("Map block 1 factory", "null", "Name of generating factory for 'Map block 1 name'");
    validParamList->set< std::string >           ("Map block 2 factory", "null", "Name of generating factory for 'Map block 2 name'");
  ...
  void ContactAFilterFactory<Scalar, LocalOrdinal, GlobalOrdinal, Node>::DeclareInput(Level &currentLevel) const {
    ...
    if(blockFactName1 == "NoFactory") {
      ...
      Teuchos::RCP<const FactoryBase> blockFact1 = currentLevel.GetFactoryManager()->GetFactory(blockFactName1);
    ...
    if(blockFactName2 == "NoFactory") {
      ...
      Teuchos::RCP<const FactoryBase> blockFact2 = currentLevel.GetFactoryManager()->GetFactory(blockFactName2);
