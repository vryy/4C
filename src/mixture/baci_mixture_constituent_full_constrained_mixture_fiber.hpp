...
#ifndef BACI_MIXTURE_CONSTITUENT_FULL_CONSTRAINED_MIXTURE_FIBER_HPP
#define BACI_MIXTURE_CONSTITUENT_FULL_CONSTRAINED_MIXTURE_FIBER_HPP
...
#endif  // MIXTURE_CONSTITUENT_FULL_CONSTRAINED_MIXTURE_FIBER_H
