...
#ifndef BACI_MIXTURE_CONSTITUENT_ELASTHYPER_ELASTIN_MEMBRANE_HPP
#define BACI_MIXTURE_CONSTITUENT_ELASTHYPER_ELASTIN_MEMBRANE_HPP
...
#endif  // MIXTURE_CONSTITUENT_ELASTHYPER_ELASTIN_MEMBRANE_H
