...
*/
/*----------------------------------------------------------------------*/
#ifndef BACI_CONTACT_CONSTITUTIVELAW_POWER_CONTACTCONSTITUTIVELAW_HPP
#define BACI_CONTACT_CONSTITUTIVELAW_POWER_CONTACTCONSTITUTIVELAW_HPP
...
#endif  // CONTACT_CONSTITUTIVELAW_POWER_CONTACTCONSTITUTIVELAW_H
