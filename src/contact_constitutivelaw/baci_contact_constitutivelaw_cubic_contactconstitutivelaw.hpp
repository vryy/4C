...
*/
/*----------------------------------------------------------------------*/
#ifndef BACI_CONTACT_CONSTITUTIVELAW_CUBIC_CONTACTCONSTITUTIVELAW_HPP
#define BACI_CONTACT_CONSTITUTIVELAW_CUBIC_CONTACTCONSTITUTIVELAW_HPP
...
#endif  // CONTACT_CONSTITUTIVELAW_CUBIC_CONTACTCONSTITUTIVELAW_H
