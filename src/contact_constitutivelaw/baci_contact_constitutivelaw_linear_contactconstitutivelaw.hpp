...
*/
/*----------------------------------------------------------------------*/
#ifndef BACI_CONTACT_CONSTITUTIVELAW_LINEAR_CONTACTCONSTITUTIVELAW_HPP
#define BACI_CONTACT_CONSTITUTIVELAW_LINEAR_CONTACTCONSTITUTIVELAW_HPP
...
#endif  // CONTACT_CONSTITUTIVELAW_LINEAR_CONTACTCONSTITUTIVELAW_H
