...
#ifndef BACI_MATELAST_ISOEXPOPOW_HPP
#define BACI_MATELAST_ISOEXPOPOW_HPP
  ...
  namespace ELASTIC
  {
    namespace PAR
    {
      ...
      class IsoExpoPow : public MAT::PAR::Parameter
      {
       public:
        ...
        IsoExpoPow(const Teuchos::RCP<MAT::PAR::Material>& matdata);
    ...
    class IsoExpoPow : public Summand
    {
     public:
      ...
      /// material type
      INPAR::MAT::MaterialType MaterialType() const override { return INPAR::MAT::mes_isoexpopow; }
