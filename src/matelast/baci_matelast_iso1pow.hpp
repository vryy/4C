...
#ifndef BACI_MATELAST_ISO1POW_HPP
#define BACI_MATELAST_ISO1POW_HPP
  ...
  namespace ELASTIC
  {
    namespace PAR
    {
      ...
      class Iso1Pow : public MAT::PAR::Parameter
      {
       public:
        ...
        Iso1Pow(const Teuchos::RCP<MAT::PAR::Material>& matdata);
    ...
    class Iso1Pow : public Summand
    {
     public:
      ...
      /// material type
      INPAR::MAT::MaterialType MaterialType() const override { return INPAR::MAT::mes_iso1pow; }
