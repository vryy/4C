...
#ifndef BACI_MATELAST_COUP3POW_HPP
#define BACI_MATELAST_COUP3POW_HPP
...
namespace MAT
{
  namespace ELASTIC
  {
    namespace PAR
    {
       ...
       */
      class Coup3Pow : public MAT::PAR::Parameter
      {
       public:
        /// standard constructor
        Coup3Pow(const Teuchos::RCP<MAT::PAR::Material>& matdata);
    ...
    class Coup3Pow : public Summand
    {
     public:
      ...
      /// material type
      INPAR::MAT::MaterialType MaterialType() const override { return INPAR::MAT::mes_coup3pow; }
