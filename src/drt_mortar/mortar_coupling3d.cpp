 ...
 *----------------------------------------------------------------------*/
bool MORTAR::Coupling3d::VertexLinearization(vector<vector<map<int,double> > >& linvertex,
 ...
 *----------------------------------------------------------------------*/
bool MORTAR::Coupling3d::SlaveVertexLinearization(vector<map<int,double> >& currlin,
                                                   int sid)
{
 ...
 *----------------------------------------------------------------------*/
bool MORTAR::Coupling3d::MasterVertexLinearization(vector<map<int,double> >& currlin,
                                                    int mid)
{
  // we first need the slave element center:
  // for quad4, quad8, quad9 elements: xi = eta = 0.0
 ...
 *----------------------------------------------------------------------*/
bool MORTAR::Coupling3d::MasterVertexLinearization(Vertex& currv,
 ...
 *----------------------------------------------------------------------*/
bool MORTAR::Coupling3d::LineclipVertexLinearization(Vertex& currv,
                                           vector<map<int,double> >& currlin,
 ...
 *----------------------------------------------------------------------*/
bool MORTAR::Coupling3d::CenterLinearization(const vector<vector<map<int,double> > >& linvertex,
