 ...
 *----------------------------------------------------------------------------------------------------------------------*/
template<int nnode>
inline void DRT::ELEMENTS::Beam3ii::computeItilde(const LINALG::Matrix<3,1>& Psil, vector<LINALG::Matrix<3,3> >& Itilde,
...
inline void DRT::ELEMENTS::Beam3ii::MyDampingConstants(ParameterList& params,LINALG::Matrix<3,1>& gamma, const INPAR::STATMECH::FrictionModel& frictionmodel)
{
  ...
  double artificial = 4000;//50;  //50 not bad for standard Actin3D_10.dat files; for 40 elements also 1 seems to work really well
