...
void FLD::TurbulenceStatisticsLdc::DumpLomaStatistics(int step)
{
  ...
  if (discret_->Comm().MyPID()==0)
  {
    ...
    for(unsigned i=0; i<x1coordinates_->size(); ++i)
    {
      ...
      (*log) <<  " "  << setw(15) << setprecision(8) << (*x1coordinates_)[i];
      (*log) << "   " << setw(15) << setprecision(8) << x1u;
      (*log) << "   " << setw(15) << setprecision(8) << x1v;
      (*log) << "   " << setw(15) << setprecision(8) << x1w;
      (*log) << "   " << setw(15) << setprecision(8) << x1p;
      (*log) << "   " << setw(15) << setprecision(8) << x1rho;
      (*log) << "   " << setw(15) << setprecision(8) << x1T;
      (*log) << "   " << setw(15) << setprecision(8) << x1sv;
      (*log) << "   " << setw(15) << setprecision(8) << x1urms;
      (*log) << "   " << setw(15) << setprecision(8) << x1vrms;
      (*log) << "   " << setw(15) << setprecision(8) << x1wrms;
      (*log) << "   " << setw(15) << setprecision(8) << x1prms;
      (*log) << "   " << setw(15) << setprecision(8) << x1rhorms;
      (*log) << "   " << setw(15) << setprecision(8) << x1Trms;
      (*log) << "   " << setw(15) << setprecision(8) << x1svrms;
      (*log) << "   " << setw(15) << setprecision(8) << x1uv;
      (*log) << "   " << setw(15) << setprecision(8) << x1uw;
      (*log) << "   " << setw(15) << setprecision(8) << x1vw;
      (*log) << "   " << setw(15) << setprecision(8) << x1uT;
      (*log) << "   " << setw(15) << setprecision(8) << x1vT;
      (*log) << "   " << setw(15) << setprecision(8) << x1wT;
      (*log) << "\n";
    }
    ...
    for(unsigned i=0; i<x2coordinates_->size(); ++i)
    {
      ...
      (*log) <<  " "  << setw(15) << setprecision(8) << (*x2coordinates_)[i];
      (*log) << "   " << setw(15) << setprecision(8) << x2u;
      (*log) << "   " << setw(15) << setprecision(8) << x2v;
      (*log) << "   " << setw(15) << setprecision(8) << x2w;
      (*log) << "   " << setw(15) << setprecision(8) << x2p;
      (*log) << "   " << setw(15) << setprecision(8) << x2rho;
      (*log) << "   " << setw(15) << setprecision(8) << x2T;
      (*log) << "   " << setw(15) << setprecision(8) << x2sv;
      (*log) << "   " << setw(15) << setprecision(8) << x2urms;
      (*log) << "   " << setw(15) << setprecision(8) << x2vrms;
      (*log) << "   " << setw(15) << setprecision(8) << x2wrms;
      (*log) << "   " << setw(15) << setprecision(8) << x2prms;
      (*log) << "   " << setw(15) << setprecision(8) << x2rhorms;
      (*log) << "   " << setw(15) << setprecision(8) << x2Trms;
      (*log) << "   " << setw(15) << setprecision(8) << x2svrms;
      (*log) << "   " << setw(15) << setprecision(8) << x2uv;
      (*log) << "   " << setw(15) << setprecision(8) << x2uw;
      (*log) << "   " << setw(15) << setprecision(8) << x2vw;
      (*log) << "   " << setw(15) << setprecision(8) << x2uT;
      (*log) << "   " << setw(15) << setprecision(8) << x2vT;
      (*log) << "   " << setw(15) << setprecision(8) << x2wT;
      (*log) << "\n";
    }
    ...
    for(unsigned i=0; i<x3coordinates_->size(); ++i)
    {
      ...
      (*log) <<  " "  << setw(15) << setprecision(8) << (*x3coordinates_)[i];
      (*log) << "   " << setw(15) << setprecision(8) << x3u;
      (*log) << "   " << setw(15) << setprecision(8) << x3v;
      (*log) << "   " << setw(15) << setprecision(8) << x3w;
      (*log) << "   " << setw(15) << setprecision(8) << x3p;
      (*log) << "   " << setw(15) << setprecision(8) << x3rho;
      (*log) << "   " << setw(15) << setprecision(8) << x3T;
      (*log) << "   " << setw(15) << setprecision(8) << x3sv;
      (*log) << "   " << setw(15) << setprecision(8) << x3urms;
      (*log) << "   " << setw(15) << setprecision(8) << x3vrms;
      (*log) << "   " << setw(15) << setprecision(8) << x3wrms;
      (*log) << "   " << setw(15) << setprecision(8) << x3prms;
      (*log) << "   " << setw(15) << setprecision(8) << x3rhorms;
      (*log) << "   " << setw(15) << setprecision(8) << x3Trms;
      (*log) << "   " << setw(15) << setprecision(8) << x3svrms;
      (*log) << "   " << setw(15) << setprecision(8) << x3uv;
      (*log) << "   " << setw(15) << setprecision(8) << x3uw;
      (*log) << "   " << setw(15) << setprecision(8) << x3vw;
      (*log) << "   " << setw(15) << setprecision(8) << x3uT;
      (*log) << "   " << setw(15) << setprecision(8) << x3vT;
      (*log) << "   " << setw(15) << setprecision(8) << x3wT;
      (*log) << "\n";
    }
    log->flush();
  }
