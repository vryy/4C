...
ELEMAG::ElemagTimeInt::ElemagTimeInt(const Teuchos::RCP<DRT::DiscretizationHDG> &actdis,
    ...
    : discret_(actdis),
      ...
      params_(params),
      output_(output),
      elemagdyna_(INPUT::IntegralValue<INPAR::ELEMAG::DynamicType>(*params_, "TIMEINT")),
      ...
      dtele_(0.0),
      dtsolve_(0.0),
      calcerr_(INPUT::IntegralValue<bool>(*params_, "CALCERR")),
      postprocess_(INPUT::IntegralValue<bool>(*params_, "POSTPROCESS")),
