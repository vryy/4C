...
DRT::ELEMENTS::Membrane_tri3Type& DRT::ELEMENTS::Membrane_tri3Type::Instance()
{
  return instance_;
}
...
{
  DRT::ELEMENTS::Membrane<DRT::Element::tri3>* object = new DRT::ELEMENTS::Membrane<DRT::Element::tri3>(-1,-1);
  object->Unpack(data);
  return object;
}

Teuchos::RCP<DRT::Element> DRT::ELEMENTS::Membrane_tri3Type::Create( const std::string eletype,
...
void DRT::ELEMENTS::Membrane_tri3Type::NodalBlockInformation( DRT::Element * dwele, int & numdf, int & dimns, int & nv, int & np )
{
...
DRT::ELEMENTS::Membrane_tri6Type& DRT::ELEMENTS::Membrane_tri6Type::Instance()
{
  return instance_;
}
...
{
  DRT::ELEMENTS::Membrane<DRT::Element::tri6>* object = new DRT::ELEMENTS::Membrane<DRT::Element::tri6>(-1,-1);
  object->Unpack(data);
  return object;
}

Teuchos::RCP<DRT::Element> DRT::ELEMENTS::Membrane_tri6Type::Create( const std::string eletype,
                                                                     const std::string eledistype,
                                                                     const int id,
                                                                     const int owner )
{
...
void DRT::ELEMENTS::Membrane_tri6Type::NodalBlockInformation( DRT::Element * dwele, int & numdf, int & dimns, int & nv, int & np )
{
  numdf = 3;  // number of degrees of freedom per node
  dimns = 3;  // number of nullspace vectors
  nv = 3;     // default value for no. of velocity dofs
...
void DRT::ELEMENTS::Membrane_tri6Type::ComputeNullSpace( DRT::Discretization & dis, std::vector<double> & ns, const double * x0, int numdf, int dimns )
{
...
{
  DRT::ELEMENTS::Membrane<DRT::Element::quad4>* object = new DRT::ELEMENTS::Membrane<DRT::Element::quad4>(-1,-1);
  object->Unpack(data);
  return object;
}

Teuchos::RCP<DRT::Element> DRT::ELEMENTS::Membrane_quad4Type::Create( const std::string eletype,
                                                                      const std::string eledistype,
                                                                      const int id,
                                                                      const int owner )
{
...
void DRT::ELEMENTS::Membrane_quad4Type::NodalBlockInformation( DRT::Element * dwele, int & numdf, int & dimns, int & nv, int & np )
{
  numdf = 3;  // number of degrees of freedom per node
  dimns = 3;  // number of nullspace vectors
  nv = 3;     // default value for no. of velocity dofs
...
void DRT::ELEMENTS::Membrane_quad4Type::ComputeNullSpace( DRT::Discretization & dis, std::vector<double> & ns, const double * x0, int numdf, int dimns )
{
  DRT::UTILS::ComputeStructure2DNullSpace( dis, ns, x0, numdf, dimns );
}
...
{
  DRT::ELEMENTS::Membrane<DRT::Element::quad9>* object = new DRT::ELEMENTS::Membrane<DRT::Element::quad9>(-1,-1);
  object->Unpack(data);
  return object;
}

Teuchos::RCP<DRT::Element> DRT::ELEMENTS::Membrane_quad9Type::Create( const std::string eletype,
                                                                      const std::string eledistype,
                                                                      const int id,
                                                                      const int owner )
{
...
void DRT::ELEMENTS::Membrane_quad9Type::NodalBlockInformation( DRT::Element * dwele, int & numdf, int & dimns, int & nv, int & np )
{
  numdf = 3;  // number of degrees of freedom per node
  dimns = 3;  // number of nullspace vectors
  nv = 3;     // default value for no. of velocity dofs
...
void DRT::ELEMENTS::Membrane_quad9Type::ComputeNullSpace( DRT::Discretization & dis, std::vector<double> & ns, const double * x0, int numdf, int dimns )
{
  DRT::UTILS::ComputeStructure2DNullSpace( dis, ns, x0, numdf, dimns );
}
