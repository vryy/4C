...
for (vi=0; vi<4; ++vi)
{
    ...
    eforce_(vi*3)     += ttimetauM*(2.0*conv_c_(vi)*conv_old_(0) - 2.0*velint_(0)*derxy_(0, vi)*gridvint_(0)*vderxy_(0, 0) - velint_(0)*derxy_(0, vi)*gridvint_(1)*vderxy_(0, 1) - velint_(0)*derxy_(1, vi)*gridvint_(1)*vderxy_(0, 0) - velint_(1)*derxy_(0, vi)*gridvint_(0)*vderxy_(0, 1) - velint_(1)*derxy_(1, vi)*gridvint_(0)*vderxy_(0, 0) - 2.0*velint_(1)*derxy_(1, vi)*gridvint_(1)*vderxy_(0, 1)) ;
    eforce_(vi*3 + 1) += ttimetauM*(2.0*conv_c_(vi)*conv_old_(1) - 2.0*velint_(0)*derxy_(0, vi)*gridvint_(0)*vderxy_(1, 0) - velint_(0)*derxy_(0, vi)*gridvint_(1)*vderxy_(1, 1) - velint_(0)*derxy_(1, vi)*gridvint_(1)*vderxy_(1, 0) - velint_(1)*derxy_(0, vi)*gridvint_(0)*vderxy_(1, 1) - velint_(1)*derxy_(1, vi)*gridvint_(0)*vderxy_(1, 0) - 2.0*velint_(1)*derxy_(1, vi)*gridvint_(1)*vderxy_(1, 1)) ;
#endif
...
#ifdef FLUID2_IS_TERM2
    /* Stabilisierung der Konvektion ( L_conv_u) */
    eforce_(vi*2 + 4) += ttimetauM*(2.0*conv_c_(vi)*conv_old_(0) - 2.0*velint_(0)*derxy_(0, vi)*gridvint_(0)*vderxy_(0, 0) - velint_(0)*derxy_(0, vi)*gridvint_(1)*vderxy_(0, 1) - velint_(0)*derxy_(1, vi)*gridvint_(1)*vderxy_(0, 0) - velint_(1)*derxy_(0, vi)*gridvint_(0)*vderxy_(0, 1) - velint_(1)*derxy_(1, vi)*gridvint_(0)*vderxy_(0, 0) - 2.0*velint_(1)*derxy_(1, vi)*gridvint_(1)*vderxy_(0, 1)) ;
    eforce_(vi*2 + 5) += ttimetauM*(2.0*conv_c_(vi)*conv_old_(1) - 2.0*velint_(0)*derxy_(0, vi)*gridvint_(0)*vderxy_(1, 0) - velint_(0)*derxy_(0, vi)*gridvint_(1)*vderxy_(1, 1) - velint_(0)*derxy_(1, vi)*gridvint_(1)*vderxy_(1, 0) - velint_(1)*derxy_(0, vi)*gridvint_(0)*vderxy_(1, 1) - velint_(1)*derxy_(1, vi)*gridvint_(0)*vderxy_(1, 0) - 2.0*velint_(1)*derxy_(1, vi)*gridvint_(1)*vderxy_(1, 1)) ;
#endif
...
#ifdef FLUID2_IS_TERM16
    /* Konvektionsstabilisierung */
    eforce_(vi*2 + 4) += timetauM*conv_g_(vi)*rhsint_(0) ;
    eforce_(vi*2 + 5) += timetauM*conv_g_(vi)*rhsint_(1) ;
#endif
