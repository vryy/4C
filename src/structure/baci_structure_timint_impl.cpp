...
#include "baci_contact_abstract_strategy.hpp"  // needed in CmtLinearSolve (for feeding the contact solver with latest information about the contact status)
#include "baci_contact_defines.hpp"
#include "baci_contact_manager.hpp"
#include "baci_contact_meshtying_abstract_strategy.hpp"  // needed in CmtLinearSolve (for feeding the contact solver with latest information about the contact status)
