...
#ifndef FOUR_C_POROFLUID_PRESSURE_BASED_ELE_HPP
#define FOUR_C_POROFLUID_PRESSURE_BASED_ELE_HPP
    ...
    */
    class PoroFluidMultiPhase : public Core::Elements::Element
    {
      ...
      */
       ...
       */
      void set_material(const int index, std::shared_ptr<Core::Mat::Material> mat) override;
