                 ...
                 DOUBLE cmat[NUMSTR_SOLID3][NUMSTR_SOLID3])
{
  ...
  switch (mat->mattyp)
  {
    ...
    case m_stvenant:
    {
      ...
      /* Poisson's ratio */
      nu = mat->m.stvenant->possionratio;
#ifdef D_MAT
      {
        /* We need to create a dynmically allocated array to hold
         * constitutive matrix. The reason is due to C incapabilties to
         * treat statically and dynamically allocated multi-dimensional
