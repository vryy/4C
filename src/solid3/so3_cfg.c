...
/*!
\file
\brief Configure element SOLID3
...
void so3_cfg_chkdef()
{
  ...
  if (MAXNOD_SOLID3 < 4)
  {
    dserror("MAXNOD_SOLID3 or MAXNOD : maximum of element nodes\n"
  ...
  if (MAXNE_SOLID3 < 2)
  {
    dserror("MAXNE_SOLID3 : maximal number of nodes on an edge\n"
...
void so3_cfg_init(SO3_DATA *data)
{
   ...
   */
  /* 8-node hexahedron */
  if ( (MAXSID_SOLID3 >= 6) && (MAXNS_SOLID3 >= 4) )
  {
    /* side 0 */
    data->nodsidh[0][0] = 0;
    data->nodsidh[0][1] = 1;
  ...
  /* additionally for 20-node hexahedron */
  if ( (MAXSID_SOLID3 >= 6) && (MAXNS_SOLID3 >=8 ) )
  {
    /* side 0 */
    data->nodsidh[0][4] = 8;
    data->nodsidh[0][5] = 9;
  ...
  /* additionally for 27-node hexahedron */
  if ( (MAXSID_SOLID3 >= 6) && (MAXNS_SOLID3 >= 9) )
  {
    /* side 0 */
    data->nodsidh[0][8] = 20;
    /* side 5 */
   ...
   */
  /* 8-node hexahedron */
  if ( (MAXEDG_SOLID3 >= 12) && (MAXNE_SOLID3 >= 2) )
  {
    /* edge 0 */
    data->nodedghl[0][0] = 0;
    data->nodedghl[0][1] = 1;
  ...
  if ( (MAXEDG_SOLID3 >= 12) && (MAXNE_SOLID3 >= 3) )
  {
    /* edge 0 */
    data->nodedghq[0][0] = 0;
    data->nodedghq[0][1] = 8;
   ...
   */
  /* 4-node tetrahedron */
  if ( (MAXSID_SOLID3 >= 4) && (MAXNS_SOLID3 >= 3) )
  {
    /* side 0 */
    data->nodsidt[0][0] = 0;
    data->nodsidt[0][1] = 1;
  ...
  /* 10-node tetrahedron */
  if ( (MAXSID_SOLID3 >= 4) && (MAXNS_SOLID3 >= 6) )
  {
    /* side 0 */
    data->nodsidt[0][3] = 4;
    data->nodsidt[0][4] = 5;
   ...
   */
  /* 4-node tetrahedron */
  if ( (MAXEDG_SOLID3 >= 6) && (MAXNE_SOLID3 >= 2) )
  {
    /* edge 0 */
    data->nodedgtl[0][0] = 0;
    data->nodedgtl[0][1] = 1;
  ...
  /* 10-node tetrahedron */
  if ( (MAXEDG_SOLID3 >= 6) && (MAXNE_SOLID3 >= 3) )
  {
    /* edge 0 */
    data->nodedgtq[0][0] = 0;
    data->nodedgtq[0][1] = 4;
...
#endif
  return;
}  /* end of so3_cfg_noderst */


/*======================================================================*/
/*!
\brief Test parametric geometry and topology of SOLID3 element
...
void so3_cfg_test(SO3_DATA *data)
{
  ...
  for (inod=0; inod<MAXNOD_SOLID3; inod++)
  {
  ...
  /*--------------------------------------------------------------------*/
  /* loop sides */
  for (isid=0; isid<MAXSID_SOLID3; isid++)
  {
    fprintf(filetest, "# Side %i\n", isid);
    for (inod=0; inod<MAXNS_SOLID3; inod++)
    {
  ...
  /*--------------------------------------------------------------------*/
  /* loop linear edges */
  for (iedg=0; iedg<MAXEDG_SOLID3; iedg++)
  {
    fprintf(filetest, "# Edge %i\n", iedg);
    for (inod=0; inod<MAXNE_SOLID3-1; inod++)
    {
  ...
  {
    fprintf(filetest, "# Edge %i\n", iedg);
    for (inod=0; inod<MAXNE_SOLID3; inod++)
    {
...
#endif  /* end of #ifdef TEST_SOLID3 */
