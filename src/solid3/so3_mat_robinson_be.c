...
/*   so3_mat_robinson_be_dvscstn(mat_robin, tem, stsdev, stsovr, */
/*                                  actso3->miv_rob->dvicstn.a.d3[ip][actstg]); */

  /*--------------------------------------------------------------------*/
  /* back stress rate */
/*   so3_mat_robinson_be_dbcksts(mat_robin, tem, stsdev, stsbac, */
/*                                  actso3->miv_rob->dvicstn.a.d3[ip][actstg], */
                                ...
                                DOUBLE cmat[NUMSTR_SOLID3][NUMSTR_SOLID3])
{
  ...
  so3_vct6_ass(actso3->miv_rob->vicstn.a.da[ip], stnvsc);
