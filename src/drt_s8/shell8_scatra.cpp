...
DRT::ELEMENTS::Shell8ScatraType& DRT::ELEMENTS::Shell8ScatraType::Instance()
{
  return instance_;
}
 ...
 *----------------------------------------------------------------------*/
Teuchos::RCP<DRT::Element> DRT::ELEMENTS::Shell8ScatraType::Create( const std::string eletype,
 ...
 *----------------------------------------------------------------------*/
void DRT::ELEMENTS::Shell8ScatraType::SetupElementDefinition( std::map<std::string,std::map<std::string,DRT::INPUT::LineDefinition> > & definitions )
{
  ...
  std::map<std::string, DRT::INPUT::LineDefinition>& defs_shell =
      definitions_shell["SHELL8"];

  std::map<std::string, DRT::INPUT::LineDefinition>& defs =
      definitions["SHELL8SCATRA"];
 ...
 *----------------------------------------------------------------------*/
bool DRT::ELEMENTS::Shell8_Scatra::ReadElement(const std::string& eletype, const std::string& eledistype, DRT::INPUT::LineDefinition* linedef)
{
  // read base element
