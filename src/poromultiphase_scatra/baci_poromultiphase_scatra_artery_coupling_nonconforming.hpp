...
#ifndef BACI_POROMULTIPHASE_SCATRA_ARTERY_COUPLING_NONCONFORMING_HPP
#define BACI_POROMULTIPHASE_SCATRA_ARTERY_COUPLING_NONCONFORMING_HPP
...
#endif  // POROMULTIPHASE_SCATRA_ARTERY_COUPLING_NONCONFORMING_H
