...
#ifndef BACI_POROMULTIPHASE_SCATRA_ARTERY_COUPLING_NODETOPOINT_HPP
#define BACI_POROMULTIPHASE_SCATRA_ARTERY_COUPLING_NODETOPOINT_HPP
...
#endif  // POROMULTIPHASE_SCATRA_ARTERY_COUPLING_NODETOPOINT_H