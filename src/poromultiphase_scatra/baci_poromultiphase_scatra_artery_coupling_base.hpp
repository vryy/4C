...
#ifndef BACI_POROMULTIPHASE_SCATRA_ARTERY_COUPLING_BASE_HPP
#define BACI_POROMULTIPHASE_SCATRA_ARTERY_COUPLING_BASE_HPP
...
#endif  // POROMULTIPHASE_SCATRA_ARTERY_COUPLING_BASE_H
