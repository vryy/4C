...
*----------------------------------------------------------------------*/
void saxistatic_ke(ELEMENT   *ele, 
                   SAXI_DATA *data, 
                   MATERIAL  *mat,
                   ARRAY     *estif_global,
                   INT        init)
...
const INT           numdf  = 2;
const INT           numeps = 4;/* eps^0_s,eps^0_deta,kappa_s,kappa_deta */
...
static DOUBLE **work2;
static ARRAY    B_a;                    /* B-operator vgl.Schalen Skript*/
static DOUBLE **B;
static ARRAY    estif_7_a; 
static DOUBLE **estif_7;          /* ke(7,7) before static condensation */
...
estif_7   = amdef("estif_7",&estif_7_a ,7,7,"DA");                     
...
*----------------------------------------------------------------------*/
void saxi_statcond( ELEMENT *ele,
                    DOUBLE **estif,  
                    DOUBLE **estif_7,
                    DOUBLE    cosa,  
                    DOUBLE    sina)  
