...
Teuchos::RCP<std::set<int> > ALE::UTILS::MapExtractor::ConditionedElementMap(const DRT::Discretization& dis) const
{
  ...
  Teuchos::RCP<std::set<int> > condelements5 = DRT::UTILS::ConditionedElementMap(dis,"BioGrCoupling");
  Teuchos::RCP<std::set<int> > condelements6 = DRT::UTILS::ConditionedElementMap(dis,"ALEUPDATECoupling");
  Teuchos::RCP<std::set<int> > condelements7 = DRT::UTILS::ConditionedElementMap(dis,"FPSICoupling");
