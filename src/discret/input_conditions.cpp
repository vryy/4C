...
void input_conditions()
{
  ...
  // At this point the discretization have Filled() = false !
  
  // Fuer Dirichlet-RBs:
  // kein wahnsinn -> condition wird mit Knoten verpointert und das wars
  
  // fuer Neumann:
  // wahnsinn:
  // von einer individuellen cloud die geometrische Hierarchie erstellen
  // die geometrische Hierarchie einer cloud soll komplett mit elementen
  // verpointert werden  
...
/*----------------------------------------------------------------------*
 | input of conditions                                    m.gee 11/06   |
 *----------------------------------------------------------------------*/
// old versionxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx
void input_conditions()
{
  DSTraceHelper dst("input_conditions");
