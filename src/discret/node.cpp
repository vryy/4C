 ...
 *----------------------------------------------------------------------*/
void CCADISCRETIZATION::Node::Print() const
{
  cout << "Node " << Id() << " Coords " << X()[0] << " " << X()[1] << " " << X()[2];
  return;
}
...
/*----------------------------------------------------------------------*
 |  Add element ptr                                            (public) |
 |                                                            gee 11/06 |
 *----------------------------------------------------------------------*/
void CCADISCRETIZATION::Node::AddElementPtr(CCADISCRETIZATION::Element* ele) const
{
  vector<CCADISCRETIZATION::Element*>* elements = const_cast<vector<CCADISCRETIZATION::Element*>*>(&element_);
