...
{
  return Core::Communication::GetElementLines<StructuralLine, SolidPoroPressureVelocityBased>(
      *this);
}
...
{
  return Core::Communication::GetElementSurfaces<StructuralSurface, SolidPoroPressureVelocityBased>(
      *this);
}
