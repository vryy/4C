...
void INPAR::XCONTACT::SetValidParameters(Teuchos::RCP<Teuchos::ParameterList> list)
{
  ...
  setStringToIntegralParameter<int>("COUPL_ALGO", "None",
      ...
      tuple<std::string>("None", "none", "Monolithic", "monolithic", "Partitioned", "partitioned"),
      tuple<int>(field_coupl_algo_undefined, field_coupl_algo_undefined,
          field_coupl_algo_monolithic, field_coupl_algo_monolithic, field_coupl_algo_partitioned,
          field_coupl_algo_partitioned),
      &p_xcontact);
}
