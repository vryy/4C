...
void INPAR::FLUID::SetValidParameters(Teuchos::RCP<Teuchos::ParameterList> list)
{
...

  {
    ...
    name[ 3] = "FLAME_VORTEX_INTERACTION";               label[ 3] = initfield_flame_vortex_interaction;
    name[ 4] = "BELTRAMI-FLOW";                          label[ 4] = initfield_beltrami_flow;
    name[ 5] = "KIM-MOIN-FLOW";                          label[ 5] = initfield_kim_moin_flow;
    name[ 6] = "BOCHEV-TEST";                            label[ 6] = initfield_bochev_test;
    name[ 7] = "hit_comte_bellot_corrsin_initial_field"; label[ 7] = initfield_hit_comte_bellot_corrsin;
...
/*  setStringToIntegralParameter<int>("SPLITFLUID","no",
...

  {
    ...
    name[ 0] = "Taylor_Hughes_Zarins";                        label[ 0] = tau_taylor_hughes_zarins;
    name[ 1] = "Taylor_Hughes_Zarins_wo_dt";                  label[ 1] = tau_taylor_hughes_zarins_wo_dt;
    name[ 2] = "Taylor_Hughes_Zarins_Whiting_Jansen";         label[ 2] = tau_taylor_hughes_zarins_whiting_jansen;
    name[ 3] = "Taylor_Hughes_Zarins_Whiting_Jansen_wo_dt";   label[ 3] = tau_taylor_hughes_zarins_whiting_jansen_wo_dt;
    name[ 4] = "Taylor_Hughes_Zarins_scaled";                 label[ 4] = tau_taylor_hughes_zarins_scaled;
    name[ 5] = "Taylor_Hughes_Zarins_scaled_wo_dt";           label[ 5] = tau_taylor_hughes_zarins_scaled_wo_dt;
    name[ 6] = "Franca_Barrenechea_Valentin_Frey_Wall";       label[ 6] = tau_franca_barrenechea_valentin_frey_wall;
    name[ 7] = "Franca_Barrenechea_Valentin_Frey_Wall_wo_dt"; label[ 7] = tau_franca_barrenechea_valentin_frey_wall_wo_dt;
    name[ 8] = "Shakib_Hughes_Codina";                        label[ 8] = tau_shakib_hughes_codina;
    name[ 9] = "Shakib_Hughes_Codina_wo_dt";                  label[ 9] = tau_shakib_hughes_codina_wo_dt;
    name[10] = "Codina";                                      label[10] = tau_codina;
    name[11] = "Codina_wo_dt";                                label[11] = tau_codina_wo_dt;
    name[12] = "Codina_convscaled";                           label[12] = tau_codina_convscaled;
    name[13] = "Franca_Madureira_Valentin_Badia_Codina";      label[13] = tau_franca_madureira_valentin_badia_codina;
    name[14] = "Franca_Madureira_Valentin_Badia_Codina_wo_dt";label[14] = tau_franca_madureira_valentin_badia_codina_wo_dt;
    name[15] = "Hughes_Franca_Balestra_wo_dt";                label[15] = tau_hughes_franca_balestra_wo_dt;
  ...
  setStringToIntegralParameter<int>("EOS_PRES",
                               ...
                               tuple<int>(
                                 EOS_PRES_none,       // no pressure edge-based stabilization
                                 EOS_PRES_std_eos,    // pressure edge-based stabilization on the entire domain
                                 EOS_PRES_xfem_gp     // pressure edge-based stabilization as ghost penalty around cut elements
                               ),
  ...
  setStringToIntegralParameter<int>("EOS_CONV_STREAM",
                               ...
                               tuple<int>(
                                 ...
                                 EOS_CONV_STREAM_std_eos,    // convective streamline edge-based stabilization on the entire domain
                                 EOS_CONV_STREAM_xfem_gp     // pressure edge-based stabilization as ghost penalty around cut elements
                               ),
                               &fdyn_edge_based_stab);
  ...
  setStringToIntegralParameter<int>("EOS_CONV_CROSS",
                               ...
                               tuple<int>(
                                 EOS_CONV_CROSS_none,       // no convective crosswind edge-based stabilization
                                 EOS_CONV_CROSS_std_eos,    // convective crosswind edge-based stabilization on the entire domain
                                 EOS_CONV_CROSS_xfem_gp     // convective crosswind edge-based stabilization as ghost penalty around cut elements
                               ),
                               &fdyn_edge_based_stab);
  ...
  setStringToIntegralParameter<int>("EOS_DIV",
                               ...
                               tuple<std::string>(
                                 ...
                                 "divergence edge-based stabilization based on divergence jump just around cut elements"),
                               tuple<int>(
                                 EOS_DIV_none,                       // no convective edge-based stabilization
...
void INPAR::FLUID::SetValidConditions(std::vector<Teuchos::RCP<DRT::INPUT::ConditionDefinition> >& condlist)
{
  using namespace DRT::INPUT;
