...
void INPAR::STI::SetValidParameters(Teuchos::RCP<Teuchos::ParameterList> list)
{
  ...
  setStringToIntegralParameter<int>("SCATRATIMINTTYPE", "Standard",
      ...
      tuple<int>(INPAR::STI::scatratiminttype_standard, INPAR::STI::scatratiminttype_elch),
      &stidyn);

  // type of coupling between scatra and thermo fields
  setStringToIntegralParameter<int>("COUPLINGTYPE", "Undefined",
      "type of coupling between scatra and thermo fields",
      ...
      tuple<int>(INPAR::STI::coupling_undefined, INPAR::STI::coupling_monolithic,
          INPAR::STI::coupling_oneway_scatratothermo, INPAR::STI::coupling_oneway_thermotoscatra,
  ...
  setStringToIntegralParameter<int>("MATRIXTYPE", "block",
      "type of global system matrix in global system of equations",
      tuple<std::string>("block", "sparse"),
      tuple<int>(INPAR::STI::matrix_block, INPAR::STI::matrix_sparse), &stidyn_monolithic);
