...
namespace INPAR
{
  ...
  void SetValidSolverParameters(Teuchos::ParameterList& list)
  {
    ...
    solver_name[0] = "Amesos_KLU_sym";               solver_number[0] = amesos_klu_sym;
    solver_name[1] = "Amesos_KLU_nonsym";            solver_number[1] = amesos_klu_nonsym;
    solver_name[2] = "Superlu";                      solver_number[2] = superlu;
    solver_name[3] = "Aztec_MSR";                    solver_number[3] = aztec_msr;
    solver_name[4] = "LAPACK_sym";                   solver_number[4] = lapack_sym;
    solver_name[5] = "LAPACK_nonsym";                solver_number[5] = lapack_nonsym;
    solver_name[6] = "UMFPACK";                      solver_number[6] = umfpack;
    solver_name[7] = "Belos";                        solver_number[7] = belos;
    solver_name[8] = "Stratimikos_Amesos";           solver_number[8] = stratimikos_amesos;
    solver_name[9] = "Stratimikos_Aztec";            solver_number[9]= stratimikos_aztec;
    solver_name[10]= "Stratimikos_Belos";            solver_number[10]= stratimikos_belos;
    solver_name[11]= "undefined";                    solver_number[11]= undefined;
...

    {
      ...
      name[10] = "ML";                          number[10] = azprec_ML;
      name[11] = "MLFLUID";                     number[11] = azprec_MLfluid;
      name[12] = "MLFLUID2";                    number[12] = azprec_MLfluid2;
      name[13] = "MLAPI";                       number[13] = azprec_MLAPI;
      name[14] = "GaussSeidel";                 number[14] = azprec_GaussSeidel;
      name[15] = "DownwindGaussSeidel";         number[15] = azprec_DownwindGaussSeidel;
      name[16] = "BGS2x2";                      number[16] = azprec_BGS2x2;
      name[17] = "BGSnxn";                      number[17] = azprec_BGSnxn;
      name[18] = "TekoSIMPLE";                  number[18] = azprec_TekoSIMPLE;
      name[19] = "CheapSIMPLE";                 number[19] = azprec_CheapSIMPLE;
      name[20] = "MueLu_sym";                   number[20] = azprec_MueLuAMG_sym;
      name[21] = "MueLu_nonsym";                number[21] = azprec_MueLuAMG_nonsym;
      name[22] = "MueLu_contact";               number[22] = azprec_MueLuAMG_contact;
      name[23] = "MueLu_contact2";              number[23] = azprec_MueLuAMG_contact2;
      name[24] = "MueLu_contactSP";             number[24] = azprec_MueLuAMG_contactSP;
      name[25] = "MueLu_contactPenalty";        number[25] = azprec_MueLuAMG_contactPen;
      name[26] = "AMGnxn";                      number[26] = azprec_AMGnxn;
      name[27] = "Chebyshev";                   number[27] = azprec_Chebyshev;
...

    {
      ...
      name[0] = "nothing";                      number[0] = Reuse_nothing;
      name[1] = "Ptent";                        number[1] = Reuse_Ptent;
      name[2] = "full";                         number[2] = Reuse_full;
    ...
    // parameters for permutation of linear systems
    {
      ...
      name[0] = "none";         number[0] = Permutation_none;
      name[1] = "Algebraic";    number[1] = Permutation_algebraic;
      name[2] = "algebraic";    number[2] = Permutation_algebraic;
      name[3] = "Local";        number[3] = Permutation_local;
      name[4] = "local";        number[4] = Permutation_local;
