...
void INPAR::MORTAR::SetValidParameters(Teuchos::RCP<Teuchos::ParameterList> list)
{
  ...
  setStringToIntegralParameter<int>("LM_SHAPEFCN","Dual","Type of employed set of shape functions",
        ...
        tuple<int>(
                ...
                shape_standard, shape_standard, shape_standard,
  ...
  setStringToIntegralParameter<int>("SEARCH_ALGORITHM","Binarytree","Type of contact search",
       ...
       tuple<int>(search_bfele,search_bfele,
                  search_bfele,search_bfele,
  ...
  setStringToIntegralParameter<int>("MESH_RELOCATION","Initial","Type of mesh relocation",
      tuple<std::string>("Initial","initial",
                         ...
                         "No", "no"),
      tuple<int>(
              relocation_initial,  relocation_initial,
              relocation_timestep, relocation_timestep,
  ...
  setStringToIntegralParameter<int>("REDUNDANT_STORAGE","Master","Type of redundancy in interface storage",
      tuple<std::string>("All","all",
                         ...
                         "None", "none"),
      tuple<int>(
              redundant_all,    redundant_all,
              redundant_master, redundant_master,
              redundant_none,   redundant_none),
      &mortar);
  ...
  setStringToIntegralParameter<int>("PARALLEL_STRATEGY","redundant_ghosting","Type of parallel interface evaluation",
      ...
      tuple<int>(
              ghosting_redundant, ghosting_redundant,ghosting_redundant,
              roundrobinevaluate, roundrobinevaluate,roundrobinevaluate,
              roundrobinghost, roundrobinghost,roundrobinghost,
  ...
  setStringToIntegralParameter<int>("PARALLEL_REDIST","Static","Type of redistribution algorithm",
      tuple<std::string>("None","none", "No", "no",
                         ...
                         "Dynamic", "dynamic"),
      tuple<int>(
              parredist_none, parredist_none,
              parredist_none, parredist_none,
              parredist_static, parredist_static,
              parredist_dynamic, parredist_dynamic),
      &mortar);
...
void INPAR::MORTAR::SetValidConditions(std::vector<Teuchos::RCP<DRT::INPUT::ConditionDefinition> >& condlist)
{
  using namespace DRT::INPUT;
  /*--------------------------------------------------------------------*/
  // mortar contact
  ...
  Teuchos::RCP<ConditionDefinition> surfcontact =
    Teuchos::rcp(new ConditionDefinition("DESIGN SURF MORTAR CONTACT CONDITIONS 3D",
                                         "Contact",
