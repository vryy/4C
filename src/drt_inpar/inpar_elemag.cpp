...
void INPAR::ELEMAG::SetValidParameters(Teuchos::RCP<Teuchos::ParameterList> list)
{
  ...
  // time integration
  setStringToIntegralParameter<int>("TIMEINT", "One_Step_Theta", "Type of time integration scheme",
      tuple<std::string>("One_Step_Theta"), tuple<int>(elemag_ost), &electromagneticdyn);
