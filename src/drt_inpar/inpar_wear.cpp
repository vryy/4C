...
void INPAR::WEAR::SetValidParameters(Teuchos::RCP<Teuchos::ParameterList> list)
{
  ...
  setStringToIntegralParameter<int>("WEARCOEFF_CONF","material","configuration in which wcoeff is defined",
      tuple<std::string>("material","mat",
                         "spatial","sp"),
      tuple<int>(
                 wear_coeff_mat, wear_coeff_mat,
                 wear_coeff_sp,  wear_coeff_sp),
      &wear);
  ...
  setStringToIntegralParameter<int>("WEAR_SHAPE_EVO","material","configuration for shape evolution step",
      tuple<std::string>("material","mat",
                         "spatial","sp"),
      tuple<int>(
                 wear_se_mat, wear_se_mat,
                 wear_se_sp,  wear_se_sp),
      &wear);
  ...
  setStringToIntegralParameter<int>("WEAR_SHAPEFCN","std","Type of employed set of shape functions for wear",
        ...
        tuple<int>(
                wear_shape_dual, wear_shape_dual,
                wear_shape_standard, wear_shape_standard, wear_shape_standard),
        &wear);
  ...
  setStringToIntegralParameter<int>("WEAR_SIDE","slave","Definition of wear side",
        ...
        tuple<int>(
                wear_slave,wear_slave,wear_slave,
                wear_both, wear_both, wear_both),
        &wear);
  ...
  setStringToIntegralParameter<int>("WEARTYPE","internal_state","Definition of wear algorithm",
        ...
        tuple<int>(
                wear_intstate, wear_intstate, wear_intstate,
                wear_primvar,  wear_primvar,  wear_primvar),
        &wear);
  ...
  setStringToIntegralParameter<int>("WEARTIMINT","explicit","Definition of wear time integration",
        tuple<std::string>("explicit","e", "expl" ,
                           "implicit","i", "impl"),
        tuple<int>(
                wear_expl, wear_expl, wear_expl,
                wear_impl, wear_impl, wear_impl),
        &wear);
  ...
  setStringToIntegralParameter<int>("WEAR_COUPALGO","stagg","Definition of wear (ALE) coupling algorithm",
        tuple<std::string>("stagg","s",
                           ...
                           "monolithic","mono"),
        tuple<int>(
                wear_stagg, wear_stagg,
                wear_iterstagg, wear_iterstagg,
                wear_monolithic, wear_monolithic),
        &wear);
