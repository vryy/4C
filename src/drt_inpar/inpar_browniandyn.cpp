...
void INPAR::BROWNIANDYN::SetValidParameters(Teuchos::RCP<Teuchos::ParameterList> list)
{
  ...
  setStringToIntegralParameter<int>(
    ...
    tuple<std::string>(
      ...
      "Input_file"),
    tuple<int>(
      INPAR::BROWNIANDYN::cylinder_geometry_approx,
      INPAR::BROWNIANDYN::cylinder_geometry_approx,
  ...
  setNumericStringParameter("BEAMS_DAMPING_COEFF_PER_UNITLENGTH","",
      "values for beam damping coefficients (per unit length and NOT yet multiplied by fluid viscosity): "
