...
/*----------------------------------------------------------------------*/
/*----------------------------------------------------------------------*/
MAT::PAR::MurnaghanTaitFluid::MurnaghanTaitFluid(
...
/*----------------------------------------------------------------------*/
/*----------------------------------------------------------------------*/
MAT::MurnaghanTaitFluid::MurnaghanTaitFluid()
  : params_(NULL)
{
}
...
/*----------------------------------------------------------------------*/
/*----------------------------------------------------------------------*/
MAT::MurnaghanTaitFluid::MurnaghanTaitFluid(MAT::PAR::MurnaghanTaitFluid* params)
  : params_(params)
{
}
...
double MAT::MurnaghanTaitFluid::ComputeDensity(const double press) const
{
  ...
  const double density = RefDensity()*std::pow((MatParameter()/RefBulkModulus()*(press-RefPressure())+1.0),(1.0/MatParameter()));
