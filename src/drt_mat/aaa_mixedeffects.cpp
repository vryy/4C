...
/*----------------------------------------------------------------------*
 |                                                                      |
 *----------------------------------------------------------------------*/
MAT::PAR::AAA_mixedeffects::AAA_mixedeffects(
 ...
 *----------------------------------------------------------------------*/
MAT::AAA_mixedeffects::AAA_mixedeffects()
  : params_(NULL)
{
}
...
/*----------------------------------------------------------------------*
 |  Constructor                             (public)   chfoe 03/08 |
 *----------------------------------------------------------------------*/
MAT::AAA_mixedeffects::AAA_mixedeffects(MAT::PAR::AAA_mixedeffects* params)
  : params_(params)
{
}
				      ...
				      double elelocalrad)
{
  ...
  // material parameters for isochoric part
  const double alpha    = 1E6*(0.09631+0.03329*(elelocalrad*2/params_->refdia_ - 2.55));
  const double beta     = 1E6*(-0.9553*(elelocalrad/(params_->refdia_) - 2.55)+(0.06721 * (params_->age_)));
  const double nue      = params_->nue_;       // Poisson's ratio
  // material parameters for volumetric part
