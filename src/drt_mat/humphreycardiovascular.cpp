...
/*----------------------------------------------------------------------*
 |  Unpack                                        (public)         11/09|
 *----------------------------------------------------------------------*/
void MAT::HumphreyCardio::Unpack(const std::vector<char>& data)
{
  isinit_=true;
  ...
  a3_ = Teuchos::rcp(new std::vector<std::vector<double> >(numgp));
  a4_ = Teuchos::rcp(new std::vector<std::vector<double> >(numgp));
  ca1_ = Teuchos::rcp(new std::vector<std::vector<double> >(numgp));
  ca2_ = Teuchos::rcp(new std::vector<std::vector<double> >(numgp));
  ca3_ = Teuchos::rcp(new std::vector<std::vector<double> >(numgp));
  ca4_ = Teuchos::rcp(new std::vector<std::vector<double> >(numgp));
...
(const int gp, const LINALG::Matrix<3,3>& locsys, const LINALG::Matrix<3,3>& defgrd)
{
  ...
  std::vector<double> a3_0(3);
  std::vector<double> a4_0(3);
