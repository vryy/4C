 ...
 * a_[1] is paf_infinity in component rapid_delayed_rectifier_potassium_current_paf_gate (dimensionless).
 * a_[2] is pas0_infinity in component rapid_delayed_rectifier_potassium_current_pas0_gate (dimensionless).
 * a_[3] is pik_infinity in component rapid_delayed_rectifier_potassium_current_pik_gate (dimensionless).
 ...
 * a_[11] is qfast_infinity in component transient_outward_potassium_current_qfast_gate (dimensionless).
 * a_[12] is qslow_infinity in component transient_outward_potassium_current_qslow_gate (dimensionless).
 ...
 * r_[2] is d/dt paf in component rapid_delayed_rectifier_potassium_current_paf_gate (dimensionless).
 * r_[3] is d/dt pas in component rapid_delayed_rectifier_potassium_current_pas0_gate (dimensionless).
 * r_[4] is d/dt pik in component rapid_delayed_rectifier_potassium_current_pik_gate (dimensionless).
 ...
 * r_[13] is d/dt q_fast in component transient_outward_potassium_current_qfast_gate (dimensionless).
 * r_[14] is d/dt q_slow in component transient_outward_potassium_current_qslow_gate (dimensionless).
...
double Myocard_Inada::ReaCoeff(const double phi, const double dt)
{
  ...
  //r_[24] = a_[18];
  s_[24] = tools_.GatingVarCalc(dt, s0_[24], 2277.0*2.5*(1.0-s0_[23])/(2277.0*2.5*(1.0-s0_[23]) +  751.0), 1.0/(2277.0*2.5*(1.0-s0_[23]) +  751.0));

  // s_[1] is y in component hyperpolarising_activated_current_y_gate (dimensionless).
  a_[0] = 1.0/(1.0+(exp((((s0_[0]+83.19) - ( - 7.2*(pow(c_[10], 0.69)))/((pow(1.26e-05, 0.69))+(pow(c_[10], 0.69))))/13.56))));
  ...
  a_[29] = 0.000596+0.003118/( 1.037*(exp(( 0.09*(s0_[0]+30.61))))+ 0.396*(exp(( - 0.12*(s0_[0]+23.84)))));
  ...
  //
  a_[4] = s0_[0]+44.4000;
  a_[23] = ((fabs(a_[4]))<c_[35] ? ( - 460.0*- 12.6730)/(exp((a_[4]/- 12.6730))) : ( - 460.0*a_[4])/((exp((a_[4]/- 12.6730))) - 1.0));
  ...
  a_[3] =  (1.0/(1.0+(exp(((s0_[0]+4.90000)/15.1400)))))*(1.0 -  0.300000*(exp((- (pow(s0_[0], 2.0))/500.0))));
  ...
  a_[7] = ( - 26.1200*(s0_[0]+35.0))/((exp(((s0_[0]+35.0)/- 2.50000))) - 1.0)+( - 78.1100*s0_[0])/((exp(( - 0.208000*s0_[0]))) - 1.0);
  ...
  a_[33] = 0.150400/( 95.0*(exp((- s0_[0]/10.0)))+ 50.0*(exp((- s0_[0]/700.0))))+0.000229000/(1.0+(exp((- s0_[0]/5.0))));
  ...
  // -------------------------
  a_[66] = ( (( c_[34]*(pow(s_[6], 3.0))*( 0.635*s_[7]+ 0.365*s_[8])*c_[33]*s_[0]*c_[2])/c_[53])*((exp(((s_[0] - c_[60])/c_[53]))) - 1.0))/((exp((s_[0]/c_[53]))) - 1.0);
  a_[69] = ( c_[45]*s0_[17]*s0_[18]*(pow(c_[10], 1.5)))/((pow(c_[46], 1.5))+(pow(c_[10], 1.5)));
  a_[70] = ( (( a_[69]*c_[13])/(10.0+c_[13]))*(s_[0] - c_[58]))/(1.0+(exp((((s_[0] - c_[58]) - 140.0)/( 2.5*c_[53])))));
  a_[71] =  c_[36]*s_[9]*( 0.675*s_[10]+ 0.325*s_[11])*(s_[0] - c_[37])*(1.0 - (( a_[70]*c_[10])/(9.0e-05+c_[10]))/1.0);
  ...
  a_[50] = ( a_[49]*(pow((c_[13]/(c_[13]+0.59)), 3.0))*(s_[0]+81.9))/(1.0+(exp((( 1.393*(s_[0]+81.9+3.6))/c_[53]))));
  a_[58] = exp((( - c_[21]*s0_[0])/( 2.0*c_[53])));
  a_[53] = 1.0+ (c_[32]/c_[31])*(1.0+(exp((( c_[22]*s0_[0])/c_[53]))))+c_[33]/c_[29]+(pow(c_[33], 2.0))/( c_[29]*c_[30])+(pow(c_[33], 3.0))/( c_[29]*c_[30]*c_[28]);
  a_[55] = ( ((pow(c_[33], 2.0))/( c_[29]*c_[30])+(pow(c_[33], 3.0))/( c_[29]*c_[30]*c_[28]))*(exp((( - c_[21]*s0_[0])/( 2.0*c_[53])))))/a_[53];
  ...
  a_[57] = 1.0+ (s0_[5]/c_[23])*(1.0+(exp((( - c_[20]*s0_[0])/c_[53])))+c_[18]/c_[27])+c_[18]/c_[24]+(pow(c_[18], 2.0))/( c_[24]*c_[25])+(pow(c_[18], 3.0))/( c_[24]*c_[25]*c_[26]);
  a_[60] = ( (s0_[5]/c_[23])*(exp((( - c_[20]*s0_[0])/c_[53]))))/a_[57];
  a_[59] = ( ((pow(c_[18], 2.0))/( c_[24]*c_[25])+(pow(c_[18], 3.0))/( c_[24]*c_[25]*c_[26]))*(exp((( c_[21]*s0_[0])/( 2.0*c_[53])))))/a_[57];
  ...
  a_[52] = ( c_[17]*(pow((c_[18]/(5.64+c_[18])), 3.0))*(pow((c_[13]/(0.621+c_[13])), 2.0))*1.6)/(1.5+(exp((- (s_[0]+60.0)/40.0))));
  a_[51] =  c_[15]*(s_[0] - c_[16]);
  a_[17] = 0.0;//(VOI_>=c_[4]&&VOI_<=c_[5]&&(VOI_ - c_[4]) -  (floor(((VOI_ - c_[4])/c_[6])))*c_[6]<=c_[7] ? c_[8] : 0.0);

  // Compute reaction coefficient (I_Na + I_CaL + I_to + I_Kr + I_f + I_st + I_K1 + I_NaCa + I_p + I_b + I_ACh)/C
  // ------------------------------------------------------------------------------------------------------------
  r_[0] = (a_[66]+a_[71]+a_[67]+a_[42]+a_[34]+a_[68]+a_[50]+a_[65]+a_[52]+a_[51]+a_[70]+a_[17])/c_[3];
  ...
  //r_[22] = a_[75];
  s_[22] = tools_.GatingVarCalc(dt, s0_[22], 88800.0*s0_[19]/(88800.0*s0_[19] +  446.0), 1.0/(88800.0*s0_[19] +  446.0));
  ...
  r_[23] = a_[77];
  s_[23] = tools_.GatingVarCalc(dt, s0_[23], 227700.0*s0_[19]*(1-s0_[24])/(227700.0*s0_[19]*(1-s0_[24]) +  7.51), 1.0/(227700.0*s0_[19]*(1-s0_[24]) +  7.51));
  ...
  double Carel_inf = s0_[20]/c_[52]+ c_[50]*s0_[5]/(1.0+(pow((0.0012/s0_[5]), 2.0))) - 10.0*a_[80];
  ...
  r_[19] = ( a_[72]*c_[57] -  a_[73]*c_[55])/c_[62] - ( 0.045*a_[78]+ 0.031*a_[75]+ 0.062*a_[77]);
  ...
  //r_[25] = a_[78];
  s_[25] = tools_.GatingVarCalc(dt, s0_[25], 227700.0*s0_[19]/(227700.0*s0_[19] +  542.0), 1.0/(227700.0*s0_[19] +  542.0));
  ...
  //r_[26] = a_[79];
  s_[26] = tools_.GatingVarCalc(dt, s0_[26], 227700.0*s0_[5]/(227700.0*s0_[5] +  542.0), 1.0/(227700.0*s0_[5] +  542.0));

  // s_[27] is f_CQ in component intracellular_calcium_concentration (dimensionless).
  r_[27] = a_[80];
  s_[27] = tools_.GatingVarCalc(dt, s0_[27], 534.0*s0_[21]/(534.0*s0_[21] +  445.0), 1.0/(534.0*s0_[21] +  445.0));

  // s_[5] is Casub in component intracellular_calcium_concentration (millimolar).
  a_[81] =  ( 0.115*s0_[5]*(1.0 - s0_[28]) -  1.0*s0_[28]);
  r_[5] = (((- (a_[71] -  2.0*a_[65])/( 2.0*c_[2])+ a_[76]*c_[56])/c_[57] - a_[72]) -  0.045*a_[79]) -  (0.031/1.2)*a_[81];
  ...
  //r_[28] = a_[81];
  s_[28] = tools_.GatingVarCalc(dt, s0_[28], s0_[5]/(s0_[5] + 1.0/0.115), 1.0/(0.115*s0_[5] + 1.0));
 ...
 *----------------------------------------------------------------------*/
int Myocard_Inada::GetNumberOfInternalStateVariables() const
{
  return 29;
}
