...
/*----------------------------------------------------------------------*
 |                                                                      |
 *----------------------------------------------------------------------*/
MAT::PAR::AAAneohooke_stopro::AAAneohooke_stopro(
 ...
 *----------------------------------------------------------------------*/
void MAT::AAAneohooke_stopro::Unpack(const vector<char>& data)
{
      ...
      LINALG::Matrix<6,1>& stress)
{
  ...
  // contribution: boeppel-product
  AddtoCmatHolzapfelProduct(cmat,invc,delta7);
 // HACK put mat data into stress tensor
  //stress(0,0)=beta;
  return;
}


/*void MAT::AAAneohooke_stopro::Evaluate(const Epetra_SerialDenseVector* glstrain_e,
                                      ...
                                      Epetra_SerialDenseVector* stress_e)
{
  ...
  double beta     = beta_;      // second parameter
