...
/*----------------------------------------------------------------------*/
/*----------------------------------------------------------------------*/
MAT::Yoghurt::Yoghurt(MAT::PAR::Yoghurt* params)
  : params_(params)
{
}
...
/*----------------------------------------------------------------------*/
/*----------------------------------------------------------------------*/
void MAT::Yoghurt::Unpack(const vector<char>& data)
{
...
{
  const double visc = PreExCon()*pow(abs(rateofstrain)+Delta(),(StrRateExp()-1))*exp(ActEnergy()/(temp*GasConst()));
