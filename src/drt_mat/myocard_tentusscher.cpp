...
double Myocard_TenTusscher::ReaCoeff(const double phi, const double dt)
{
  ...
  a_[20] =  1102.50*(exp((- (pow((s0_[0]+27.0), 2.0))/225.0)))+200.0/(1.0+(exp(((13.0 - s0_[0])/10.0))))+180.0/(1.0+(exp(((s0_[0]+30.0)/10.0))))+20.0000;
  ...
  a_[21] =  562.0*(exp((- (pow((s0_[0]+27.0), 2.0))/240.0)))+31.0/(1.0+(exp(((25.0 - s0_[0])/10.0))))+80.0/(1.0+(exp(((s0_[0]+30.0)/10.0))));
  ...
  a_[23] =  85.0*(exp((- (pow((s0_[0]+45.0), 2.0))/320.0)))+5.0/(1.0+(exp(((s0_[0] - 20.0)/5.0))))+3.0;
  ...
  a_[29] = 0.1/(1.0+(exp(((s0_[0]+35.0)/5.0))))+0.1/(1.0+(exp(((s0_[0] - 50.0)/200.0))));
  ...
  a_[30] = (s0_[0]<- 40.0 ?  2.7*(exp(( 0.079*s0_[0])))+ 310000.0*(exp(( 0.3485*s0_[0]))) : 0.77/( 0.13*(1.0+(exp(((s0_[0]+10.66)/- 11.1))))));
  ...
  a_[18] = (s0_[0]<- 40.0 ? (( ( - 25428.0*(exp(( 0.2444*s0_[0]))) -  6.948e-06*(exp(( - 0.04391*s0_[0]))))*(s0_[0]+37.78))/1.0)/(1.0+(exp(( 0.311000*(s0_[0]+79.2300))))) : 0.0);
  a_[31] = (s0_[0]<- 40.0 ? ( 0.02424*(exp(( - 0.01052*s0_[0]))))/(1.0+(exp(( - 0.1378*(s0_[0]+40.14))))) : ( 0.6*(exp(( 0.057*s0_[0]))))/(1.0+(exp(( - 0.100000*(s0_[0]+32.0))))));
  ...
  // -------------------------
  a_[55] = (( (( c_[21]*c_[10])/(c_[10]+c_[22]))*s0_[2])/(s0_[2]+c_[23]))/(1.0+ 0.1245*(exp((( - 0.1*s_[0]*c_[2])/( c_[0]*c_[1]))))+ 0.0353000*(exp((( - s_[0]*c_[2])/( c_[0]*c_[1])))));
  a_[25] =  (( c_[0]*c_[1])/c_[2])*(log((c_[11]/s0_[2])));
  a_[50] =  c_[16]*(pow(s_[7], 3.0))*s_[8]*s_[9]*(s_[0] - a_[25]);
  a_[51] =  c_[17]*(s_[0] - a_[25]);
  a_[56] = ( c_[24]*( (exp((( c_[27]*s_[0]*c_[2])/( c_[0]*c_[1]))))*(pow(s0_[2], 3.0))*c_[12] -  (exp((( (c_[27] - 1.0)*s_[0]*c_[2])/( c_[0]*c_[1]))))*(pow(c_[11], 3.0))*s_[3]*c_[26]))/( ((pow(c_[29], 3.0))+(pow(c_[11], 3.0)))*(c_[28]+c_[12])*(1.0+ c_[25]*(exp((( (c_[27] - 1.0)*s_[0]*c_[2])/( c_[0]*c_[1]))))));

  // s_[2] is Na_i in component sodium_dynamics (millimolar).
  r_[2] =  (( - 1.0*(a_[50]+a_[51]+ 3.0*a_[55]+ 3.0*a_[56]))/( 1.0*c_[4]*c_[2]))*c_[3];
  ...
  a_[45] = ( 3.0*(exp(( 0.0002*((s0_[0] - a_[33])+100.0))))+(exp(( 0.1*((s0_[0] - a_[33]) - 10.0)))))/(1.0+(exp(( - 0.5*(s0_[0] - a_[33])))));
  ...
  a_[41] =  (( c_[0]*c_[1])/c_[2])*(log(((c_[10]+ c_[9]*c_[11])/(s0_[1]+ c_[9]*s_[2]))));
  a_[49] =  c_[15]*(pow(s0_[6], 2.0))*(s0_[0] - a_[41]);
  a_[52] = ( (( c_[18]*s_[11]*s_[12]*s_[13]*s_[14]*4.0*(s_[0] - 15.0)*(pow(c_[2], 2.0)))/( c_[0]*c_[1]))*( 0.25*s_[10]*(exp((( 2.0*(s_[0] - 15.0)*c_[2])/( c_[0]*c_[1])))) - c_[12]))/((exp((( 2.0*(s_[0] - 15.0)*c_[2])/( c_[0]*c_[1])))) - 1.0);
  ...
  // ---------------------------------------------------------------------------------------------------------------------------
  r_[0] = (a_[47]+a_[54]+a_[48]+a_[49]+a_[52]+a_[55]+a_[50]+a_[51]+a_[56]+a_[53]+a_[58]+a_[57]+a_[12]);

  // s_[1] is K_i in component potassium_dynamics (millimolar).
  r_[1] =  (( - 1.0*((a_[47]+a_[54]+a_[48]+a_[49]+a_[58]+a_[12]) -  2.0*a_[55]))/( 1.0*c_[4]*c_[2]))*c_[3];
  ...
  r_[3] =  a_[63]*((( (a_[60] - a_[59])*c_[51])/c_[4]+a_[61]) - ( 1.0*((a_[53]+a_[57]) -  2.0*a_[56])*c_[3])/( 2.0*1.0*c_[4]*c_[2]));
  ...
  r_[10] =  a_[69]*((( - 1.0*a_[52]*c_[3])/( 2.0*1.0*c_[52]*c_[2])+( a_[67]*c_[51])/c_[52]) - ( a_[61]*c_[4])/c_[52]);
 ...
 *----------------------------------------------------------------------*/
int Myocard_TenTusscher::GetNumberOfInternalStateVariables() const
{
  return 19;
}
