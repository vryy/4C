...
the input line should read:
  MAT 1 MAT_Struct_AAAGasser DENS 0.0001 VOL OgSiMi NUE 0.49 BETA -2.0 CLUM 2.62e-3 CMED 2.13e-3 CABLUM 1.98e-3
...
/*----------------------------------------------------------------------*
 |  Constructor                                    (public)             |
 *----------------------------------------------------------------------*/
MAT::AAAgasser::AAAgasser(MAT::PAR::AAAgasser* params)
  : params_(params)
{
}
