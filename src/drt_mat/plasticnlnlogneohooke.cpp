...
/*----------------------------------------------------------------------*
 | constructor (public)                                                 |
 *----------------------------------------------------------------------*/
MAT::PlasticNlnLogNeoHooke::PlasticNlnLogNeoHooke()
  : params_(NULL)
{
}
 ...
 *----------------------------------------------------------------------*/
void MAT::PlasticNlnLogNeoHooke::Evaluate(
  ...
  )
{
  ...
  for (int i=0; i<3; i++)
    for (int j=0; j<3; j++)
      (spatial_principal_directions.at(i))(j) = n(j,i);
