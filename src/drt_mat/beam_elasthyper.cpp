...
\brief constitutive relations for beam cross-section resultants (hyperelastic stored energy function)
...
/*-----------------------------------------------------------------------------------------------*
 *-----------------------------------------------------------------------------------------------*/
MAT::PAR::Parameter* MAT::BeamElastHyperMaterial::Parameter() const
{
  return params_;
}
...
/*-----------------------------------------------------------------------------------------------*
 *-----------------------------------------------------------------------------------------------*/
const MAT::PAR::BeamElastHyperMaterialParameterGeneric&
MAT::BeamElastHyperMaterial::Params() const
{
...
{
  if (params_ == NULL)
    dserror("pointer to parameter class is not set!");
}
...
template void MAT::BeamElastHyperMaterial::GetConstitutiveMatrixOfForcesMaterialFrame<Sacado::Fad::DFad<double> >(
...
template void MAT::BeamElastHyperMaterial::GetConstitutiveMatrixOfMomentsMaterialFrame<double>(
    LINALG::TMatrix<double,3,3>& ) const;
template void MAT::BeamElastHyperMaterial::GetConstitutiveMatrixOfMomentsMaterialFrame<Sacado::Fad::DFad<double> >(
    LINALG::TMatrix<Sacado::Fad::DFad<double>,3,3>& ) const;

template void MAT::BeamElastHyperMaterial::GetMassMomentOfInertiaTensorMaterialFrame<double>(
    LINALG::TMatrix<double,3,3>& ) const;
template void MAT::BeamElastHyperMaterial::GetMassMomentOfInertiaTensorMaterialFrame<Sacado::Fad::DFad<double> >(
    LINALG::TMatrix<Sacado::Fad::DFad<double>,3,3>& ) const;
