 ...
 *----------------------------------------------------------------------*/
const double MAT::Electrode::ComputeDiffusionCoefficient(const double cint) const
{
  double diff(0.);
 ...
 *------------------------------------------------------------------------------------------*/
const double MAT::Electrode::ComputeFirstDerivDiffCoeff(const double cint) const
{
  double firstderiv(0.);
 ...
 *----------------------------------------------------------------------*/
const double MAT::Electrode::ComputeConductivity(const double cint) const
{
  double cond(0.);
 ...
 *---------------------------------------------------------------------------------*/
const double MAT::Electrode::ComputeFirstDerivCond(const double cint) const
{
  double firstderiv(0.);
