...
{
  MAT::FluidPoroMultiPhaseReactions* FluidPoroMultiPhaseReactions = new MAT::FluidPoroMultiPhaseReactions();
 ...
 *----------------------------------------------------------------------*/
MAT::FluidPoroMultiPhaseReactions::FluidPoroMultiPhaseReactions(MAT::PAR::FluidPoroMultiPhaseReactions* params)
  : FluidPoroMultiPhase(params),
    paramsreac_(params)
{
