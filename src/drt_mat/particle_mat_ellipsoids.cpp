/*!----------------------------------------------------------------------*/
/*!
\file particle_mat_ellipsoids.cpp
 ...
 *--------------------------------------------------------------------*/
MAT::PAR::ParticleMatEllipsoids::ParticleMatEllipsoids(
...
semiaxes_(true)
{
  ...
  // safety check
  if(semiaxes.size() != 3)
    dserror("Must have exactly three semi-axes!");
 ...
 *--------------------------------------------------------------------*/
MAT::ParticleMatEllipsoids::ParticleMatEllipsoids() :
  params_(NULL)
{
  return;
}
