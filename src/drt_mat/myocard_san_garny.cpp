...

{
  ...
  c_[108] = 0.03339;
  c_[109] = 140;
  c_[110] = (c_[0]==0.0 ? ( 1.07000*( 3.0*c_[1] - 0.100000))/( 3.0*(1.0+ 0.774500*(exp((- ( 3.0*c_[1] - 2.05000)/0.295000))))) : c_[0]==1.0 ? ( c_[2]*c_[1])/(1.0+ 0.774500*(exp((- ( 3.0*c_[1] - 2.05000)/0.295000)))) : ( 1.07000*29.0000*c_[1])/( 30.0000*(1.0+ 0.774500*(exp((- ( 29.0000*c_[1] - 24.5000)/1.95000))))));
  c_[111] =  (( c_[3]*c_[4])/c_[5])*(log((c_[14]/c_[91])));
  c_[112] =  (( c_[3]*c_[4])/c_[5])*(log((c_[102]/c_[109])));
  c_[113] = (c_[0]==0.0 ? 0.00200000 : c_[0]==1.0 ? 0.00200000 : 0.00600000);
...
double Myocard_SAN_Garny::ComputeReactionCoeff(const double phi, const double dt)
{
  s0_[0] = phi;
  s_[0] = phi;
  ...
  a_[6] = (c_[0]==1.0 ?  15.3000*(exp((- (s0_[0]+71.0+ 0.700000*c_[110])/83.3000))) :  15.3000*(exp((- (s0_[0]+71.7000)/83.3000))));
  a_[20] = (c_[0]==1.0 ?  15.0000*(exp(((s0_[0]+71.0)/15.3800))) :  15.0000*(exp(((s0_[0]+71.7000)/15.3800))));
  ...
  // -------------------------
  a_[0] = (c_[0]==0.0 ? ( 0.0952000*(exp(( - 0.0630000*(s_[0]+34.4000)))))/(1.0+ 1.66000*(exp(( - 0.225000*(s_[0]+63.7000)))))+0.0869000 : ( 0.0951800*(exp(( - 0.0630600*(s_[0]+34.4000)))))/(1.0+ 1.66200*(exp(( - 0.225100*(s_[0]+63.7000)))))+0.0869300);
  a_[13] =  (1.0 - a_[0])*s_[2]+ a_[0]*s_[3];
  a_[27] =  (( (( c_[117]*(pow(s_[1], 3.0))*a_[13]*c_[14]*(pow(c_[5], 2.0)))/( c_[3]*c_[4]))*((exp((( (s_[0] - c_[111])*c_[5])/( c_[3]*c_[4])))) - 1.0))/((exp((( s_[0]*c_[5])/( c_[3]*c_[4])))) - 1.0))*s_[0];
  a_[34] =  c_[118]*( s_[5]*s_[4]+0.00600000/(1.0+(exp((- (s_[0]+14.1000)/6.0)))))*(s_[0] - c_[21]);
  a_[39] =  c_[119]*s_[6]*s_[7]*(s_[0] - c_[28]);
  a_[40] =  c_[120]*s_[8]*s_[9]*(s_[0] - c_[112]);
  a_[41] =  c_[121]*s_[9]*(s_[0] - c_[112]);
  a_[42] =  0.600000*s_[10]+ 0.400000*s_[11];
  a_[43] =  c_[122]*a_[42]*s_[12]*(s_[0] - c_[112]);
  a_[44] =  c_[123]*(pow(s_[13], 2.0))*(s_[0] - c_[114]);
  a_[45] = (c_[0] != 2.0 ?  c_[124]*s_[14]*(s_[0] - c_[111]) :  c_[124]*s_[14]*(s_[0] - 77.6000));
  a_[46] = (c_[0] != 2.0 ?  c_[125]*s_[14]*(s_[0] - c_[112]) :  c_[125]*s_[14]*(s_[0]+102.000));
  a_[47] =  c_[126]*(s_[0] - c_[111]);
  a_[49] =  c_[128]*(s_[0] - c_[115]);
  a_[48] =  c_[127]*(s_[0] - c_[112]);
  a_[50] = (c_[0]==0.0 ? ( c_[129]*( (pow(c_[91], 3.0))*c_[93]*(exp(( 0.0374300*s_[0]*c_[90]))) -  (pow(c_[14], 3.0))*c_[92]*(exp(( 0.0374000*s_[0]*(c_[90] - 1.0))))))/(1.0+ c_[89]*( c_[92]*(pow(c_[14], 3.0))+ c_[93]*(pow(c_[91], 3.0)))) : ( c_[129]*( (pow(c_[91], 3.0))*c_[93]*(exp(( 0.0374300*s_[0]*c_[90]))) -  (pow(c_[14], 3.0))*c_[92]*(exp(( 0.0374300*s_[0]*(c_[90] - 1.0))))))/(1.0+ c_[89]*( c_[92]*(pow(c_[14], 3.0))+ c_[93]*(pow(c_[91], 3.0)))));
  a_[51] = ( c_[130]*(pow((c_[91]/(c_[94]+c_[91])), 3.0))*(pow((c_[102]/(c_[95]+c_[102])), 2.0))*1.60000)/(1.50000+(exp((- (s_[0]+60.0)/40.0))));
  ...
  //for (int i=27; i<51; i++)
  //  cout << "a_[" << i << "]\t" << a_[i] << endl;
  //cout << "c_[122]" << c_[122] << endl << "a_[42]" << a_[42] << endl << "s_[12]" << s_[12] << endl << "s_[0]" << s_[0] << endl << "c_[112]" << c_[112] << endl;
