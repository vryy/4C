...
POROMULTIPHASE::UTILS::PoroFluidMultiPhaseCloneStrategy::ConditionsToCopy()
{
  ...
  conditions_to_copy.insert(std::pair<std::string, std::string> (
      "PoroDirichlet", "Dirichlet"));
  conditions_to_copy.insert(std::pair<std::string, std::string> (
      "PoroPointNeumann", "PointNeumann"));
  conditions_to_copy.insert(std::pair<std::string, std::string> (
      "PoroLineNeumann", "LineNeumann"));
  conditions_to_copy.insert(std::pair<std::string, std::string> (
  ...
  conditions_to_copy.insert(std::pair<std::string,std::string>("ArtPorofluidCouplCon","ArtPorofluidCouplCon"));
