  ...
  Epetra_SerialDenseVector&  elevec_epetra )
{
  ...
  const std::string* consistency
    =
    (*wdbc_cond).Get<std::string>("Choice of gamma parameter");
  ...
  const std::string* deftauB
    =
    (*wdbc_cond).Get<std::string>("Definition of penalty parameter");
  ...
  const std::string* linearisation_approach
    =
    (*wdbc_cond).Get<std::string>("Linearisation");
  ...
  //--------------------------------------------------
  // get elements location vector and ownerships
  std::vector<int>  lm ;
  std::vector<int>  lmowner;
  std::vector<int>  lmstride;

  surfele->DRT::Element::LocationVector(discretization,lm,lmowner,lmstride);
  ...
  Epetra_SerialDenseVector&  elevec_epetra )
{
  ...
  lineele->DRT::Element::LocationVector(discretization,lm,lmowner,lmstride);
