 ...
 *----------------------------------------------------------------------*/
Beam3ContactOctTree::Beam3ContactOctTree(
  ...
  for (int i = 0; i < numshifts_bbox0 + 1; i++)
  {
    for (int j = 0; j < numshifts_bbox1 + 1; j++)
    {
      ...
      if (angle > ANGLETOL)
      {
        ...
        bool etaset = false;
        intersection = BEAMCONTACT::IntersectArbitraryCylinders(
      ...
      {
        intersection =
            BEAMCONTACT::IntersectParallelCylinders(r1_a, r1_b, r2_a, r2_b, distancelimit);
 ...
 *-----------------------------------------------------------------------*/
void Beam3ContactOctTree::CommunicateVector(
    Epetra_Vector& InVec, Epetra_Vector& OutVec, bool zerofy, bool doexport, bool doimport)
{
