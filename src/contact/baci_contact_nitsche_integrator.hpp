...
*/
/*---------------------------------------------------------------------*/
#ifndef BACI_CONTACT_NITSCHE_INTEGRATOR_HPP
#define BACI_CONTACT_NITSCHE_INTEGRATOR_HPP
   ...
   public:
    ...
    IntegratorNitsche(
        ...
        : Integrator(params, eletype, comm),
          ...
          frtype_(INPUT::IntegralValue<INPAR::CONTACT::FrictionType>(imortar_, "FRICTION")),
