...
*/
/*-----------------------------------------------------------------------*/
#ifndef BACI_CONTACT_SELFCONTACT_BINARYTREE_UNBIASED_HPP
#define BACI_CONTACT_SELFCONTACT_BINARYTREE_UNBIASED_HPP
...
#endif  // CONTACT_SELFCONTACT_BINARYTREE_UNBIASED_H
