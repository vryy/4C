...
DRT::ELEMENTS::Truss3CLType& DRT::ELEMENTS::Truss3CLType::Instance()
{
  return instance_;
}
...
Teuchos::RCP<DRT::Element> DRT::ELEMENTS::Truss3CLType::Create( const std::string eletype,
...
void DRT::ELEMENTS::Truss3CLType::NodalBlockInformation( DRT::Element * dwele, int & numdf, int & dimns, int & nv, int & np )
{
  numdf = 3;
  dimns = 6;
  nv = 3;
...
void DRT::ELEMENTS::Truss3CLType::ComputeNullSpace( DRT::Discretization & dis, std::vector<double> & ns, const double * x0, int numdf, int dimns )
{
  DRT::UTILS::ComputeStructure3DNullSpace( dis, ns, x0, numdf, dimns );
}

void DRT::ELEMENTS::Truss3CLType::SetupElementDefinition( std::map<std::string,std::map<std::string,DRT::INPUT::LineDefinition> > & definitions )
{
 ...
 *----------------------------------------------------------------------*/
DRT::ELEMENTS::Truss3CL::~Truss3CL()
{
  return;
}
 ...
 *----------------------------------------------------------------------*/
DRT::Element::DiscretizationType DRT::ELEMENTS::Truss3CL::Shape() const
{
  return line2;
}
...
/*----------------------------------------------------------------------*
 ...
 |                                               (public)mukherjee 01/14|
 *----------------------------------------------------------------------*/
DRT::UTILS::GaussRule1D DRT::ELEMENTS::Truss3CL::MyGaussRule(int nnode, IntegrationType integrationtype)
{
...
void DRT::ELEMENTS::Truss3CL::SetUpReferenceGeometry(const std::vector<double>& xrefe, const bool secondinit)
{
 ...
 *----------------------------------------------------------------------*/
// TODO: remove once truss3cl element is fixed and no longer expects more dofs (6) than it can inherently handle (3)...
void DRT::ELEMENTS::Truss3CL::LocationVector(const Discretization& dis, LocationArray& la, bool doDirichlet) const
{
