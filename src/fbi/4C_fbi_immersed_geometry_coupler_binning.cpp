...
{
  Teuchos::RCP<const Core::LinAlg::Vector> disp2 =
      Teuchos::rcp(new const Core::LinAlg::Vector(*(discretizations[1]->dof_col_map())));

  std::vector<Teuchos::RCP<const Core::LinAlg::Vector>> disp_vec = {structure_displacement, disp2};
