...
#ifndef BACI_FBI_BEAM_TO_FLUID_MESHTYING_OUTPUT_WRITER_HPP
#define BACI_FBI_BEAM_TO_FLUID_MESHTYING_OUTPUT_WRITER_HPP
...
namespace BEAMINTERACTION
{
  ...
  class BeamToFluidMeshtyingVtkOutputWriter
  {
   public:
     ...
     */
    void Setup(const IO::VisualizationParameters& visualization_params,
