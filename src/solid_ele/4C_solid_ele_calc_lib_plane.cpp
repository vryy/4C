...
namespace
{
      ...
      const Mat::EvaluationContext<2>& context, const int gp, const int eleGID)
  {
    ...
    // Compute the consistent 3D deformation gradient that satisfies the plane-stress
    // condition (F_zz determined by the local Newton above).
