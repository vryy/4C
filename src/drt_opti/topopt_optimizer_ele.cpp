...
{
  DRT::ELEMENTS::TopOpt* object =
    new DRT::ELEMENTS::TopOpt(-1,-1);
  object->Unpack(data);
  return object;
}


Teuchos::RCP<DRT::Element> DRT::ELEMENTS::TopOptType::Create( const std::string eletype,
...
void DRT::ELEMENTS::TopOptType::SetupElementDefinition( std::map<std::string,std::map<std::string,DRT::INPUT::LineDefinition> > & definitions )
{
 ...
 *----------------------------------------------------------------------*/
DRT::ELEMENTS::TopOpt::TopOpt(int id, int owner) :
...
/*----------------------------------------------------------------------*
 ...
 |                                                            gjb 05/08 |
 *----------------------------------------------------------------------*/
DRT::Element::DiscretizationType DRT::ELEMENTS::TopOpt::Shape() const
{
  return distype_;
}
 ...
 *----------------------------------------------------------------------*/
int DRT::ELEMENTS::TopOpt::NumLine() const
{
...
std::vector<Teuchos::RCP<DRT::Element> > DRT::ELEMENTS::TopOpt::Surfaces()
{
  ...
  if (NumSurface() > 1) // 3D
    return DRT::UTILS::ElementBoundaryFactory<TopOptBoundary,TopOpt>(DRT::UTILS::buildSurfaces,this);
 ...
 *----------------------------------------------------------------------*/
bool DRT::ELEMENTS::TopOpt::ReadElement(const std::string& eletype,
 ...
 *----------------------------------------------------------------------*/
DRT::ELEMENTS::TopOptBoundary::TopOptBoundary(int id, int owner,
 ...
 *----------------------------------------------------------------------*/
DRT::ELEMENTS::TopOptBoundary::~TopOptBoundary()
{
  return;
}
