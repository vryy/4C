/*----------------------------------------------------------------------*/
/*!
\file fsi_overlappprec_amgnxn.cpp
...
/*----------------------------------------------------------------------*/
/*----------------------------------------------------------------------*/
FSI::AMGnxnInterfaceFSI::AMGnxnInterfaceFSI(
...
void FSI::AMGnxnInterfaceFSI::Default_AMG_BGS(Teuchos::ParameterList& params)
{
  ...
  file_contents  += "      <Parameter name=\"smoothers\"   type=\"string\"  value=\"REUSE_MUELU_SMOOTHER,REUSE_MUELU_SMOOTHER,REUSE_MUELU_SMOOTHER\"/> ";
  ...
  file_contents  += "    </ParameterList>                                                                                                              ";
  file_contents  += "  </ParameterList>                                                                                                                ";
  file_contents  += "  <ParameterList name=\"PG-AMG-3D\">                                                                                              ";
  file_contents  += "    <ParameterList name=\"Factories\">                                                                                            ";
  file_contents  += "      <ParameterList name=\"myCoalesceDropFact\">                                                                                 ";
  file_contents  += "        <Parameter name=\"factory\"                         type=\"string\" value=\"CoalesceDropFactory\"/>                       ";
  file_contents  += "        <Parameter name=\"lightweight wrap\"                type=\"bool\"   value=\"false\"/>                                     ";
