  ...
  statistics_outfilename_(statistics_outfilename)
{
  ...
  if (numdim!=3)
    dserror("Evaluation of turbulence statistics only for 3d flow!");
  ...
  if(DRT::INPUT::IntegralValue<int>(*stabparams,"Reconstruct_Sec_Der"))
  {
    ...
    if(DRT::INPUT::IntegralValue<int>(*stabparams,"Reconstruct_Sec_Der"))
    {
                                                    ...
                                                    ++state                 )
      {
        ...
        {
          FLD::UTILS::ProjectGradientAndSetParam(discret_,eleparams_,state->second,"velafgrad",false);
          break;
        }
      }
    }
...
void FLD::TurbulenceStatisticsTgv::DumpStatistics(const int step)
{
  ...
  if (discret_->Comm().MyPID()==0)
  {
      ...
      for (unsigned rr=0;rr<nodeplanes_->size()-1;++rr)
      {
        ...
        (*log_res)  << std::setw(11) << std::setprecision(4) << (*sum_crossstress_)[6*rr+1]/numele_ << "  ";
        (*log_res)  << std::setw(11) << std::setprecision(4) << (*sum_crossstress_)[6*rr+2]/numele_ << "  ";
        (*log_res)  << std::setw(11) << std::setprecision(4) << (*sum_crossstress_)[6*rr+3]/numele_ << "  ";
        (*log_res)  << std::setw(11) << std::setprecision(4) << (*sum_crossstress_)[6*rr+4]/numele_ << "  ";
        (*log_res)  << std::setw(11) << std::setprecision(4) << (*sum_crossstress_)[6*rr+5]/numele_ << "  ";
