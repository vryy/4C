...
void XFEM::XFSCoupling_Manager::SetCouplingStates()
{
  ...
  Teuchos::RCP<Epetra_Vector> velnp = Teuchos::rcp(new Epetra_Vector(mcfsi_->IVelnp()->Map(),true));
...
*-----------------------------------------------------------------------------------------*/
void XFEM::XFSCoupling_Manager::AddCouplingMatrix(LINALG::BlockSparseMatrixBase& systemmatrix, double scaling)
{
  /*----------------------------------------------------------------------*/
...
*-----------------------------------------------------------------------------------------*/
void XFEM::XFSCoupling_Manager::AddCouplingRHS(Teuchos::RCP<Epetra_Vector> rhs,
    const LINALG::MultiMapExtractor& me, double scaling)
{
  Teuchos::RCP<Epetra_Vector> coup_rhs_sum = Teuchos::rcp(new Epetra_Vector(*xfluid_->RHS_s_Vec(cond_name_))); //REMARK: Copy this vector to store the correct lambda_ in update!
