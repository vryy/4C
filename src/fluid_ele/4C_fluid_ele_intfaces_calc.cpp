...
)
{
  ...
  FLUID::EosGpPattern eos_gp_pattern = fldpara_intface_->face_eos_gp_pattern();


  int numblocks = 0;

  if (eos_gp_pattern == FLUID::EOS_GP_Pattern_uvwp)
  {
  ...
  else if (eos_gp_pattern == FLUID::EOS_GP_Pattern_up)
  {
  ...
  else if (eos_gp_pattern == FLUID::EOS_GP_Pattern_full)
  {
