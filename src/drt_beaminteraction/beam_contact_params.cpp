...
{
  beam_to_beam_contact_params_ = Teuchos::rcp( new BEAMINTERACTION::
...
{
  beam_contact_runtime_vtk_output_params_ = Teuchos::rcp( new BEAMINTERACTION::
...
{
  beam_to_sphere_contact_params_ = Teuchos::rcp( new BEAMINTERACTION::
...
{
  beam_to_solid_volume_meshtying_params_ = Teuchos::rcp( new BEAMINTERACTION::
