...
BEAMINTERACTION::BeamPotentialParams::BeamPotentialParams()
    : isinit_(false),
      ...
      num_GPs_(-1),
      useFAD_(false),
      choice_master_slave_(INPAR::BEAMPOTENTIAL::choice_master_slave_vague),
      vtk_output_(false),
...
void BEAMINTERACTION::BeamPotentialParams::Init()
{
  ...
  /****************************************************************************/
  choice_master_slave_ = DRT::INPUT::IntegralValue<INPAR::BEAMPOTENTIAL::MasterSlaveChoice>(
      beam_potential_params_list, "CHOICE_MASTER_SLAVE");

  if (choice_master_slave_ == INPAR::BEAMPOTENTIAL::choice_master_slave_vague)
  {
