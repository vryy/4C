/*!----------------------------------------------------------------------
\file scatra_ele_hdg_intfaces_calc.cpp
...
/*----------------------------------------------------------------------*
 *----------------------------------------------------------------------*/
DRT::ELEMENTS::ScaTraHDGIntFaceImplInterface* DRT::ELEMENTS::ScaTraHDGIntFaceImplInterface::Impl(const DRT::Element* ele)
{
  switch (ele->Shape())
  {
...
DRT::ELEMENTS::ScaTraHDGIntFaceImpl<distype> * DRT::ELEMENTS::ScaTraHDGIntFaceImpl<distype>::Instance(bool create)
{
  static ScaTraHDGIntFaceImpl<distype> * instance;
  if (create)
  {
    if (instance==NULL)
      instance = new ScaTraHDGIntFaceImpl<distype>();
  }
  else
  {
    if (instance!=NULL)
