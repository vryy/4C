...
PoroElastScaTra::PoroScatraPart2WC::PoroScatraPart2WC(
    ...
    : PoroScatraPart(comm, timeparams),
      scaincnp_(Teuchos::RCP(new Core::LinAlg::Vector<double>(*(scatra_field()->phinp())))),
      structincnp_(Teuchos::RCP(
          new Core::LinAlg::Vector<double>(*(poro_field()->structure_field()()->dispnp())))),
      fluidincnp_(
          Teuchos::RCP(new Core::LinAlg::Vector<double>(*(poro_field()->fluid_field()()->velnp()))))
{
