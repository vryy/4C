...
#ifndef BACI_CONTACT_AUG_PARALLEL_DISTRIBUTION_CONTROLLER_HPP
#define BACI_CONTACT_AUG_PARALLEL_DISTRIBUTION_CONTROLLER_HPP
...
#endif  // CONTACT_AUG_PARALLEL_DISTRIBUTION_CONTROLLER_H
