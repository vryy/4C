...
#ifndef BACI_CONTACT_AUG_STEEPEST_ASCENT_INTERFACE_HPP
#define BACI_CONTACT_AUG_STEEPEST_ASCENT_INTERFACE_HPP
...
#endif  // CONTACT_AUG_STEEPEST_ASCENT_INTERFACE_H
