...
namespace
{
  void RegisterParObjectTypes()
  {
    ...
    s << DRT::NodeType::Instance().Name() << " " << DRT::NURBS::ControlPointType::Instance().Name()
      ...
      << MAT::Cnst1dArtType::Instance().Name() << " " << MAT::AAAgasserType::Instance().Name()
      << " " << MAT::AAAneohookeType::Instance().Name() << " "
      << MAT::AaAneohookeStoproType::Instance().Name() << " "
      << MAT::AaAraghavanvorpDamageType::Instance().Name() << " "
      << MAT::AaaMixedeffectsType::Instance().Name() << " "
