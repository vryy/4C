...

{
  ...
  switch (mctrl)
  {
     ...
     *======================================================================*/
  case 1:
    fsi_fluid_setup(work,actfield,disnum_calc,disnum_io);
    break;
     ...
     *======================================================================*/
  case 2:
    fsi_fluid_calc(work,actfield,disnum_calc,disnum_io);
     ...
     *======================================================================*/
  case 3:
    fsi_fluid_final(work,actfield,disnum_calc,disnum_io);
    break;
     ...
     *======================================================================*/
  case 6:
    fsi_fluid_sd(work,actfield,disnum_calc,disnum_io);
    break;
     ...
     *======================================================================*/
  case 98:
    fsi_fluid_output(work,actfield,disnum_calc,disnum_io);
    break;
     ...
     *======================================================================*/
  case 99:
    fsi_fluid_cleanup(work,actfield,disnum_calc,disnum_io);
    break;
