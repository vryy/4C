    ...
    Epetra_Vector& f)
{
  ...
  cardvasc0dman_->EvaluateForceStiff(time_np, disnp_ptr_, block_vec_ptr, dummat, pwindk);
    ...
    LINALG::SparseOperator& jac)
{
  ...
  cardvasc0dman_->EvaluateForceStiff(time_np, disnp_ptr_, dumvec, jac_dd, pwindk);
