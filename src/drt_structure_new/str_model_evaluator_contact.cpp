...
void STR::MODELEVALUATOR::Contact::Setup()
{
  ...
  // ---------------------------------------------------------------------
  strategy_ptr_ = factory.BuildStrategy( cparams, poroslave,
...
/*----------------------------------------------------------------------*
 *----------------------------------------------------------------------*/
bool STR::MODELEVALUATOR::Contact::AssembleForce(Epetra_Vector& f,
...
/*----------------------------------------------------------------------------*
 *----------------------------------------------------------------------------*/
void STR::MODELEVALUATOR::Contact::RunPostIterate(
...
STR::MODELEVALUATOR::Contact::GetAuxDisplJacobian() const
{
  std::vector<INPAR::STR::ModelType> g;
  g.push_back(INPAR::STR::ModelType::model_contact);

  Teuchos::RCP<LINALG::SparseOperator> jacaux =
      GState().CreateAuxJacobian();
