...
UQ::UQ_REDAIRWAYS::UQ_REDAIRWAYS(Teuchos::RCP<DRT::Discretization> dis)
: discret_(dis)
{
...
void UQ::UQ_REDAIRWAYS::Integrate()
{
  ...
  do
  {
    ...
    Teuchos::rcp(new AIRWAY::RedAirwayImplicitTimeInt(discret_,*solver,airwaystimeparams,*output));
