...
/*---------------------------------------------------- set element data */
f2_calset_tu_1(data,eleke,elev,kapomen,kapomeg,kapomepro,eddyg,eddypro,
               kappan,omega,evel,xyze);

/*-------------- calculate stab-parameter and parameter for DISC. CAPT. */
f2_calelesize_tu_1(eleke,elev,data,funct,deriv,deriv2,evel,eddyg,
                   velint,velint_dc,kapomen,xjm,xyze,derxy,kapomederxy,wa1);

/*-------------------------------- calculate element stiffness matrices */
/*                                            and element force vectors */
f2_calint_tu_1(data,eleke,elev,estif,emass,etforce,eiforce,eproforce,
...
fluid_caldirich_tu_1(eleke,edforce,estif,hasdirich);
