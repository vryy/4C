 ...
 *----------------------------------------------------------------------*/
TimeAdaptivity::TimeAdaptivity(ParameterList& params,
 ...
 *----------------------------------------------------------------------*/
// void TimeAdaptivity::ConstantPredictor()
// {
...
//   return;
// } // TimeAdaptivity::ConstantPredictor()

/*----------------------------------------------------------------------*
 |  do matrix free constant predictor step (public)             lw 10/07|
 *----------------------------------------------------------------------*/
// void TimeAdaptivity::MatrixFreeConstantPredictor()
// {
...
//   return;
// } // TimeAdaptivity::MatrixFreeConstantPredictor()


/*----------------------------------------------------------------------*
 |  do consistent predictor step (public)                    mwgee 07/07|
 *----------------------------------------------------------------------*/
// void TimeAdaptivity::ConsistentPredictor()
// {
//   // -------------------------------------------------------------------
//   // get some parameters from parameter list
//   // -------------------------------------------------------------------
...
//   return;
// } // TimeAdaptivity::ConsistentPredictor()

/*----------------------------------------------------------------------*
 |  do Newton iteration (public)                             mwgee 03/07|
 *----------------------------------------------------------------------*/
// void TimeAdaptivity::FullNewton()
// {
//   // -------------------------------------------------------------------
//   // get some parameters from parameter list
//   // -------------------------------------------------------------------
...
//   return;
// } // Timeadaptivity::FullNewton()


/*----------------------------------------------------------------------*
 |  do modified Newton iteration (public)                    mwgee 03/07|
 *----------------------------------------------------------------------*/
// void Timeadaptivity::ModifiedNewton()
// {
//   // -------------------------------------------------------------------
//   // get some parameters from parameter list
//   // -------------------------------------------------------------------
...
//   return;
// } // TimeAdaptivity::ModifiedNewton()

                                                                 \
/*----------------------------------------------------------------------*
 |  do matrix free Newton iteration (public)                    lw 10/07|
 *----------------------------------------------------------------------*/
// void TimeAdaptivity::MatrixFreeNewton()
// {
//   // -------------------------------------------------------------------
//   // get some parameters from parameter list
//   // -------------------------------------------------------------------
...
//   return;
// } // TimeAdaptivity::MatrixFreeNewton()
 ...
 *----------------------------------------------------------------------*/
// void TimeAdaptivity::NonlinearCG()
// {
//   // -------------------------------------------------------------------
//   // get some parameters from parameter list
//   // -------------------------------------------------------------------
...
//   return;
// } // TimeAdaptivity::NonlinearCG()


/*----------------------------------------------------------------------*
 |  do Newton iteration (public)                             mwgee 03/07|
 *----------------------------------------------------------------------*/
// void TimeAdaptivity::PTC()
// {
//   // -------------------------------------------------------------------
//   // get some parameters from parameter list
//   // -------------------------------------------------------------------
 ...
 *----------------------------------------------------------------------*/
// void TimeAdaptivity::computeF(const Epetra_Vector& x, Epetra_Vector& F)
// {
 ...
 *----------------------------------------------------------------------*/
// void TimeAdaptivity::computeJacobian(const Epetra_Vector& x)
// {
//     double time    = params_.get<double>("total time",0.0);
//     double dt      = params_.get<double>("delta time",0.01);
//     double beta    = params_.get<double>("beta"      ,0.292);
 ...
 *----------------------------------------------------------------------*/
// void TimeAdaptivity::UpdateandOutput()
// {
//   // -------------------------------------------------------------------
//   // get some parameters from parameter list
//   // -------------------------------------------------------------------
...
//   return;
// } // TimeAdaptivity::UpdateandOutput()
...
/*----------------------------------------------------------------------*
 |  set default parameter list (static/public)               mwgee 03/07|
 *----------------------------------------------------------------------*/
void TimeAdaptivity::SetDefaults(ParameterList& params)
{
 ...
 *----------------------------------------------------------------------*/
// void TimeAdaptivity::ReadRestart(int step)
// {
...
// const Epetra_Vector& TimeAdaptivity::Getdu()
// {
//   return *disi_;
// }
...
// const Epetra_Map* TimeAdaptivity::GetMap()
// {
