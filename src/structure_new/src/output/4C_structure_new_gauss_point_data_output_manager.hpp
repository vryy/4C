  ...
  namespace ModelEvaluator
  {
    class GaussPointDataOutputManager
    {
     public:
      ...
      inline std::unordered_map<std::string, std::shared_ptr<Core::LinAlg::Vector<int>>>&
      ...
      inline std::unordered_map<std::string,
          std::vector<std::shared_ptr<Core::LinAlg::MultiVector<double>>>>&
      ...
      inline const std::unordered_map<std::string, std::shared_ptr<Core::LinAlg::Vector<int>>>&
     ...
     private:
      ...
      std::unordered_map<std::string, std::shared_ptr<Core::LinAlg::MultiVector<double>>>
          data_nodes_;

      //! map holding the number of elements that share a quantity at each node
      std::unordered_map<std::string, std::shared_ptr<Core::LinAlg::Vector<int>>> data_nodes_count_;
