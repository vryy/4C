...
#ifndef BACI_STRUCTURE_NEW_TIMINT_NOXINTERFACE_HPP
#define BACI_STRUCTURE_NEW_TIMINT_NOXINTERFACE_HPP

#include "baci_config.hpp"

#include "baci_solver_nonlin_nox_enum_lists.hpp"
#include "baci_solver_nonlin_nox_interface_jacobian.hpp"  // (2) base class: jacobian
#include "baci_solver_nonlin_nox_interface_required.hpp"  // (1) base class: rhs, status tests and more
...
#endif  // STRUCTURE_NEW_TIMINT_NOXINTERFACE_H
