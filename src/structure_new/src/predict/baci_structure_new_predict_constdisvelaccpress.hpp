...
#ifndef BACI_STRUCTURE_NEW_PREDICT_CONSTDISVELACCPRESS_HPP
#define BACI_STRUCTURE_NEW_PREDICT_CONSTDISVELACCPRESS_HPP
...
#endif  // STRUCTURE_NEW_PREDICT_CONSTDISVELACCPRESS_H
