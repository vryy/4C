        ...
        linsolvers)
{
  ...
  // ---------------------------------------------------------------------------
  {
    ...
    dyntype_ = Core::UTILS::IntegralValue<Inpar::Solid::DynamicType>(sdynparams, "DYNAMICTYP");
  ...
  // ---------------------------------------------------------------------------
  {
    damptype_ = Core::UTILS::IntegralValue<Inpar::Solid::DampKind>(sdynparams, "DAMPING");
  ...
  // ---------------------------------------------------------------------------
  {
    masslintype_ = Core::UTILS::IntegralValue<Inpar::Solid::MassLin>(sdynparams, "MASSLIN");
  ...
  // ---------------------------------------------------------------------------
  {
    ...
    nlnsolvertype_ = Core::UTILS::IntegralValue<Inpar::Solid::NonlinSolTech>(sdynparams, "NLNSOL");
    divergenceaction_ =
        Core::UTILS::IntegralValue<Inpar::Solid::DivContAct>(sdynparams, "DIVERCONT");
    mid_time_energy_type_ =
        Core::UTILS::IntegralValue<Inpar::Solid::MidAverageEnum>(sdynparams, "MIDTIME_ENERGY_TYPE");
  ...
  // ---------------------------------------------------------------------------
  {
    normtype_ = Core::UTILS::IntegralValue<Inpar::Solid::VectorNorm>(sdynparams, "ITERNORM");
    nox_normtype_ = Solid::Nln::Convert2NoxNormType(normtype_);
    ...
    toltype_disp_incr_ =
        Core::UTILS::IntegralValue<Inpar::Solid::ConvNorm>(sdynparams, "NORM_DISP");

    tol_fres_ = sdynparams.get<double>("TOLRES");
    toltype_fres_ = Core::UTILS::IntegralValue<Inpar::Solid::ConvNorm>(sdynparams, "NORM_RESF");
  ...
  {
    initial_disp_ =
        Core::UTILS::IntegralValue<Inpar::Solid::InitialDisp>(sdynparams, "INITIALDISP");
