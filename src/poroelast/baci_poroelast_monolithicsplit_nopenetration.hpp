...
#ifndef BACI_POROELAST_MONOLITHICSPLIT_NOPENETRATION_HPP
#define BACI_POROELAST_MONOLITHICSPLIT_NOPENETRATION_HPP
...
#endif  // POROELAST_MONOLITHICSPLIT_NOPENETRATION_H
