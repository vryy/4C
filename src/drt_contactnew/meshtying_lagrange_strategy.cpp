...
void CONTACT::MtLagrangeStrategy::MeshInitialization()
{
  ...
  //**********************************************************************
  // (1) compute modified positions on global level
  //**********************************************************************
  // fill Xmaster first
  ...
  //**********************************************************************
  // (3) re-evaluate constraints in reference configuration
  //**********************************************************************
  // intialize
...
{   
  ...
  // For the dual Lagrange strategy there is no difference between
  // versions 1 and 2, as the constraints are exactly fulfilled in
  // the reference configuration X due to mesh initialization!
