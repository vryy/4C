...
void f2_inbu(FLUID_DATA      *data,     
	     ...
	     DOUBLE	    **ssxjm);
/*!---------------------------------------------------------------------
\brief error calculation integration loop for submesh element for fluid2
...
------------------------------------------------------------------------*/
void f2_sminterr(FLUID_DATA      *data,     
	         ELEMENT	 *ele,	
	         FLUID_DYN_CALC  *dynvar, 
	         FLUID_DYN_ML    *mlvar, 
	         FLUID_ML_SMESH  *submesh, 
...
------------------------------------------------------------------------*/
void f2_bubinterr(FLUID_DATA      *data,     
                  FLUID_DYNAMIC   *fdyn, 
	          ELEMENT         *ele,     
	          FLUID_DYN_ML    *mlvar, 
	          FLUID_ML_SMESH  *submesh, 
...
\param    iel	     INT            (i)   number of bubble functions 
\return void                                                                       
