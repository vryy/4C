 ...
 *--------------------------------------------------------------------------------*/
void XFEM::UTILS::ComputeSurfaceTransformation(
 ...
 *--------------------------------------------------------------------------------*/
double XFEM::UTILS::ComputeMeasFace(
...
)
{
  ...
  if(nsd != 3) dserror("don't call this function for non-3D examples, adapt the following for 2D!");
...
double XFEM::UTILS::EvalElementVolume(
    ...
    LINALG::Matrix<DRT::UTILS::DisTypeToNumNodePerEle<distype>::numNodePerElement,1>* nurbs_weights,
    std::vector<Epetra_SerialDenseVector>* nurbs_knots)
{
  ...
  DRT::UTILS::IntPointsAndWeights<nsd> intpoints_stab(DRT::ELEMENTS::DisTypeToStabGaussRule<distype>::rule);
  ...
  switch (distype)
  {
    ...
    case DRT::Element::nurbs27:
    {
     ...
     DRT::NURBS::UTILS::nurbs_get_funct_deriv(funct, deriv, xsi, *nurbs_knots,*nurbs_weights, distype );
     break;
     }
    default:
   ...
   */
   ...
   if (det < 1E-16)
     dserror("GLOBAL ELEMENT ZERO OR NEGATIVE JACOBIAN DETERMINANT: %f", det);
 ...
 *--------------------------------------------------------------------------------*/
template <DRT::Element::DiscretizationType distype>
double XFEM::UTILS::ComputeCharEleLength(
    DRT::Element *                                                        ele,                   ///< fluid element
    Epetra_SerialDenseMatrix &                                            ele_xyze,              ///< element coordinates
...
)
{
  ...
  LINALG::Matrix<3,DRT::UTILS::DisTypeToNumNodePerEle<distype>::numNodePerElement> xyze (ele_xyze,true);
  ...
  case INPAR::XFEM::ViscStab_hk_vol_equivalent:
  {
    ...
    {
      //meas_vol =  XFEM::UTILS::EvalElementVolume<distype>(my::xyze_,&(my::weights_),&(my::myknots_));
...
void XFEM::UTILS::NIT_Compute_FullPenalty_Stabfac(
    ...
    INPAR::XFEM::MassConservationScaling  MassConservationScaling,    ///< kind of mass conservation scaling
    INPAR::XFEM::MassConservationCombination MassConservationCombination, ///< kind of mass conservation combination
    const double                       NITStabScaling,                ///< scaling of nit stab fac
    INPAR::XFEM::ConvStabScaling       ConvStabScaling,               ///< which convective stab. scaling of inflow stab
    INPAR::XFEM::XFF_ConvStabScaling   XFF_ConvStabScaling,           ///< which convective stab. scaling on XFF interface
    ...
    )
{
  ...
  if (MassConservationScaling == INPAR::XFEM::MassConservationScaling_full)
  {
    ...
    {
      NIT_full_stab_fac = std::max(NIT_full_stab_fac,NITStabScaling * (kappa_m*densaf_master*fabs(velnorminf_m)+kappa_s*densaf_slave*fabs(velnorminf_s)) / 6.0);
      if (! isstationary)
        NIT_full_stab_fac= std::max( NITStabScaling * h_k * ( kappa_m*densaf_master + kappa_s*densaf_slave ) / (12.0 * timefac),NIT_full_stab_fac);
    }
    else // the sum
    {
      // (2)
      NIT_full_stab_fac += NITStabScaling * (kappa_m*densaf_master*fabs(velnorminf_m)+kappa_s*densaf_slave*fabs(velnorminf_s)) / 6.0; //THIS ONE NEEDS CHANGING!

      // (3)
      if (! isstationary)
        NIT_full_stab_fac += NITStabScaling * h_k * ( kappa_m*densaf_master + kappa_s*densaf_slave ) / (12.0 * timefac);
    }
  }
  ...
  if (IsConservative and (XFF_ConvStabScaling != INPAR::XFEM::XFF_ConvStabScaling_none
                                       or ConvStabScaling   != INPAR::XFEM::ConvStabScaling_none ) )
  {
...
template double XFEM::UTILS::EvalElementVolume<DRT::Element::hex8>(    LINALG::Matrix<3,DRT::UTILS::DisTypeToNumNodePerEle<DRT::Element::hex8>::numNodePerElement>, LINALG::Matrix<DRT::UTILS::DisTypeToNumNodePerEle<DRT::Element::hex8>::numNodePerElement,1>* , std::vector<Epetra_SerialDenseVector>* );
template double XFEM::UTILS::EvalElementVolume<DRT::Element::hex20>(   LINALG::Matrix<3,DRT::UTILS::DisTypeToNumNodePerEle<DRT::Element::hex20>::numNodePerElement>, LINALG::Matrix<DRT::UTILS::DisTypeToNumNodePerEle<DRT::Element::hex20>::numNodePerElement,1>* , std::vector<Epetra_SerialDenseVector>* );
template double XFEM::UTILS::EvalElementVolume<DRT::Element::hex27>(   LINALG::Matrix<3,DRT::UTILS::DisTypeToNumNodePerEle<DRT::Element::hex27>::numNodePerElement> , LINALG::Matrix<DRT::UTILS::DisTypeToNumNodePerEle<DRT::Element::hex27>::numNodePerElement,1>* , std::vector<Epetra_SerialDenseVector>* );
template double XFEM::UTILS::EvalElementVolume<DRT::Element::tet4>(    LINALG::Matrix<3,DRT::UTILS::DisTypeToNumNodePerEle<DRT::Element::tet4>::numNodePerElement> , LINALG::Matrix<DRT::UTILS::DisTypeToNumNodePerEle<DRT::Element::tet4>::numNodePerElement,1>* , std::vector<Epetra_SerialDenseVector>* );
template double XFEM::UTILS::EvalElementVolume<DRT::Element::tet10>(   LINALG::Matrix<3,DRT::UTILS::DisTypeToNumNodePerEle<DRT::Element::tet10>::numNodePerElement>, LINALG::Matrix<DRT::UTILS::DisTypeToNumNodePerEle<DRT::Element::tet10>::numNodePerElement,1>* , std::vector<Epetra_SerialDenseVector>* );
template double XFEM::UTILS::EvalElementVolume<DRT::Element::wedge6>(  LINALG::Matrix<3,DRT::UTILS::DisTypeToNumNodePerEle<DRT::Element::wedge6>::numNodePerElement>, LINALG::Matrix<DRT::UTILS::DisTypeToNumNodePerEle<DRT::Element::wedge6>::numNodePerElement,1>* , std::vector<Epetra_SerialDenseVector>* );
template double XFEM::UTILS::EvalElementVolume<DRT::Element::wedge15>( LINALG::Matrix<3,DRT::UTILS::DisTypeToNumNodePerEle<DRT::Element::wedge15>::numNodePerElement>, LINALG::Matrix<DRT::UTILS::DisTypeToNumNodePerEle<DRT::Element::wedge15>::numNodePerElement,1>* , std::vector<Epetra_SerialDenseVector>* );

template double XFEM::UTILS::ComputeCharEleLength<DRT::Element::hex8>(DRT::Element *, Epetra_SerialDenseMatrix &, const Teuchos::RCP<XFEM::ConditionManager> &,const GEO::CUT::plain_volumecell_set &,const std::map<int, std::vector<GEO::CUT::BoundaryCell*> > &,const std::map<int, std::vector<DRT::UTILS::GaussIntegration> > &,    const INPAR::XFEM::ViscStab_hk,    Teuchos::RCP<DRT::ELEMENTS::XFLUID::SlaveElementInterface<DRT::Element::hex8> >,    DRT::Element *);
template double XFEM::UTILS::ComputeCharEleLength<DRT::Element::hex20>(DRT::Element *, Epetra_SerialDenseMatrix &, const Teuchos::RCP<XFEM::ConditionManager> &,const GEO::CUT::plain_volumecell_set &,const std::map<int, std::vector<GEO::CUT::BoundaryCell*> > &,const std::map<int, std::vector<DRT::UTILS::GaussIntegration> > &,    const INPAR::XFEM::ViscStab_hk,    Teuchos::RCP<DRT::ELEMENTS::XFLUID::SlaveElementInterface<DRT::Element::hex20> >,    DRT::Element *);
template double XFEM::UTILS::ComputeCharEleLength<DRT::Element::hex27>(DRT::Element *, Epetra_SerialDenseMatrix &, const Teuchos::RCP<XFEM::ConditionManager> &,const GEO::CUT::plain_volumecell_set &,const std::map<int, std::vector<GEO::CUT::BoundaryCell*> > &,const std::map<int, std::vector<DRT::UTILS::GaussIntegration> > &,    const INPAR::XFEM::ViscStab_hk,    Teuchos::RCP<DRT::ELEMENTS::XFLUID::SlaveElementInterface<DRT::Element::hex27> >,    DRT::Element *);
template double XFEM::UTILS::ComputeCharEleLength<DRT::Element::tet4>(DRT::Element *, Epetra_SerialDenseMatrix &, const Teuchos::RCP<XFEM::ConditionManager> &,const GEO::CUT::plain_volumecell_set &,const std::map<int, std::vector<GEO::CUT::BoundaryCell*> > &,const std::map<int, std::vector<DRT::UTILS::GaussIntegration> > &,    const INPAR::XFEM::ViscStab_hk,    Teuchos::RCP<DRT::ELEMENTS::XFLUID::SlaveElementInterface<DRT::Element::tet4> >,    DRT::Element *);
template double XFEM::UTILS::ComputeCharEleLength<DRT::Element::tet10>(DRT::Element *, Epetra_SerialDenseMatrix &, const Teuchos::RCP<XFEM::ConditionManager> &,const GEO::CUT::plain_volumecell_set &,const std::map<int, std::vector<GEO::CUT::BoundaryCell*> > &,const std::map<int, std::vector<DRT::UTILS::GaussIntegration> > &,    const INPAR::XFEM::ViscStab_hk,    Teuchos::RCP<DRT::ELEMENTS::XFLUID::SlaveElementInterface<DRT::Element::tet10> >,    DRT::Element *);
template double XFEM::UTILS::ComputeCharEleLength<DRT::Element::wedge6>(DRT::Element *, Epetra_SerialDenseMatrix &, const Teuchos::RCP<XFEM::ConditionManager> &,const GEO::CUT::plain_volumecell_set &,const std::map<int, std::vector<GEO::CUT::BoundaryCell*> > &,const std::map<int, std::vector<DRT::UTILS::GaussIntegration> > &,    const INPAR::XFEM::ViscStab_hk,    Teuchos::RCP<DRT::ELEMENTS::XFLUID::SlaveElementInterface<DRT::Element::wedge6> >,    DRT::Element *);
template double XFEM::UTILS::ComputeCharEleLength<DRT::Element::wedge15>(DRT::Element *, Epetra_SerialDenseMatrix &, const Teuchos::RCP<XFEM::ConditionManager> &,const GEO::CUT::plain_volumecell_set &,const std::map<int, std::vector<GEO::CUT::BoundaryCell*> > &,const std::map<int, std::vector<DRT::UTILS::GaussIntegration> > &,    const INPAR::XFEM::ViscStab_hk,    Teuchos::RCP<DRT::ELEMENTS::XFLUID::SlaveElementInterface<DRT::Element::wedge15> >,    DRT::Element *);
