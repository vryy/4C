...
namespace Thermo
{
  ...
  class TimIntGenAlpha : public TimIntImpl
  {
   ...
   protected:
    ...
    //@{
    Teuchos::RCP<Core::LinAlg::Vector> tempm_;  //!< mid-temperatures
                                                //!< \f$T_m = T_{n+\alpha_f}\f$
    Teuchos::RCP<Core::LinAlg::Vector> ratem_;  //!< mid-temperature rates
    ...
    Teuchos::RCP<Core::LinAlg::Vector> fintm_;  //!< internal mid-force at \f$t_{n+\alpha_f}\f$
    ...
    Teuchos::RCP<Core::LinAlg::Vector> fextm_;  //!< external mid-force \f$t_{n+\alpha_f}\f$
    Teuchos::RCP<Core::LinAlg::Vector> fextn_;  //!< external force at \f$t_{n+1}\f$

    Teuchos::RCP<Core::LinAlg::Vector> fcap_;  //!< capacity force \f$C\cdot\Theta_n\f$ at \f$t_n\f$
