...
THR::TimIntImpl::TimIntImpl(const Teuchos::ParameterList& ioparams,
    ...
    : TimInt(ioparams, tdynparams, xparams, actdis, solver, output),
      pred_(INPUT::IntegralValue<INPAR::THR::PredEnum>(tdynparams, "PREDICT")),
      itertype_(INPUT::IntegralValue<INPAR::THR::NonlinSolTech>(tdynparams, "NLNSOL")),
      normtypetempi_(INPUT::IntegralValue<INPAR::THR::ConvNorm>(tdynparams, "NORM_TEMP")),
      normtypefres_(INPUT::IntegralValue<INPAR::THR::ConvNorm>(tdynparams, "NORM_RESF")),
      combtempifres_(INPUT::IntegralValue<INPAR::THR::BinaryOp>(tdynparams, "NORMCOMBI_RESFTEMP")),
      iternorm_(INPUT::IntegralValue<INPAR::THR::VectorNorm>(tdynparams, "ITERNORM")),
      itermax_(tdynparams.get<int>("MAXITER")),
      itermin_(tdynparams.get<int>("MINITER")),
      divcontype_(INPUT::IntegralValue<INPAR::THR::DivContAct>(tdynparams, "DIVERCONT")),
