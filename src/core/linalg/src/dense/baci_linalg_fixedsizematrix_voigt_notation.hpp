...
#ifndef BACI_LINALG_FIXEDSIZEMATRIX_VOIGT_NOTATION_HPP
#define BACI_LINALG_FIXEDSIZEMATRIX_VOIGT_NOTATION_HPP
...
#endif  // BACI_LINALG_FIXEDSIZE_VOIGT_NOTATION_H