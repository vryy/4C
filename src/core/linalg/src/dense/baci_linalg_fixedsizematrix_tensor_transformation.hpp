...
#ifndef BACI_LINALG_FIXEDSIZEMATRIX_TENSOR_TRANSFORMATION_HPP
#define BACI_LINALG_FIXEDSIZEMATRIX_TENSOR_TRANSFORMATION_HPP
...
#endif  // BACI_LINALG_FIXEDSIZEMATRIX_TENSOR_TRANSFORMATION_H