...
#ifndef BACI_DISCRETIZATION_GEOMETRY_INTEGRATIONCELL_HPP
#define BACI_DISCRETIZATION_GEOMETRY_INTEGRATIONCELL_HPP
...
#endif  // DISCRETIZATION_GEOMETRY_INTEGRATIONCELL_H
