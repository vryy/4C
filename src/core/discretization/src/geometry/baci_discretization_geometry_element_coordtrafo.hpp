...
#ifndef BACI_DISCRETIZATION_GEOMETRY_ELEMENT_COORDTRAFO_HPP
#define BACI_DISCRETIZATION_GEOMETRY_ELEMENT_COORDTRAFO_HPP
...
#endif  // DISCRETIZATION_GEOMETRY_ELEMENT_COORDTRAFO_H
