...
#include "baci_discretization_geometric_search_kdop_intersections.h"
...
namespace CORE::GEOMETRICSEARCH
{
  ...
  GetKDopPolyhedronRepresentation(const BoundingVolume boundingVolume)
  {
    ...
    // The possible intersections of the k-dop
    KdopIntersection possible_intersections;
    ...
    for (unsigned int i_direction = 0; i_direction < kdop_directions; i_direction++)
    {
      ...
      {
        const auto& my_possible_partners = possible_intersections.pairs_[i_direction][i_min_max];
