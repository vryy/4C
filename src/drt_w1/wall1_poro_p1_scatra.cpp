...
/*!
 ...
 \brief a 2D wall element for solid-part of porous medium using p1 (mixed) approach including scatra functionality
...
DRT::ELEMENTS::Wall1_PoroP1<distype>(id,owner),
 ...
 *----------------------------------------------------------------------*/
template<DRT::Element::DiscretizationType distype>
DRT::ELEMENTS::Wall1_PoroP1Scatra<distype>::Wall1_PoroP1Scatra(const DRT::ELEMENTS::Wall1_PoroP1Scatra<distype>& old) :
DRT::ELEMENTS::Wall1_PoroP1<distype>(old),
...
{
  DRT::ELEMENTS::Wall1_PoroP1Scatra<distype>* newelement = new DRT::ELEMENTS::Wall1_PoroP1Scatra<distype>(*this);
  return newelement;
}
 ...
 *----------------------------------------------------------------------*/
template<DRT::Element::DiscretizationType distype>
bool DRT::ELEMENTS::Wall1_PoroP1Scatra<distype>::ReadElement(const std::string& eletype, const std::string& eledistype, DRT::INPUT::LineDefinition* linedef)
{
  // read base element
