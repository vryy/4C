 ...
 *----------------------------------------------------------------------*/
template<DRT::Element::DiscretizationType distype>
DRT::ELEMENTS::Wall1_Poro_Scatra<distype>::Wall1_Poro_Scatra(const DRT::ELEMENTS::Wall1_Poro_Scatra<distype>& old) :
...
{
  DRT::ELEMENTS::Wall1_Poro_Scatra<distype>* newelement = new DRT::ELEMENTS::Wall1_Poro_Scatra<distype>(*this);
  return newelement;
}
 ...
 *----------------------------------------------------------------------*/
template<DRT::Element::DiscretizationType distype>
bool DRT::ELEMENTS::Wall1_Poro_Scatra<distype>::ReadElement(const std::string& eletype,
