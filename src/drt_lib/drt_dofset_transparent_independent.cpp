...
DRT::TransparentIndependentDofSet::TransparentIndependentDofSet(RCP<DRT::Discretization> sourcedis,bool parallel) :
DRT::IndependentDofSet(),
parallel_(parallel)
{
...
DRT::TransparentIndependentDofSet::TransparentIndependentDofSet(vector<RCP<DRT::Discretization> > sourcedis,bool parallel) :
DRT::IndependentDofSet(),
...
void DRT::TransparentIndependentDofSet::TransferDegreesOfFreedom(
...
/// Assign dof numbers for new discretization using dof numbering from source discretization.
void DRT::TransparentIndependentDofSet::ParallelTransferDegreesOfFreedom(
  const vector<RCP<DRT::Discretization> > sourcedis,
  const DRT::Discretization& newdis,
  const int start
  )
...
//<><><><><><><><><><><><><><><><><><><><><><><><><><><><><><><><><><><>//
//<><><><><><><><><><><><><><><><><><><><><><><><><><><><><><><><><><><>//
void DRT::TransparentIndependentDofSet::SetSourceDofsAvailableOnThisProc(
  map<int,vector<int> >   & gid_to_dofs
  )
{
...
//<><><><><><><><><><><><><><><><><><><><><><><><><><><><><><><><><><><>//
//<><><><><><><><><><><><><><><><><><><><><><><><><><><><><><><><><><><>//
void DRT::TransparentIndependentDofSet::PackLocalSourceDofs(
  map<int,vector<int> >   & gid_to_dofs  ,
...
//<><><><><><><><><><><><><><><><><><><><><><><><><><><><><><><><><><><>//
//<><><><><><><><><><><><><><><><><><><><><><><><><><><><><><><><><><><>//
void DRT::TransparentIndependentDofSet::UnpackLocalSourceDofs(
  map<int,vector<int> >   & gid_to_dofs  ,
  vector<char>            & rblock
  )
{
...
//<><><><><><><><><><><><><><><><><><><><><><><><><><><><><><><><><><><>//
//<><><><><><><><><><><><><><><><><><><><><><><><><><><><><><><><><><><>//
void DRT::TransparentIndependentDofSet::ReceiveBlock(
  int             numproc ,
  int             myrank  ,
  vector<char>   & rblock,
...
//<><><><><><><><><><><><><><><><><><><><><><><><><><><><><><><><><><><>//
//<><><><><><><><><><><><><><><><><><><><><><><><><><><><><><><><><><><>//
void DRT::TransparentIndependentDofSet::SendBlock(
  int             numproc ,
  int             myrank  ,
  vector<char>  & sblock  ,
  DRT::Exporter & exporter,
