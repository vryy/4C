...
/*----------------------------------------------------------------------*/
/*----------------------------------------------------------------------*/
double DRT::UTILS::JefferyHamelFlowFunction::GefferyHamelFlow(
    const double& alpha
    )
{
#ifdef DEBUG
  if (alpha < 0.01 or alpha > (PI/4+0.01))
  {
  ...
  + 51.72093368870616*    pow(-PI/8. + alpha, 2)
  + 1453.2480022627062*   pow(-PI/8. + alpha, 4) 
  + 15469.249826734282*   pow(-PI/8. + alpha, 6)
  + 153515.23050166125*   pow(-PI/8. + alpha, 8) 
  - 3.1393239563288596e6* pow(-PI/8. + alpha,10) 
  + 1.3791074955303007e8* pow(-PI/8. + alpha,12) 
  - 3.9054873809559045e9* pow(-PI/8. + alpha,14) 
  + 8.064960114312076e10* pow(-PI/8. + alpha,16) 
  - 1.2314175442399622e12*pow(-PI/8. + alpha,18) 
  + 1.3952367263056582e13*pow(-PI/8. + alpha,20) 
  - 1.1694967181678298e14*pow(-PI/8. + alpha,22) 
  + 7.149819830278836e14* pow(-PI/8. + alpha,24) 
  - 3.0970644442180215e15*pow(-PI/8. + alpha,26) 
  + 9.001387683687223e15* pow(-PI/8. + alpha,28) 
  - 1.5737446665792184e16*pow(-PI/8. + alpha,30) 
  + 1.250536015803445e16* pow(-PI/8. + alpha,32);
}
...
double DRT::UTILS::JefferyHamelFlowFunction::Evaluate(int index, const double* xp, double, DRT::Discretization*)
{
  ...
  const double u_alpha = GefferyHamelFlow(alpha);
