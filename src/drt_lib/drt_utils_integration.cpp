...
DRT::UTILS::IntegrationPoints2D::IntegrationPoints2D(const GaussRule2D gaussrule)
{
  ...
  case intrule_tri_12point:
  {
    ...
    qwgt[ 1] = 0.050844906370207;
    qwgt[ 2] = 0.050844906370207;
    
    qwgt[ 3] = 0.116786275726379;
    qwgt[ 4] = 0.116786275726379;
    qwgt[ 5] = 0.116786275726379;
    
    qwgt[ 6] = 0.082851075618374;
    qwgt[ 7] = 0.082851075618374;
    qwgt[ 8] = 0.082851075618374;
    qwgt[ 9] = 0.082851075618374;
    qwgt[10] = 0.082851075618374;
    qwgt[11] = 0.082851075618374;
