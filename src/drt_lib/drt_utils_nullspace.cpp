    ...
    DRT::Discretization& dis, std::vector<double>& ns, const double* x0, int numdf, int dimns)
{
  ...
  //   else if (ele->Type() == DRT::Element::element_beam3 || ele->Type() ==
  //   DRT::Element::element_beam3r)
  {
    ...
    DRT::Discretization& dis, std::vector<double>& ns, const double* x0, int numdf, int dimns)
{
  ...
  */
  ...
  }        // else if (ele->Type() == DRT::Element::element_fluid3 or ele->Type() ==
           // DRT::Element::element_xfluid3)
}
