...
void DRT::Condition::Print(std::ostream& os) const
{
  ...
  else if (Type()==LineSlipSupp)                  os << "line slip supplemental curved boundary condition: ";
  else if (Type()==SurfaceSlipSupp)               os << "surface slip supplemental curved boundary condition: ";
  ...
  else if (Type()==FilamentBeamLineCondition)     os << "line condition for polymer networks: ";
  ...
  else if (Type()==TransportThermoConvections)    os << "Transport ThermoConvections boundary condition: ";
  ...
  else if (Type()==IMMERSEDCoupling)              os << "Interface of immersed objects";
  ...
  else if (Type()==ScatraHeteroReactionCondMaster) os << "Scalar transport reaction coupling condition (Master)";
  ...
  else if (Type()==SSICouplingSolidToScatra)      os << "Scalar-Structure coupling condition from Solid to Scatra";
  else if (Type()==SSICouplingScatraToSolid)      os << "Scalar-Structure coupling condition from Scatra to Solid";
  ...
  else if (Type()==ElementTag)                    os << "Tagged elements";
  else if (Type()==NodeTag)                       os << "Tagged nodes";
