...
/*----------------------------------------------------------------------*
 |                                                                      |
 *----------------------------------------------------------------------*/
MAT::ELASTIC::PAR::VarIsoNeoHooke::VarIsoNeoHooke(
 ...
 *----------------------------------------------------------------------*/
MAT::ELASTIC::VarIsoNeoHooke::VarIsoNeoHooke()
  : Summand(),
    params_(NULL)
{
}
...
/*----------------------------------------------------------------------*
 |  Constructor                             (public)   bborn 04/09 |
 *----------------------------------------------------------------------*/
MAT::ELASTIC::VarIsoNeoHooke::VarIsoNeoHooke(MAT::ELASTIC::PAR::VarIsoNeoHooke* params)
  : params_(params)
{
}
...
/*----------------------------------------------------------------------*/
/*----------------------------------------------------------------------*/
void MAT::ELASTIC::VarIsoNeoHooke::AddShearMod(
  bool& haveshearmod,
  double& shearmod
  ) const
{
...
/*----------------------------------------------------------------------*/
/*----------------------------------------------------------------------*/
void MAT::ELASTIC::VarIsoNeoHooke::AddCoefficientsModified(
...
/*----------------------------------------------------------------------*/
/*----------------------------------------------------------------------*/
// void MAT::ELASTIC::VarIsoNeoHooke::AddCoefficientsStretchesPrincipal(
...
/*----------------------------------------------------------------------*/
/*----------------------------------------------------------------------*/
// void MAT::ELASTIC::VarIsoNeoHooke::AddCoefficientsStretchesModified(
//   LINALG::Matrix<3,1>& gamma,  ///< see above, [gamma_1, gamma_2, gamma_3]
//   LINALG::Matrix<6,1>& delta,  ///< see above, [delta_11, delta_22, delta_33, delta_12, delta_23, delta_31]
