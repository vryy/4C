 ...
 *----------------------------------------------------------------------*/
MAT::ELASTIC::PAR::Coup3Pow::Coup3Pow(
 ...
 *----------------------------------------------------------------------*/
MAT::ELASTIC::Coup3Pow::Coup3Pow(MAT::ELASTIC::PAR::Coup3Pow* params)
  : params_(params)
{
}
...
/*----------------------------------------------------------------------*/
/*----------------------------------------------------------------------*/
void MAT::ELASTIC::Coup3Pow::AddStrainEnergy(
    double& psi,
 ...
 *                                                       birzle 12/2014 */
/*----------------------------------------------------------------------*/
void MAT::ELASTIC::Coup3Pow::AddDerivativesPrincipal(
...
// If d<2
if (d<2)
  dserror("The Elast_Coup3Pow - material only works for positive integer exponents, which are larger than two.");
