...
/*----------------------------------------------------------------------*/
/*----------------------------------------------------------------------*/
void MAT::ELASTIC::IsoMooneyRivlin::AddStrainEnergy(
    double& psi,
    ...
    const int eleGID)
{
  ...
  // strain energy: Psi = C1 (\overline{I}_{\boldsymbol{C}}-3) + C2 (\overline{II}_{\boldsymbol{C}}-3).
 ...
 *                                                      birzle 11/2014  */
/*----------------------------------------------------------------------*/
void MAT::ELASTIC::IsoMooneyRivlin::AddDerivativesModified(
