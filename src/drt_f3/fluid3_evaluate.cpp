      ...
      */
      ...
      if(supg)
      {
         ...
         */
         ...
         elemat(vi*4    , ui*4 + 3) += fac_alphaM_tauM_funct_ui_conv_c_vi ;
         elemat(vi*4 + 1, ui*4 + 3) += fac_alphaM_tauM_funct_ui_conv_c_vi ;
         elemat(vi*4 + 2, ui*4 + 3) += fac_alphaM_tauM_funct_ui_conv_c_vi ;
