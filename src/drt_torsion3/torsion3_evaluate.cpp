    ...
    Epetra_SerialDenseVector& elevec3)
{
  ...
  else if (action=="calc_stat_force_damp") act = Torsion3::calc_stat_force_damp;
   ...
   *(allows connectin torsion3 and beam3 directly)*/
  ...
  switch(act)
  {
    ...
    case Torsion3::calc_stat_force_damp:
    {
...
int DRT::ELEMENTS::Torsion3::EvaluateStatForceDamp(ParameterList& params,
                                                ...
                                                int& ActNumDof0)
{
  ...
  return 0;
} //DRT::ELEMENTS::Torsion3::EvaluateStatisticalNeumann
...
int DRT::ELEMENTS::Torsion3::EvaluatePTC(ParameterList& params,
                                      Epetra_SerialDenseMatrix& elemat1,
                                      int& ActNumDof0)
{
  ...
  return 0;
} //DRT::ELEMENTS::Torsion3::EvaluatePTC
 ...
 *-----------------------------------------------------------------------------------------------------------*/
void DRT::ELEMENTS::Torsion3::t3_nlnstiffmass_totlag( vector<double>& disp,
    Epetra_SerialDenseMatrix* stiffmatrix,
    Epetra_SerialDenseMatrix* massmatrix,
    Epetra_SerialDenseVector* force,
    int& ActNumDof0)
{
  ...
  /* read material parameters using structure _MATERIAL which is defined by inclusion of      /
   ...
   / function instead of e.g. Torsion3_input.cpp or within the Torsion3Register class since it is not/
  ...
  return;
} // DRT::ELEMENTS::Torsion3::t3_nlnstiffmass
...
/*------------------------------------------------------------------------------------------------------------*
  ...
  *-----------------------------------------------------------------------------------------------------------*/
void DRT::ELEMENTS::Torsion3::t3_nlnstiffmass_engstr( vector<double>& disp,
    Epetra_SerialDenseMatrix* stiffmatrix,
    Epetra_SerialDenseMatrix* massmatrix,
    Epetra_SerialDenseVector* force,
    int& ActNumDof0)
{
  ...
  return;
} // DRT::ELEMENTS::Torsion3::bt_nlnstiffmass2


// lump mass matrix
void DRT::ELEMENTS::Torsion3::t3_lumpmass(Epetra_SerialDenseMatrix* emass)
{
  // lump mass matrix
  if (emass != NULL)
  {
