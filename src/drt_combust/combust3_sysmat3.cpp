...
//{
          ...
          )
  {
      ...
      const int numparamvelx = XFEM::comgetNumParam<ASSTYPE>(dofman, XFEM::PHYSICS::Velx, numnode);
      const int numparamvely = XFEM::comgetNumParam<ASSTYPE>(dofman, XFEM::PHYSICS::Vely, numnode);
      const int numparamvelz = XFEM::comgetNumParam<ASSTYPE>(dofman, XFEM::PHYSICS::Velz, numnode);
      const int numparampres = XFEM::comgetNumParam<ASSTYPE>(dofman, XFEM::PHYSICS::Pres, numnode);
      ...
      const int numparamtauxx = XFEM::comgetNumParam<ASSTYPE>(dofman, XFEM::PHYSICS::Tauxx, 1);
      const int numparamdiscpres = XFEM::comgetNumParam<ASSTYPE>(dofman, XFEM::PHYSICS::DiscPres, 1);
      ...
      const bool tauele_unknowns_present = (XFEM::comgetNumParam<ASSTYPE>(dofman, XFEM::PHYSICS::Tauxx, 0) > 0);
      if (tauele_unknowns_present)
      {
          const int numparamtauyy = XFEM::comgetNumParam<ASSTYPE>(dofman, XFEM::PHYSICS::Tauyy, 1);
          const int numparamtauzz = XFEM::comgetNumParam<ASSTYPE>(dofman, XFEM::PHYSICS::Tauzz, 1);
          const int numparamtauxy = XFEM::comgetNumParam<ASSTYPE>(dofman, XFEM::PHYSICS::Tauxy, 1);
          const int numparamtauxz = XFEM::comgetNumParam<ASSTYPE>(dofman, XFEM::PHYSICS::Tauxz, 1);
          const int numparamtauyz = XFEM::comgetNumParam<ASSTYPE>(dofman, XFEM::PHYSICS::Tauyz, 1);
      ...
      const bool discpres_unknowns_present = (XFEM::comgetNumParam<ASSTYPE>(dofman, XFEM::PHYSICS::DiscPres, 0) > 0);
        ...
        )
{
    ...
    const bool tauele_unknowns_present = (XFEM::comgetNumParam<ASSTYPE>(dofman, Tauxx, 0) > 0);
    const bool discpres_unknowns_present = (XFEM::comgetNumParam<ASSTYPE>(dofman, DiscPres, 0) > 0);
...
//    cout << "pressure unknowns present: " << pressure_unknowns_present << endl;
    ...
    // number of parameters for each field (assumed to be equal for each velocity component and the pressure)
    const int numparamvelx = XFEM::comgetNumParam<ASSTYPE>(dofman, Velx, numnode);
...
//    const int numparamvelz = getNumParam<ASSTYPE>(dofman, Velz, numnode);
    const int numparampres = XFEM::comgetNumParam<ASSTYPE>(dofman, Pres, numnode);
    // put one here to create arrays of size 1, since they are not needed anyway
    // in the xfem assembly, the numparam is determined by the dofmanager
    const int numparamtauxx = XFEM::comgetNumParam<ASSTYPE>(dofman, Tauxx, 1);
    const int numparamdiscpres = XFEM::comgetNumParam<ASSTYPE>(dofman, DiscPres, 1);
