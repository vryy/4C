...
namespace DealiiWrappers
{
  ...
  namespace ConversionInternal
  {
        ...
        const std::span<const int>& reindex_scalar, std::vector<int>& reindexing)
    {
      ...
      const auto fe_name = DealiiWrappers::FourCToDealii::dealii_fe_name(cell_type);
    ...
    /**
     * Helper function to extract the dimension from a deal.II finite element name.
     * Return -1 if the dimension cannot be extracted.
     * This is necessary as deal.II uses the same finite element names for different spatial
     * dimensions (e.g. FE_Q(1) is the liner tensor
     * product element in any spatial dimension i.e. dim=1 -> line2, dim=2 -> quad4, dim=3 -> hex8).
     * @param
     * @return
     */
  ...
  namespace FourCToDealii
  {
        ...
        Core::FE::CellType cell_type)
    {
      switch (cell_type)
      {
        // dimension 1
        {
          ...
          {
            return ConversionInternal::FourCToDealii::reindex_line2;
          }
        }
        ...
        // dimension 2
        {
          ...
          {
            return ConversionInternal::FourCToDealii::reindex_quad4;
          }
          case Core::FE::CellType::quad9:
          {
            return ConversionInternal::FourCToDealii::reindex_quad9;
          }
        }
        ...
        // dimension 3
        {
          ...
          {
            return ConversionInternal::FourCToDealii::reindex_tet4;
          }
          case Core::FE::CellType::hex8:
          {
            return ConversionInternal::FourCToDealii::reindex_hex8;
          }
          case Core::FE::CellType::hex27:
          {
            return ConversionInternal::FourCToDealii::reindex_hex27;
          }
        }
        default:
        {
    ...
    {
      ConversionInternal::reindex_shape_functions<true, dim, spacedim>(
  ...
  namespace DealiiToFourC
  {
    inline std::span<const int> reindex_shape_functions_scalar(Core::FE::CellType cell_type)
    {
      switch (cell_type)
      {
        // dimension 1
        {
          case Core::FE::CellType::line2:
          {
            return ConversionInternal::DealiiToFourC::reindex_line2;
          }
        }
        ...
        // dimension 2
        {
          case Core::FE::CellType::quad4:
          {
            return ConversionInternal::DealiiToFourC::reindex_quad4;
          }
          case Core::FE::CellType::quad9:
          {
            return ConversionInternal::DealiiToFourC::reindex_quad9;
          }
        }
        ...
        // dimension 3
        {
          case Core::FE::CellType::tet4:
          {
            return ConversionInternal::DealiiToFourC::reindex_tet4;
          }
          case Core::FE::CellType::hex8:
          {
            return ConversionInternal::DealiiToFourC::reindex_hex8;
          }
          case Core::FE::CellType::hex27:
          {
            return ConversionInternal::DealiiToFourC::reindex_hex27;
          }
        }
        default:
        {
    ...
    inline void reindex_shape_functions(
        Core::FE::CellType cell_type, unsigned int n_components, std::vector<int>& reindexing)
    {
      ConversionInternal::reindex_shape_functions<false, dim, spacedim>(
          cell_type, n_components, reindex_shape_functions_scalar(cell_type), reindexing);
    }
    ...
    constexpr Core::FE::CellType four_c_cell_type(std::string_view finite_element_name)
    {
      auto dim = ConversionInternal::extract_dimension_from_fe_name(finite_element_name);
      if (dim == -1)
      {
        FOUR_C_THROW(
