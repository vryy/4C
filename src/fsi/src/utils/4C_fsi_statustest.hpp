...
namespace FSI::Nonlinear
{
  ...
  class AdaptiveNewtonNormF : public GenericNormF
  {
   public:
    ...
    void set_newton(Teuchos::RCP<FSI::Nonlinear::Newton> newton) { newton_ = newton; }

   protected:
    Teuchos::RCP<FSI::Nonlinear::Newton> newton() { return newton_; }

   private:
    Teuchos::RCP<FSI::Nonlinear::Newton> newton_;
  };
