...
/// ctor
TUTORIAL::StructAleCoupling::StructAleCoupling()
: TUTORIAL::NonlinearTruss()
{
...
/*-----------------------------------------------------------------------/
/-----------------------------------------------------------------------*/
void TUTORIAL::StructAleCoupling::PostEvaluate(LINALG::Matrix<numele+1,1> rhs, LINALG::Matrix<numele+1,numele+1> stiff, bool eval_rhs, bool eval_stiff)
{
