...
//#include "xdiff3_spacetime_utils.H"
...
#include "../drt_fem_general/drt_utils_gder2.H"
  ...
  void BuildStiffnessMatrixEntries(
      ...
      const XDIFF::ApproxFunc<shpVecSize>&                     shp,
      ...
      const XDIFF::EnrViscs2<shpVecSize>& enr_viscs2,
...
//                      XFEM::Enrichment::approachUnknown));
            ...
            const LINALG::Matrix<nsd,1> gpvelnp = XDIFF::interpolateVectorFieldToIntPoint(evelnp, shp.d0, numparamvelx);
...
//            }
            ...
            if (tauele_unknowns_present)
            {
              XDIFF::fill_tau(numparamtauxx, shp_tau, etau, tau);
            }
            else
            {
              tau.Clear();
...
//              enr_conv_g_ = 0.0;
          ...
          /*   /                                                \
             ...
             2 |                                                |
               ...
               N_y .. y-line of N                                             */
            static XDIFF::EnrViscs2<shpVecSize> enr_viscs2;
