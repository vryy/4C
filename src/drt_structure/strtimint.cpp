  ...
  damp_(Teuchos::null)
{
  ...
  // time state
  time_ = Teuchos::rcp(new TimIntMStep<double>(0, 0, 0.0));  // HERE SHOULD BE SOMETHING LIKE (sdynparams.get<double>("TIMEINIT")) -- you may not believe it, but time does not always starts at zero, folks
