...
init_assembly(actpart,actsolv,actintra,actfield,a_array,kapeps);
...
/*---------------------------- intitialise global matrix and global rhs */
solserv_zero_vec(rhs_ke);
solserv_zero_mat(actintra,&(actsolv->sysarray[kapeps]),
                 &(actsolv->sysarray_typ[kapeps]));
