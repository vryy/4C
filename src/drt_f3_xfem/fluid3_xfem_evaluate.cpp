...
/*--------------------------------------------------- form basic values */
   ...
   if(icode>1) /* --> first derivative evaluation */
   {
      deriv(0,0) = Q18*sm*tm*(2.0*rp+sm+tm-FIVE);
      deriv(1,0) =-Q18*tm*rp*(2.0*sm+tm+rp-FIVE);
      deriv(2,0) =-Q18*rp*sm*(2.0*tm+rp+sm-FIVE);

      deriv(0,1) = Q18*sp*tm*(2.0*rp+sp+tm-FIVE);
      deriv(1,1) = Q18*tm*rp*(2.0*sp+tm+rp-FIVE);
      deriv(2,1) =-Q18*rp*sp*(2.0*tm+rp+sp-FIVE);

      deriv(0,2) =-Q18*sp*tm*(2.0*rm+sp+tm-FIVE);
      deriv(1,2) = Q18*tm*rm*(2.0*sp+tm+rm-FIVE);
      deriv(2,2) =-Q18*rm*sp*(2.0*tm+rm+sp-FIVE);

      deriv(0,3) =-Q18*sm*tm*(2.0*rm+sm+tm-FIVE);
      deriv(1,3) =-Q18*tm*rm*(2.0*sm+tm+rm-FIVE);
      deriv(2,3) =-Q18*rm*sm*(2.0*tm+rm+sm-FIVE);

      deriv(0,4) = Q18*sm*tp*(2.0*rp+sm+tp-FIVE);
      deriv(1,4) =-Q18*tp*rp*(2.0*sm+tp+rp-FIVE);
      deriv(2,4) = Q18*rp*sm*(2.0*tp+rp+sm-FIVE);

      deriv(0,5) = Q18*sp*tp*(2.0*rp+sp+tp-FIVE);
      deriv(1,5) = Q18*tp*rp*(2.0*sp+tp+rp-FIVE);
      deriv(2,5) = Q18*rp*sp*(2.0*tp+rp+sp-FIVE);

      deriv(0,6) =-Q18*sp*tp*(2.0*rm+sp+tp-FIVE);
      deriv(1,6) = Q18*tp*rm*(2.0*sp+tp+rm-FIVE);
      deriv(2,6) = Q18*rm*sp*(2.0*tp+rm+sp-FIVE);

      deriv(0,7) =-Q18*sm*tp*(2.0*rm+sm+tp-FIVE);
      deriv(1,7) =-Q18*tp*rm*(2.0*sm+tp+rm-FIVE);
      deriv(2,7) = Q18*rm*sm*(2.0*tp+rm+sm-FIVE);
