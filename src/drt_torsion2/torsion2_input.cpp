 ...
 *----------------------------------------------------------------------*/
bool DRT::ELEMENTS::Torsion2::ReadElement()
{
  ...
  if (ierr!=1) dserror("Reading of Torsion2 element failed");
  ...
  if (ierr)
  {
   ...
   else dserror("Reading of Torsion2 element failed because of unknown kinematic type!");
  }
  return true;
} // Torsion2::ReadElement()
