...
ens_reader1.CaseFileName = './PAR_structure.case'
...
csvWriter1.FileName = './par.csv'
csvWriter1.UpdatePipeline()


csv_reader1 = csv.reader(open('./par0.csv','r'), delimiter = ',')
...
ens_reader2.CaseFileName = './SER_structure.case'
...
csvWriter2.FileName = './ser.csv'
csvWriter2.UpdatePipeline()

csv_reader2 = csv.reader(open('./ser0.csv', 'r'), delimiter = ',')
