...
public:
  ...
  bool operator()( vertex_t u, const Graph & g )
  {
    return done_;
  }
...
//   std::copy( non_tree_edges.begin(), non_tree_edges.end(), std::ostream_iterator<edge_t>( std::cout, " " ) );
//   std::cout << "\n";
