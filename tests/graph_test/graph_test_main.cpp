...
int main( int ac, char ** av )
{
  ...
  desc.add_options()
    ...
    ( "cmd", boost::program_options::value<std::string>()->default_value( "find_cycles" ), "set graph command" )
    ( "graph", boost::program_options::value<std::string>()->default_value( "graph.txt" ), "set graph file" )
    ( "points", boost::program_options::value<std::string>()->default_value( "all_points.plot" ), "set point file" )
    ;
