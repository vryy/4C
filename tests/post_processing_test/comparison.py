...
if (
    ...
    sortlist1 = sorted(
        csv_reader1,
        key=operator.itemgetter(index1, index1 + 1, index1 + 2, head1.index("phi_1")),
    )
elif "c_1" in head1:
    sortlist1 = sorted(
        csv_reader1,
...
if (
    ...
    sortlist2 = sorted(
        csv_reader2,
        key=operator.itemgetter(index2, index2 + 1, index2 + 2, head2.index("phi_1")),
    )
elif "c_1" in head2:
    sortlist2 = sorted(
        csv_reader2,
...
if (
    ...
    sortlist_ref = sorted(
        csv_reader_ref, key=operator.itemgetter(index_ref, index_ref + 1, index_ref + 2)
    )
