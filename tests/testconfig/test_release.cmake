...
# prepare commands
set(CTEST_CONFIGURE_COMMAND "$ENV{CTEST_CONFIGURE_PREFIX}${CTEST_SOURCE_DIRECTORY}/do-configure -f --no-ccache --config=${CTEST_SOURCE_DIRECTORY}/buildconfig/$ENV{CTEST_BUILD_CONFIG_GITLAB} $ENV{CTEST_CONFIGURE_POSTFIX}")
