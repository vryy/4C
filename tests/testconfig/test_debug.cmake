...
# prepare commands
set(CTEST_CONFIGURE_COMMAND "${CTEST_SOURCE_DIRECTORY}/do-configure -f --debug --trilinos-debug --config=${CTEST_SOURCE_DIRECTORY}/buildconfig/$ENV{CTEST_BUILD_CONFIG_GITLAB} --useDEAL")
