...
set(CTEST_CONFIGURE_COMMAND
    "$ENV{CTEST_CONFIGURE_PREFIX}${CTEST_SOURCE_DIRECTORY}/do-configure -f --debug-optimized --no-ccache --config=${CTEST_SOURCE_DIRECTORY}/buildconfig/$ENV{CTEST_BUILD_CONFIG_GITLAB} --generator=$ENV{BUILD_GENERATOR} $ENV{CTEST_CONFIGURE_POSTFIX}"
    )
...
if(NOT $ENV{TEST_TAG} STREQUAL ""
   )# Only execute if tests are selected as otherwise scripte returns err
...
if(NOT ${numWarnings} EQUAL 0 AND $ENV{CTEST_FAIL_ON_WARNING} EQUAL 1
   )# Send error for warnings if enabled
  message(SEND_ERROR "Baci build issued build warnings!")
endif(NOT ${numWarnings} EQUAL 0 AND $ENV{CTEST_FAIL_ON_WARNING} EQUAL 1)

if(NOT ${testRes} EQUAL 0 AND NOT $ENV{TEST_TAG} STREQUAL ""
   )# Send error if test fail (if test were performed)
