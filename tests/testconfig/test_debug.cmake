...
set(CTEST_CONFIGURE_COMMAND
    "${CTEST_SOURCE_DIRECTORY}/do-configure -f --debug-optimized --no-ccache --config=${CTEST_SOURCE_DIRECTORY}/buildconfig/$ENV{CTEST_BUILD_CONFIG_GITLAB} --generator=$ENV{BUILD_GENERATOR} $ENV{CTEST_CONFIGURE_POSTFIX}"
    )
