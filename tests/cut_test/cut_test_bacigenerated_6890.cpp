...
void test_bacigenerated_6890()
{
  ...
  }
  {
    ...
    intersection.AddElement(6889, nids, hex8_xyze, DRT::Element::DiscretizationType::hex8);
  }

  {
    ...
    intersection.AddElement(6890, nids, hex8_xyze, DRT::Element::DiscretizationType::hex8);
  }

  {
    ...
    intersection.AddElement(6891, nids, hex8_xyze, DRT::Element::DiscretizationType::hex8);
  }

  {
    ...
    intersection.AddElement(6900, nids, hex8_xyze, DRT::Element::DiscretizationType::hex8);
  }

  {
    ...
    intersection.AddElement(6990, nids, hex8_xyze, DRT::Element::DiscretizationType::hex8);
  }
