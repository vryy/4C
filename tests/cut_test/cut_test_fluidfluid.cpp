...
void test_fluidfluid()
{
  ...
  loader.CreateSide(0, 96, 99, 98, 97, CORE::FE::CellType::quad4);
  ...
  loader.CreateSide(1, 96, 97, 101, 100, CORE::FE::CellType::quad4);
  loader.GetCutNode(-2, -0.0754442, -0.232583, 0.0129442, 0);
  loader.GetCutNode(103, 0.0625, -0.188388, 0.0625, 0);
  loader.CreateSide(2, 96, 100, 103, 99, CORE::FE::CellType::quad4);
  ...
  loader.CreateSide(3, 97, 98, 105, 104, CORE::FE::CellType::quad4);
  loader.GetCutNode(-4, -0.150888, -0.1, 0.0258883, 0);
  loader.GetCutNode(106, -0.125, -0.1, -0.125, 0);
  loader.CreateSide(4, 97, 104, 106, 101, CORE::FE::CellType::quad4);
  ...
  loader.CreateElement(11, 3, 2, 16, 17, 7, 6, 18, 19, CORE::FE::CellType::hex8);
  ...
  loader.CreateElement(12, 2, 9, 20, 16, 6, 11, 21, 18, CORE::FE::CellType::hex8);
  ...
  loader.CreateElement(13, 9, 13, 22, 20, 11, 15, 23, 21, CORE::FE::CellType::hex8);
  ...
  loader.CreateElement(14, 17, 16, 24, 25, 19, 18, 26, 27, CORE::FE::CellType::hex8);
  loader.GetNode(28, -0.25, 0.1, -0.0833333, 0);
  loader.GetNode(29, -0.0833333, 0.1, -0.0833333, 0);
  loader.CreateElement(15, 16, 20, 28, 24, 18, 21, 29, 26, CORE::FE::CellType::hex8);
  loader.GetNode(30, -0.25, 0.1, -0.25, 0);
  loader.GetNode(31, -0.0833333, 0.1, -0.25, 0);
  loader.CreateElement(16, 20, 22, 30, 28, 21, 23, 31, 29, CORE::FE::CellType::hex8);
  ...
  loader.CreateElement(26, 7, 6, 18, 19, 51, 50, 56, 57, CORE::FE::CellType::hex8);
  loader.GetNode(53, 0.0833333, -0.3, -0.0833333, 0);
  loader.GetNode(58, 0.0833333, -0.1, -0.0833333, 0);
  loader.CreateElement(27, 6, 11, 21, 18, 50, 53, 58, 56, CORE::FE::CellType::hex8);
  loader.GetNode(55, 0.0833333, -0.3, -0.25, 0);
  loader.GetNode(59, 0.0833333, -0.1, -0.25, 0);
  loader.CreateElement(28, 11, 15, 23, 21, 53, 55, 59, 58, CORE::FE::CellType::hex8);
  loader.GetNode(60, 0.0833333, 0.1, 0.0833333, 0);
  loader.GetNode(61, 0.0833333, 0.1, 0.25, 0);
  loader.CreateElement(29, 19, 18, 26, 27, 57, 56, 60, 61, CORE::FE::CellType::hex8);
  loader.GetNode(62, 0.0833333, 0.1, -0.0833333, 0);
  loader.CreateElement(30, 18, 21, 29, 26, 56, 58, 62, 60, CORE::FE::CellType::hex8);
  loader.GetNode(63, 0.0833333, 0.1, -0.25, 0);
  loader.CreateElement(31, 21, 23, 31, 29, 58, 59, 63, 62, CORE::FE::CellType::hex8);
  ...
  loader.CreateElement(41, 51, 50, 56, 57, 75, 74, 80, 81, CORE::FE::CellType::hex8);
  loader.GetNode(77, 0.25, -0.3, -0.0833333, 0);
  loader.GetNode(82, 0.25, -0.1, -0.0833333, 0);
  loader.CreateElement(42, 50, 53, 58, 56, 74, 77, 82, 80, CORE::FE::CellType::hex8);
  loader.GetNode(79, 0.25, -0.3, -0.25, 0);
  loader.GetNode(83, 0.25, -0.1, -0.25, 0);
  loader.CreateElement(43, 53, 55, 59, 58, 77, 79, 83, 82, CORE::FE::CellType::hex8);
  loader.GetNode(84, 0.25, 0.1, 0.0833333, 0);
  loader.GetNode(85, 0.25, 0.1, 0.25, 0);
  loader.CreateElement(44, 57, 56, 60, 61, 81, 80, 84, 85, CORE::FE::CellType::hex8);
  loader.GetNode(86, 0.25, 0.1, -0.0833333, 0);
  loader.CreateElement(45, 56, 58, 62, 60, 80, 82, 86, 84, CORE::FE::CellType::hex8);
  loader.GetNode(87, 0.25, 0.1, -0.25, 0);
  loader.CreateElement(46, 58, 59, 63, 62, 82, 83, 87, 86, CORE::FE::CellType::hex8);
...
void test_fluidfluid2()
{
  ...
  loader.CreateSide(0, 32, 35, 34, 33, CORE::FE::CellType::quad4);
  loader.GetCutNode(-1, -0.25, 0, 0, 0);
  loader.GetCutNode(37, 0.25, -0.25, -0.025, 0);
  loader.GetCutNode(36, 0.25, -0.25, 0.025, 0);
  loader.CreateSide(1, 32, 33, 37, 36, CORE::FE::CellType::quad4);
  loader.GetCutNode(-2, 0, -0.25, 0, 0);
  loader.GetCutNode(39, 0.25, 0.25, 0.025, 0);
  loader.CreateSide(2, 32, 36, 39, 35, CORE::FE::CellType::quad4);
  loader.GetCutNode(-3, 0, 0, 0.025, 0);
  loader.GetCutNode(38, 0.25, 0.25, -0.025, 0);
  loader.CreateSide(3, 33, 34, 38, 37, CORE::FE::CellType::quad4);
  loader.GetCutNode(-4, 0, 0, -0.025, 0);
  loader.CreateSide(4, 34, 35, 39, 38, CORE::FE::CellType::quad4);
  loader.GetCutNode(-5, 0, 0.25, 0, 0);
  loader.CreateSide(5, 36, 37, 38, 39, CORE::FE::CellType::quad4);
  loader.GetCutNode(-6, 0.25, 0, 0, 0);
  loader.CreateSide(6, 32, 35, 34, 33, CORE::FE::CellType::quad4);
  loader.CreateSide(7, 32, 33, 37, 36, CORE::FE::CellType::quad4);
  loader.CreateSide(8, 32, 36, 39, 35, CORE::FE::CellType::quad4);
  loader.CreateSide(9, 33, 34, 38, 37, CORE::FE::CellType::quad4);
  loader.CreateSide(10, 34, 35, 39, 38, CORE::FE::CellType::quad4);
  loader.CreateSide(11, 36, 37, 38, 39, CORE::FE::CellType::quad4);
  ...
  loader.CreateElement(0, 0, 1, 2, 3, 4, 5, 6, 7, CORE::FE::CellType::hex8);
  ...
  loader.CreateElement(1, 3, 2, 8, 9, 7, 6, 10, 11, CORE::FE::CellType::hex8);
  ...
  loader.CreateElement(2, 9, 8, 12, 13, 11, 10, 14, 15, CORE::FE::CellType::hex8);
  ...
  loader.CreateElement(3, 4, 5, 6, 7, 16, 17, 18, 19, CORE::FE::CellType::hex8);
  loader.GetNode(20, 0.25, 0.25, -0.025, 0);
  loader.GetNode(21, 0.25, 0.25, 0.025, 0);
  loader.CreateElement(4, 7, 6, 10, 11, 19, 18, 20, 21, CORE::FE::CellType::hex8);
  loader.GetNode(22, 0.25, 0.75, -0.025, 0);
  loader.GetNode(23, 0.25, 0.75, 0.025, 0);
  loader.CreateElement(5, 11, 10, 14, 15, 21, 20, 22, 23, CORE::FE::CellType::hex8);
  ...
  loader.CreateElement(6, 16, 17, 18, 19, 24, 25, 26, 27, CORE::FE::CellType::hex8);
  loader.GetNode(28, 0.75, 0.25, -0.025, 0);
  loader.GetNode(29, 0.75, 0.25, 0.025, 0);
  loader.CreateElement(7, 19, 18, 20, 21, 27, 26, 28, 29, CORE::FE::CellType::hex8);
  loader.GetNode(30, 0.75, 0.75, -0.025, 0);
  loader.GetNode(31, 0.75, 0.75, 0.025, 0);
  loader.CreateElement(8, 21, 20, 22, 23, 29, 28, 30, 31, CORE::FE::CellType::hex8);
