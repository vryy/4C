...
void test_fluidfluid()
{
  ...
  loader.CreateSide( 0, 96, 99, 98, 97, 1 );
  ...
  loader.CreateElement( 11, 3, 2, 16, 17, 7, 6, 18, 19, 6 );
  ...
  loader.CreateElement( 12, 2, 9, 20, 16, 6, 11, 21, 18, 6 );
  ...
  loader.CreateElement( 13, 9, 13, 22, 20, 11, 15, 23, 21, 6 );
  ...
  loader.CreateElement( 41, 51, 50, 56, 57, 75, 74, 80, 81, 6 );
  loader.GetNode( 77, 0.25, -0.3, -0.0833333, 0 );
  loader.GetNode( 82, 0.25, -0.1, -0.0833333, 0 );
  loader.CreateElement( 42, 50, 53, 58, 56, 74, 77, 82, 80, 6 );
  loader.GetNode( 79, 0.25, -0.3, -0.25, 0 );
  loader.GetNode( 83, 0.25, -0.1, -0.25, 0 );
  loader.CreateElement( 43, 53, 55, 59, 58, 77, 79, 83, 82, 6 );
  loader.GetNode( 84, 0.25, 0.1, 0.0833333, 0 );
  loader.GetNode( 85, 0.25, 0.1, 0.25, 0 );
  loader.CreateElement( 44, 57, 56, 60, 61, 81, 80, 84, 85, 6 );
  loader.GetNode( 86, 0.25, 0.1, -0.0833333, 0 );
  loader.CreateElement( 45, 56, 58, 62, 60, 80, 82, 86, 84, 6 );
  loader.GetNode( 87, 0.25, 0.1, -0.25, 0 );
  loader.CreateElement( 46, 58, 59, 63, 62, 82, 83, 87, 86, 6 );
