...
#define nxyz(x, y, z)                     \
  {                                       \
    if (nodeids.count(#x #y #z) == 0)     \
    {                                     \
      nodeids[#x #y #z] = nodeids.size(); \
    }                                     \
  }
#define nxyz1(x, y, z)  \
  nxyz(x, y, z);        \
  ...
  quad4_xyze(1, 0) = y; \
  quad4_xyze(2, 0) = z; \
  nids[0] = nodeids[#x #y #z];
#define nxyz2(x, y, z)  \
  nxyz(x, y, z);        \
  quad4_xyze(0, 1) = x; \
  quad4_xyze(1, 1) = y; \
  quad4_xyze(2, 1) = z; \
  nids[1] = nodeids[#x #y #z];
#define nxyz3(x, y, z)  \
  nxyz(x, y, z);        \
  quad4_xyze(0, 2) = x; \
  quad4_xyze(1, 2) = y; \
  quad4_xyze(2, 2) = z; \
  nids[2] = nodeids[#x #y #z];
#define nxyz4(x, y, z)  \
  nxyz(x, y, z);        \
  quad4_xyze(0, 3) = x; \
  quad4_xyze(1, 3) = y; \
  quad4_xyze(2, 3) = z; \
  nids[3] = nodeids[#x #y #z];
...
void test_quad4_line2(double x1, double y1, double x2, double y2)
{
  ...
  xyz[1] = y1;
  xyz[2] = 0;
  Cut::Node* n1 = mesh.get_node(1, &xyz[0]);

  xyz[0] = x2;
  xyz[1] = y2;
  Cut::Node* n2 = mesh.get_node(2, &xyz[0]);

  Cut::Edge* edge = mesh.get_edge(n1, n2);

  std::vector<Cut::Node*> nodes;
  xyz[0] = 0;
  xyz[1] = 0;
  nodes.push_back(mesh.get_node(3, &xyz[0]));
  xyz[0] = 1;
  xyz[1] = 0;
  nodes.push_back(mesh.get_node(4, &xyz[0]));
  xyz[0] = 1;
  xyz[1] = 1;
  nodes.push_back(mesh.get_node(5, &xyz[0]));
  xyz[0] = 0;
  xyz[1] = 1;
  nodes.push_back(mesh.get_node(6, &xyz[0]));
  ...
  if (cuts.size() != 2)
  {
    ...
    std::copy(cuts.begin(), cuts.end(), std::ostream_iterator<Cut::Point*>(str, " "));
...
void test_hex8_quad4_qhull1()
{
  ...
  intersection.add_cut_side(1, nids, quad4_xyze, Core::FE::CellType::quad4);
  ...
  intersection.add_cut_side(2, nids, quad4_xyze, Core::FE::CellType::quad4);
...
void test_hex8_quad4_alex1()
{
  ...
  intersection.add_cut_side(3, nids, quad4_xyze, Core::FE::CellType::quad4);
...
void test_hex8_quad4_alex2()
{
  ...
  intersection.add_cut_side(4, nids, quad4_xyze, Core::FE::CellType::quad4);
...
void test_hex8_quad4_alex3()
{
  ...
  intersection.add_cut_side(5, nids, quad4_xyze, Core::FE::CellType::quad4);
  ...
  intersection.add_cut_side(6, nids, quad4_xyze, Core::FE::CellType::quad4);
...
void test_tet4_quad4_alex9()
{
  ...
  Cut::SideHandle* s1 = intersection.add_cut_side(1, nids, quad4_xyze, Core::FE::CellType::quad4);
  ...
  Cut::SideHandle* s2 = intersection.add_cut_side(2, nids, quad4_xyze, Core::FE::CellType::quad4);
  ...
  Cut::SideHandle* s3 = intersection.add_cut_side(3, nids, quad4_xyze, Core::FE::CellType::quad4);
  ...
  Cut::SideHandle* s4 = intersection.add_cut_side(4, nids, quad4_xyze, Core::FE::CellType::quad4);
  ...
  Cut::ElementHandle* e = intersection.add_element(1, nids, tet4_xyze, Core::FE::CellType::tet4);

  Cut::plain_side_set cut_sides;
  s1->collect_sides(cut_sides);
  s2->collect_sides(cut_sides);
  s3->collect_sides(cut_sides);
  s4->collect_sides(cut_sides);
...
void test_tet4_quad4_alex11()
{
...

  {
    ...
    intersection.add_cut_side(2, nids, quad4_xyze, Core::FE::CellType::tri3);
    ...
    intersection.add_cut_side(3, nids, quad4_xyze, Core::FE::CellType::tri3);
    ...
    intersection.add_cut_side(4, nids, quad4_xyze, Core::FE::CellType::tri3);

    nxyz1(0.90127599046596340582, 0.12378087657319215842, 0.31909880503242982197);
    nxyz2(0.89130437399999984383, 0.11422492436052207598, 0.31907111909968571828);
    nxyz3(0.91110590805399416237, 0.11396906901062973938, 0.31913932938821898411);

    intersection.add_cut_side(5, nids, quad4_xyze, Core::FE::CellType::tri3);
  }
  ...
  intersection.add_element(1, nids, tet4_xyze, Core::FE::CellType::tet4);
  intersection.cut_test_cut(true, Cut::VCellGaussPts_DirectDivergence);
}
...
void test_hex8_quad4_alex12()
{
  ...
  intersection.add_cut_side(7, nids, quad4_xyze, Core::FE::CellType::quad4);
...
void test_hex8_quad4_alex15()
{
  ...
  intersection.add_cut_side(8, nids, quad4_xyze, Core::FE::CellType::quad4);
  ...
  intersection.add_cut_side(9, nids, quad4_xyze, Core::FE::CellType::quad4);
  ...
  intersection.add_cut_side(10, nids, quad4_xyze, Core::FE::CellType::quad4);
  ...
  intersection.add_cut_side(11, nids, quad4_xyze, Core::FE::CellType::quad4);
  ...
  intersection.add_cut_side(12, nids, quad4_xyze, Core::FE::CellType::quad4);
...
void test_tet4_quad4_alex16()
{
  ...
  //     intersection.AddCutSide( 1, nids, quad4_xyze, Core::FE::CellType::quad4 );
  //   }

  {
    ...
    intersection.add_cut_side(1, nids, quad4_xyze, Core::FE::CellType::tri3);
    ...
    intersection.add_cut_side(6, nids, quad4_xyze, Core::FE::CellType::tri3);

    nxyz1(0.899594, 0.4201, 0.016);
    nxyz2(0.9103, 0.4201, -8.26403e-20);
    nxyz3(0.888889, 0.4201, 0);

    intersection.add_cut_side(7, nids, quad4_xyze, Core::FE::CellType::tri3);

    nxyz1(0.9103, 0.423383, 0.016);
    nxyz2(0.9103, 0.4201, -8.26403e-20);
    nxyz3(0.9103, 0.4201, 0.032);

    intersection.add_cut_side(8, nids, quad4_xyze, Core::FE::CellType::tri3);

    nxyz1(0.9103, 0.423383, 0.016);
    nxyz2(0.9103, 0.4201, 0.032);
    nxyz3(0.9103, 0.426667, 0.032);

    intersection.add_cut_side(9, nids, quad4_xyze, Core::FE::CellType::tri3);

    nxyz1(0.9103, 0.423383, 0.016);
    nxyz2(0.9103, 0.426667, 0.032);
    nxyz3(0.9103, 0.426667, 0);

    intersection.add_cut_side(10, nids, quad4_xyze, Core::FE::CellType::tri3);

    nxyz1(0.9103, 0.423383, 0.016);
    nxyz2(0.9103, 0.426667, 0);
    nxyz3(0.9103, 0.4201, -8.26403e-20);

    intersection.add_cut_side(11, nids, quad4_xyze, Core::FE::CellType::tri3);
  }
...
void test_hex8_quad4_alex30()
{
  ...
  intersection.add_element(1, nids, hex8_xyze, Core::FE::CellType::hex8);
  // intersection.CutTest_Cut( true,Cut::VCellGaussPts_Tessellation);
  intersection.cut_test_cut(true, Cut::VCellGaussPts_DirectDivergence);
}
...
void test_hex8_quad4_axel7()
{
  ...
  intersection.add_cut_side(++sideid, nids, quad4_xyze, Core::FE::CellType::tri3);
...
void test_hex8_quad4_shadan5()
{
  ...
  intersection.add_cut_side(++sideid, nids, quad4_xyze, Core::FE::CellType::quad4);
...
void test_hex8_quad4_shadan1()
{
  ...
  intersection.add_cut_side(13, nids, quad4_xyze, Core::FE::CellType::quad4);
  ...
  intersection.add_cut_side(14, nids, quad4_xyze, Core::FE::CellType::quad4);
  ...
  intersection.add_cut_side(15, nids, quad4_xyze, Core::FE::CellType::quad4);
  ...
  intersection.add_cut_side(16, nids, quad4_xyze, Core::FE::CellType::quad4);
  ...
  intersection.add_cut_side(17, nids, quad4_xyze, Core::FE::CellType::quad4);
  ...
  intersection.add_cut_side(18, nids, quad4_xyze, Core::FE::CellType::quad4);
...
void test_hex27_quad9_simple()
{
  ...
  for (int i = 0; i < 9; ++i)
  {
    ...
    for (int j = 0; j < 2; ++j)
    {
      quad9_xyze(j, i) = Core::FE::eleNodeNumbering_quad9_nodes_reference[i][j];
    }
    quad9_xyze(2, i) = 0;
  }

  intersection.add_cut_side(1, nids, quad9_xyze, Core::FE::CellType::quad9);
  ...
  for (int i = 0; i < 27; ++i)
  {
    ...
    for (int j = 0; j < 3; ++j)
    {
      hex27_xyze(j, i) = Core::FE::eleNodeNumbering_hex27_nodes_reference[i][j];
    }
  }
  ...
  intersection.add_element(1, nids, hex27_xyze, Core::FE::CellType::hex27);
...
void test_hex20_quad9_simple()
{
  ...
  for (int i = 0; i < 20; ++i)
  {
    ...
    for (int j = 0; j < 3; ++j)
    {
      hex20_xyze(j, i) = Core::FE::eleNodeNumbering_hex27_nodes_reference[i][j];
    }
  }
  ...
  intersection.add_element(1, nids, hex20_xyze, Core::FE::CellType::hex20);
...
void test_tet10_quad9_simple()
{
  ...
  for (int i = 0; i < 10; ++i)
  {
    ...
    for (int j = 0; j < 3; ++j)
    {
      tet10_xyze(j, i) = Core::FE::eleNodeNumbering_tet10_nodes_reference[i][j];
    }
  }
  ...
  intersection.add_element(1, nids, tet10_xyze, Core::FE::CellType::tet10);
