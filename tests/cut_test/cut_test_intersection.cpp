...
void test_hex8_quad4_qhull1()
{
  ...
  intersection.AddCutSide(1, nids, quad4_xyze, DRT::Element::DiscretizationType::quad4);
  ...
  intersection.AddCutSide(2, nids, quad4_xyze, DRT::Element::DiscretizationType::quad4);
...
void test_hex8_quad4_alex1()
{
  ...
  intersection.AddCutSide(3, nids, quad4_xyze, DRT::Element::DiscretizationType::quad4);
...
void test_hex8_quad4_alex2()
{
  ...
  intersection.AddCutSide(4, nids, quad4_xyze, DRT::Element::DiscretizationType::quad4);
...
void test_hex8_quad4_alex3()
{
  ...
  intersection.AddCutSide(5, nids, quad4_xyze, DRT::Element::DiscretizationType::quad4);
  ...
  intersection.AddCutSide(6, nids, quad4_xyze, DRT::Element::DiscretizationType::quad4);
...
void test_tet4_quad4_alex9()
{
  ...
  CORE::GEO::CUT::ElementHandle* e =
      intersection.AddElement(1, nids, tet4_xyze, DRT::Element::DiscretizationType::tet4);
...
void test_tet4_quad4_alex11()
{
...

  {
    ...
    intersection.AddCutSide(2, nids, quad4_xyze, DRT::Element::DiscretizationType::tri3);
    ...
    intersection.AddCutSide(3, nids, quad4_xyze, DRT::Element::DiscretizationType::tri3);
    ...
    intersection.AddCutSide(4, nids, quad4_xyze, DRT::Element::DiscretizationType::tri3);

    nxyz1(0.90127599046596340582, 0.12378087657319215842, 0.31909880503242982197);
    nxyz2(0.89130437399999984383, 0.11422492436052207598, 0.31907111909968571828);
    nxyz3(0.91110590805399416237, 0.11396906901062973938, 0.31913932938821898411);

    intersection.AddCutSide(5, nids, quad4_xyze, DRT::Element::DiscretizationType::tri3);
  }
...
void test_hex8_quad4_alex12()
{
  ...
  intersection.AddCutSide(7, nids, quad4_xyze, DRT::Element::DiscretizationType::quad4);
...
void test_hex8_quad4_alex15()
{
  ...
  intersection.AddCutSide(8, nids, quad4_xyze, DRT::Element::DiscretizationType::quad4);
  ...
  intersection.AddCutSide(9, nids, quad4_xyze, DRT::Element::DiscretizationType::quad4);
  ...
  intersection.AddCutSide(10, nids, quad4_xyze, DRT::Element::DiscretizationType::quad4);
  ...
  intersection.AddCutSide(11, nids, quad4_xyze, DRT::Element::DiscretizationType::quad4);
  ...
  intersection.AddCutSide(12, nids, quad4_xyze, DRT::Element::DiscretizationType::quad4);
...
void test_tet4_quad4_alex16()
{
...

  {
    ...
    intersection.AddCutSide(1, nids, quad4_xyze, DRT::Element::DiscretizationType::tri3);
    ...
    intersection.AddCutSide(6, nids, quad4_xyze, DRT::Element::DiscretizationType::tri3);

    nxyz1(0.899594, 0.4201, 0.016);
    nxyz2(0.9103, 0.4201, -8.26403e-20);
    nxyz3(0.888889, 0.4201, 0);

    intersection.AddCutSide(7, nids, quad4_xyze, DRT::Element::DiscretizationType::tri3);

    nxyz1(0.9103, 0.423383, 0.016);
    nxyz2(0.9103, 0.4201, -8.26403e-20);
    nxyz3(0.9103, 0.4201, 0.032);

    intersection.AddCutSide(8, nids, quad4_xyze, DRT::Element::DiscretizationType::tri3);

    nxyz1(0.9103, 0.423383, 0.016);
    nxyz2(0.9103, 0.4201, 0.032);
    nxyz3(0.9103, 0.426667, 0.032);

    intersection.AddCutSide(9, nids, quad4_xyze, DRT::Element::DiscretizationType::tri3);

    nxyz1(0.9103, 0.423383, 0.016);
    nxyz2(0.9103, 0.426667, 0.032);
    nxyz3(0.9103, 0.426667, 0);

    intersection.AddCutSide(10, nids, quad4_xyze, DRT::Element::DiscretizationType::tri3);

    nxyz1(0.9103, 0.423383, 0.016);
    nxyz2(0.9103, 0.426667, 0);
    nxyz3(0.9103, 0.4201, -8.26403e-20);

    intersection.AddCutSide(11, nids, quad4_xyze, DRT::Element::DiscretizationType::tri3);
  }
...
void test_hex8_quad4_axel7()
{
  ...
  intersection.AddCutSide(++sideid, nids, quad4_xyze, DRT::Element::DiscretizationType::tri3);
...
void test_hex8_quad4_shadan5()
{
  ...
  intersection.AddCutSide(++sideid, nids, quad4_xyze, DRT::Element::DiscretizationType::quad4);
...
void test_hex8_quad4_shadan1()
{
  ...
  intersection.AddCutSide(13, nids, quad4_xyze, DRT::Element::DiscretizationType::quad4);
  ...
  intersection.AddCutSide(14, nids, quad4_xyze, DRT::Element::DiscretizationType::quad4);
  ...
  intersection.AddCutSide(15, nids, quad4_xyze, DRT::Element::DiscretizationType::quad4);
  ...
  intersection.AddCutSide(16, nids, quad4_xyze, DRT::Element::DiscretizationType::quad4);
  ...
  intersection.AddCutSide(17, nids, quad4_xyze, DRT::Element::DiscretizationType::quad4);
  ...
  intersection.AddCutSide(18, nids, quad4_xyze, DRT::Element::DiscretizationType::quad4);
...
void test_hex27_quad9_simple()
{
  ...
  intersection.AddCutSide(1, nids, quad9_xyze, DRT::Element::DiscretizationType::quad9);
  ...
  intersection.AddElement(1, nids, hex27_xyze, DRT::Element::DiscretizationType::hex27);
...
void test_hex20_quad9_simple()
{
  ...
  intersection.AddElement(1, nids, hex20_xyze, DRT::Element::DiscretizationType::hex20);
...
void test_tet10_quad9_simple()
{
  ...
  intersection.AddElement(1, nids, tet10_xyze, DRT::Element::DiscretizationType::tet10);
