...
void test_bacigenerated_79216()
{
  ...
  }
  {
    ...
    intersection.AddElement(77416, nids, hex8_xyze, DRT::Element::DiscretizationType::hex8);
  }

  {
    ...
    intersection.AddElement(79217, nids, hex8_xyze, DRT::Element::DiscretizationType::hex8);
  }

  {
    ...
    intersection.AddElement(79276, nids, hex8_xyze, DRT::Element::DiscretizationType::hex8);
  }

  {
    ...
    intersection.AddElement(81016, nids, hex8_xyze, DRT::Element::DiscretizationType::hex8);
  }

  {
    ...
    intersection.AddElement(79216, nids, hex8_xyze, DRT::Element::DiscretizationType::hex8);
  }
