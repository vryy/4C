...
echo '...the real work starts here' `/usr/bin/date`
...
echo '...preparing the parallel application start' `/usr/bin/date`
echo '...this job is running with' NSLOTS=$NSLOTS , $TMPDIR/machines:
cat $TMPDIR/machines
echo 'EOF' 
 
echo '...starting the application' `/usr/bin/date`
 
# the following command starts your MPI-executable in parallel 
#                       --------------------------------------       
 
$CODINE_ROOT/mpi/MPRUN -np $NSLOTS -Mf $TMPDIR/machines ./hello 
#                                                       ------- 
...
echo '...end of the application' `/usr/bin/date`
...
echo '...end of clean up' `/usr/bin/date`
