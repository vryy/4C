...
namespace
{
  ...
  class GeometryPairLineToSurfaceTest : public ::testing::Test
  {
   protected:
    ...
    GeometryPairLineToSurfaceTest()
    {
      ...
      evaluation_data_ =
          Teuchos::make_rcp<GEOMETRYPAIR::LineToSurfaceEvaluationData>(line_to_surface_params_list);
    }
  ...
  {
    // Set up the pair.
    Teuchos::RCP<Core::Elements::Element> beam = Teuchos::make_rcp<Discret::Elements::Beam3r>(0, 0);
