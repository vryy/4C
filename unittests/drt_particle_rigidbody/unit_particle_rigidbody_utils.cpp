...
namespace
{
  TEST(QuaternionTest, Clear)
  {
    ...
    EXPECT_NEAR(q[0], 0.0, 1.0e-14);
    EXPECT_NEAR(q[1], 0.0, 1.0e-14);
    EXPECT_NEAR(q[2], 0.0, 1.0e-14);
    EXPECT_NEAR(q[3], 1.0, 1.0e-14);
  }
  ...
  TEST(QuaternionTest, Set)
  {
    ...
    EXPECT_NEAR(q1[0], q2[0], 1.0e-14);
    EXPECT_NEAR(q1[1], q2[1], 1.0e-14);
    EXPECT_NEAR(q1[2], q2[2], 1.0e-14);
    EXPECT_NEAR(q1[3], q2[3], 1.0e-14);
  }
  ...
  TEST(QuaternionTest, Product)
  {
    ...
    EXPECT_NEAR(q12[0], -0.01121419126499877, 1.0e-14);
    EXPECT_NEAR(q12[1], 0.9977058985744629, 1.0e-14);
    EXPECT_NEAR(q12[2], -0.05089858263600289, 1.0e-14);
    EXPECT_NEAR(q12[3], 0.04320319605818204, 1.0e-14);
  }
  ...
  TEST(QuaternionTest, FromAngleXAxis)
  {
    ...
    EXPECT_NEAR(q[0], std::sin(M_PI / 4), 1.0e-14);
    EXPECT_NEAR(q[1], 0.0, 1.0e-14);
    EXPECT_NEAR(q[2], 0.0, 1.0e-14);
    EXPECT_NEAR(q[3], std::cos(M_PI / 4), 1.0e-14);
  }
  ...
  TEST(QuaternionTest, FromAngleYAxis)
  {
    ...
    EXPECT_NEAR(q[0], 0.0, 1.0e-14);
    EXPECT_NEAR(q[1], std::sin(M_PI / 4), 1.0e-14);
    EXPECT_NEAR(q[2], 0.0, 1.0e-14);
    EXPECT_NEAR(q[3], std::cos(M_PI / 4), 1.0e-14);
  }
  ...
  TEST(QuaternionTest, FromAngleZAxis)
  {
    ...
    EXPECT_NEAR(q[0], 0.0, 1.0e-14);
    EXPECT_NEAR(q[1], 0.0, 1.0e-14);
    EXPECT_NEAR(q[2], std::sin(M_PI / 4), 1.0e-14);
    EXPECT_NEAR(q[3], std::cos(M_PI / 4), 1.0e-14);
  }
  ...
  TEST(QuaternionTest, FromAngleGeneral)
  {
    ...
    EXPECT_NEAR(q[0], -0.2759788075111623, 1.0e-14);
    EXPECT_NEAR(q[1], 0.8279364225334871, 1.0e-14);
    EXPECT_NEAR(q[2], 0.4139682112667435, 1.0e-14);
    EXPECT_NEAR(q[3], -0.2588190451025209, 1.0e-14);
  }
  ...
  TEST(QuaternionTest, RotateVectorXUnitAroundZAxis)
  {
    ...
    EXPECT_NEAR(w[0], 0.0, 1.0e-14);
    EXPECT_NEAR(w[1], 1.0, 1.0e-14);
    EXPECT_NEAR(w[2], 0.0, 1.0e-14);
  }
  ...
  TEST(QuaternionTest, RotateVectorZUnitAroundYAxis)
  {
    ...
    EXPECT_NEAR(w[0], 1.0, 1.0e-14);
    EXPECT_NEAR(w[1], 0.0, 1.0e-14);
    EXPECT_NEAR(w[2], 0.0, 1.0e-14);
  }
  ...
  TEST(QuaternionTest, RotateVectorGeneral)
  {
    ...
    EXPECT_NEAR(w[0], 0.7145801717316358, 1.0e-14);
    EXPECT_NEAR(w[1], -0.9159468817988596, 1.0e-14);
    EXPECT_NEAR(w[2], 1.97494721141881, 1.0e-14);
  }
}  // namespace
