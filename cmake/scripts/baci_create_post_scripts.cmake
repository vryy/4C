...
file(
  COPY ${CMAKE_PROJECT_SOURCE_DIR}/cmake/scripts/post_drt_ensight
...
file(
  COPY ${CMAKE_PROJECT_SOURCE_DIR}/cmake/scripts/post_drt_gid
  DESTINATION ${CMAKE_BINARY_DIR}
  FILE_PERMISSIONS
    OWNER_READ
    OWNER_WRITE
...
file(
  COPY ${CMAKE_PROJECT_SOURCE_DIR}/cmake/scripts/post_drt_vtu
  DESTINATION ${CMAKE_BINARY_DIR}
  FILE_PERMISSIONS
    OWNER_READ
    OWNER_WRITE
...
file(
  COPY ${CMAKE_PROJECT_SOURCE_DIR}/cmake/scripts/post_drt_vti
  DESTINATION ${CMAKE_BINARY_DIR}
  FILE_PERMISSIONS
    OWNER_READ
    OWNER_WRITE
