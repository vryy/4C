...
.. code-block:: bash
    ...
    ./<baci_command> <input_file> <output_basename>
...
Output generated by BACI consists at least of one file named ``<output_basename>.control``.
...
All available options when starting BACI from the command line are shown by an output of ``<baci-command> --help``:
...
.. code-block:: bash
   ...
   ./<baci-command> tests/input_files/f2_drivencavity20x20_drt.dat xxx
...
.. code-block:: bash
   ...
   mpirun -np 1 ./<baci-command> tests/input_files/f2_drivencavity20x20_drt.dat xxx
...
::
   ...
   ./<baci-command> <restart_input_file> <output_basename> [restartfrom=<restart_filename>] restart=<step>
