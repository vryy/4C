...
BACI is a versatile tool which can handle Finite element as well as meshless (particle) methods.
...
- All other meshed are to be generated by external pre-processing software, see section :ref:`preprocessing`.
  In the baci input file, the mesh is included by node and element definitions.
