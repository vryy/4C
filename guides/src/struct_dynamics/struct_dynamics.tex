...
\cite{strdyn:hairer87}, \name{Deuflhard} \etal{} \cite{strdyn:deuflhard94})\@. The global
error at time 
$t_{n+1}$ 
can be written as
...
error (\name{Hairer} \etal{} \cite{strdyn:hairer87, strdyn:hairer91}), it is easier to deal
with 
the \intro{local discretisation error} (\cf{} \name{Hairer} \etal{}
\cite{strdyn:hairer87}, \name{Deuflhard} \etal{} \cite{strdyn:deuflhard94}; it is
...
\begin{figure}[H]
\begin{center}
  \subfigure[Acceleration]{ \label{strdyn:fig:lindyn-newmark_acceleration}
  \includegraphics[width=0.32\textwidth]{gfx/lindyn-newmark_acceleration}}
  \subfigure[Velocity]{\label{strdyn:fig:lindyn-newmark_velocity}
  \includegraphics[width=0.32\textwidth]{gfx/lindyn-newmark_velocity}}
  \subfigure[Displacement]{\label{strdyn:fig:lindyn-newmark_displacement}
...
This section is an excerpt of \cite{strdyn:bornemann03}.
...
\subsection{\name{Zienkiewicz} and \name{Xie} indicator}\label{strdyn:sec:zx}
\name{Zienkiewicz} and \name{Xie} presented in \cite{strdyn:zienkiewicz91} a local
