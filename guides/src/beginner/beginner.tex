...
\begin{enumerate}
  ...
  Revision number: actual Baci reversion number ($\rightarrow $ entire Baci is checked out without this number)
...
Including this framework the student can work on different computers allways connected to an actual version. Therefore, they must update Baci\_bare in their home directory each day.
...
\begin{itemize}
  \item git diff \$ * | kompare - \\
  compare the files in kompare
  \item git diff branch\_name \$ * | kompare - \\
