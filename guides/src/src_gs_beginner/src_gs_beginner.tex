...
libraries and metis. Additional the boost libraries will be used in
the future. You should not need to worry about these libraries as
long as to stick to the provided configurations.
...
There is only one degugger: \texttt{gdb}. But it has a very plain
...
\#P~BS~-l~walltime=00:30:00,nodes=NUM\_NODES\_TAG:ppn=PROCS\_PER\_NODE\_TAG~

\#PBS~-l~nodes=NUM\_NODES\_TAG~
